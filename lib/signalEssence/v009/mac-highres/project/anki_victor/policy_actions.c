/* (C) Copyright 2017 Signal Essence for Robot; All Rights Reserved
   ...
   Lrya Specific:
   The Lrya robot has the microphones on the body and the loudspeaker is !!!
   The body can spin in place, but not terribly fast.
   The head only moves up and down independently of the body.
   
   The Lrya robot has 4 microphones closely spaced. Direction-finding operates mostly on 
   ...
   The Lrya angles are defined as radians.
...
void PolicyDoActions( void *p)
{
    ...
    // for Lrya is has been determined that echo is the biggest problem.
