...
The android build ships with static libraries
   ...
   -I../../../project/lrya_deskmate -I../../../se_lib_public/cpu_none
...
$ ./adb-push-run.sh
    + TOP_DIR=lrya_deskmate_example
    + ADB=adb
    ++ adb devices
    ++ wc -l
    + '[' 3 -ne 3 ']'
    + adb shell rm -rf /data/lrya_deskmate_example
    + adb shell mkdir /data/lrya_deskmate_example
    + adb shell mkdir /data/lrya_deskmate_example/build
    + adb shell mkdir /data/lrya_deskmate_example/out
    + adb shell chmod 777 /data/lrya_deskmate_example
    + adb shell chmod 777 /data/lrya_deskmate_example/build
    + adb shell chmod 777 /data/lrya_deskmate_example/out
    + adb push build/simple /data/lrya_deskmate_example/build
    build/simple: 1 file pushed. 9.2 MB/s (2360784 bytes in 0.245s)
    + adb push build/libmmfx.a /data/lrya_deskmate_example/build
    build/libmmfx.a: 1 file pushed. 9.4 MB/s (2306206 bytes in 0.234s)
    + adb push build/libmmif.a /data/lrya_deskmate_example/build
    build/libmmif.a: 1 file pushed. 7.7 MB/s (121670 bytes in 0.015s)
    + adb push config.json /data/lrya_deskmate_example/.
    config.json: 1 file pushed. 0.2 MB/s (493 bytes in 0.003s)
    + adb push sin1004hz_16khz.rmsdb_-24.wav /data/lrya_deskmate_example/.
    sin1004hz_16khz.rmsdb_-24.wav: 1 file pushed. 8.8 MB/s (320044 bytes in 0.035s)
    + adb shell 'export LD_LIBRARY_PATH=lrya_deskmate_example/build: && cd /data/lrya_deskmate_example && ./build/simple'
    WARNING: linker: Warning: unable to normalize "lrya_deskmate_example/build"
    WARNING: linker: Warning: unable to normalize ""
    WARNING: linker: /data/lrya_deskmate_example/build/simple: unused DT entry: type 0xf arg 0x33c
    version=(lrya_deskmate 001|mmfxver-localbuild)
    ReadConfigFile:  reading (config.json).......done
    ...
    + adb pull /data/lrya_deskmate_example/out/example_rout.wav out/.
    /data/lrya_deskmate_example/out/example_rout.wav: 1 file pulled. 12.1 MB/s (320364 bytes in 0.025s)
    + adb pull /data/lrya_deskmate_example/out/example_sout.wav out/.
    /data/lrya_deskmate_example/out/example_sout.wav: 1 file pulled. 3.1 MB/s (320364 bytes in 0.097s)
