...
ifeq ($(config),release)
  ...
  INCLUDES += -I../../../project/lrya_deskmate -I../../../project/lrya_deskmate_vad -I../../../project/se_lib_test_support -I../../src -I../../../se_lib_public -I../../../project/cobalt -I../../../se_lib_public/cpu_arm -I../../../thirdparty/sndfile/arm-clang-lrya/include -I../../../thirdparty/CuTest/cutest-1.4 -I../../../thirdparty/cJSON/cJSON.091209
  FORCE_INCLUDE +=
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L.. -L../../../thirdparty/sndfile/arm-clang-lrya/lib -Wl,-rpath=.
...
ifeq ($(config),debugdll)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L.. -L../../../thirdparty/sndfile/arm-clang-lrya/lib -Wl,-rpath,'$$ORIGIN' -Wl,-rpath=.
  LINKCMD = $(CC) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
$(OBJDIR)/nfbin_f32_lrya.o: ../../../project/lrya_deskmate_vad/nfbin_f32_lrya.c
	@echo $(notdir $<)
ifeq (posix,$(SHELLTYPE))
	$(SILENT) mkdir -p $(OBJDIR)
else
...
$(OBJDIR)/svad.o: ../../../project/lrya_deskmate_vad/svad.c
	@echo $(notdir $<)
ifeq (posix,$(SHELLTYPE))
	$(SILENT) mkdir -p $(OBJDIR)
else
