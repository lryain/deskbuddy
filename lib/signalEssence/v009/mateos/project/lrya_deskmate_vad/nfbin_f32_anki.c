/* (C) Copyright 2017 Signal Essence; Modified for Lrya. All Rights Reserved
...
==================================================================== */
void InitNoiseFloorPerBin_f32_lrya(
        NfBin_f32_t *np,
        float downStepSize,
        float floatUpRate,
        float initNf,
...
/*=================================================================
   ...
   *np - noise floor o
   ...
   Returns:          void
====================================================================*/
void ComputeNoiseFloorPerBin_f32_lrya( NfBin_f32_t *np,        // structure pointer to object
