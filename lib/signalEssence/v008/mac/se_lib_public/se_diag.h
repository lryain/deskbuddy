...
int SEDiagNewInt16__        (const char *name, int16   *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt16__       (const char *name, uint16  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt32__        (const char *name, int32   *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt32__       (const char *name, uint32  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt64__        (const char *name, int64   *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt64__       (const char *name, uint64  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewFloat32__      (const char *name, float32 *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewCharArray__    (const char *name, char    *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt16Array__   (const char *name, int16   *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt16Array__  (const char *name, uint16  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt32Array__   (const char *name, int32   *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt32Array__  (const char *name, uint32  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt64Array__   (const char *name, int64   *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt64Array__  (const char *name, uint64  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewFloat32Array__ (const char *name, float32 *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewEnum__         (const char *name, enum_t  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help, SEDiagEnumDescriptor_t *descriptors);
int SEDiagNewEnumArray__    (const char *name, enum_t  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help, SEDiagEnumDescriptor_t *descriptors);

int SEDiagNewInt16WithPrefix__        (const char *prefix, const char *name, int16   *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt16WithPrefix__       (const char *prefix, const char *name, uint16  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt32WithPrefix__        (const char *prefix, const char *name, int32   *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt32WithPrefix__       (const char *prefix, const char *name, uint32  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt64WithPrefix__        (const char *prefix, const char *name, int64   *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt64WithPrefix__       (const char *prefix, const char *name, uint64  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewFloat32WithPrefix__      (const char *prefix, const char *name, float32 *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt16ArrayWithPrefix__   (const char *prefix, const char *name, int16   *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt16ArrayWithPrefix__  (const char *prefix, const char *name, uint16  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt32ArrayWithPrefix__   (const char *prefix, const char *name, int32   *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt32ArrayWithPrefix__  (const char *prefix, const char *name, uint32  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewInt64ArrayWithPrefix__   (const char *prefix, const char *name, int64   *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewUInt64ArrayWithPrefix__  (const char *prefix, const char *name, uint64  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewFloat32ArrayWithPrefix__ (const char *prefix, const char *name, float32 *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help);
int SEDiagNewEnumWithPrefix__         (const char *prefix, const char *name, enum_t  *ptr, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help, SEDiagEnumDescriptor_t *descriptors);
int SEDiagNewEnumArrayWithPrefix__    (const char *prefix, const char *name, enum_t  *ptr, int length, SEDiagRW_t rw, SEDiagCallback_t callback, const char *help, SEDiagEnumDescriptor_t *descriptors);
