...
public final class WifiUtil {
  ...
  private static LryativityDispatcher mDispatcher;
  ...
  public static void register(final Activity activity, final LryativityDispatcher dispatcher) {
  ...
  private static void registerInternal(Activity activity, LryativityDispatcher dispatcher) {
    mActivity = activity;
