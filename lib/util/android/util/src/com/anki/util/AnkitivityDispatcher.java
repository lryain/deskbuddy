 ...
 * to receive those updates. An LryativityDispatcher should be created in an Activity subclass
 * and injected into dependent modules. This allows code in the lrya-util repository to receive
 ...
 */
public class LryativityDispatcher {
