...
public class LocationUtil {
  ...
  private static final String TAG = "LryaUtil";

  private static GoogleApiClient mApiClient;

  public static void requestEnableLocation(final Activity activity, final LryativityDispatcher dispatcher) {
  ...
  private static void makeLocationRequest(final Activity activity, final LryativityDispatcher dispatcher) {
      ...
      public void onResult(final LocationSettingsResult result) {
        ...
        switch (status.getStatusCode()) {
          ...
          case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
            ...
            try {
              final LryativityDispatcher.ResultListener listener = new LryativityDispatcher.ResultListener() {
  ...
  private static void onApiConnected(final Activity activity, final LryativityDispatcher dispatcher) {
