...
# Since we only have one version of each clang and clang, specifying a version
...
elseif(ANDROID_TOOLCHAIN STREQUAL clang)
	set(ANDROID_C_COMPILER   "${ANDROID_TOOLCHAIN_PREFIX}clang${ANDROID_TOOLCHAIN_SUFFIX}")
	set(ANDROID_CXX_COMPILER "${ANDROID_TOOLCHAIN_PREFIX}clang++${ANDROID_TOOLCHAIN_SUFFIX}")
else()
