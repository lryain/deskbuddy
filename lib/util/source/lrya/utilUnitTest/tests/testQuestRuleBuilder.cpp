...
using namespace Lrya::Util::QuestEngine;
...
public:
  ...
  static void SetUpTestCase() {
    Lrya::Util::FileUtils::DeleteFile(StatFile());
  }
  
  static void TearDownTestCase() {
    Lrya::Util::FileUtils::DeleteFile(StatFile());
    Lrya::Util::FileUtils::DeleteFile(RulesFile());
  }
...
TEST_F(QuestRuleBuilderTest, LoadDefinitions)
{
  ...
  Lrya::Util::FileUtils::WriteFile(RulesFile(), jsonString);
