...
{
  Lrya::Util::FixedCircularBuffer<int, 5> testBuff;
...
{
  Lrya::Util::FixedCircularBuffer<int, 100> testBufferNorm;
  Lrya::Util::FixedCircularBuffer<int, 100> testBufferArray;
...
{
  Lrya::Util::FixedCircularBuffer<int, 10> testBuff;
...
TEST(FixedCircularBuffer, MoveConstructor)
{
  ...
  Lrya::Util::FixedCircularBuffer<int, 5> testBuff2( std::move(testBuff) ); // Move Constructor
...
TEST(FixedCircularBuffer, MoveAssignment)
{
  ...
  Lrya::Util::FixedCircularBuffer<int, 5> testBuff2;
...
TEST(FixedCircularBuffer, CopyConstructor)
{
  ...
  Lrya::Util::FixedCircularBuffer<int, 5> testBuff2( testBuff ); // CopyConstructor
