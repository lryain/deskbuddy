...
TEST(GraphEvaluator2d, OneNode)
{
  ...
  Lrya::Util::GraphEvaluator2d testGraph( {{kNodeValX, kNodeValY}} );
...
TEST(GraphEvaluator2d, TwoNodesUp)
{
  ...
  Lrya::Util::GraphEvaluator2d testGraph( {{kNodeValX1, kNodeValY1}, {kNodeValX2, kNodeValY2}} );
...
TEST(GraphEvaluator2d, TwoNodesSameX)
{
  ...
  Lrya::Util::GraphEvaluator2d testGraph( {{kNodeValX, kNodeValY1}, {kNodeValX, kNodeValY2}} );
...
{
  Lrya::Util::GraphEvaluator2d testGraph( {{-5.0f,  -10.0f}, {-3.0f,  -2.0f}, {-1.0f,   0.0f}, { -1.0f, 100.0f},
...
{
  Lrya::Util::GraphEvaluator2d testGraph( {{0.0f, 0.0f}, {1.0f, 1.0f}, {1.0f, 100.0f}} );
...
TEST(GraphEvaluator2d, BadDataNodeOrder)
{
  ...
  Lrya::Util::GraphEvaluator2d testGraph( {{0.0f, 10.0f}, {-1.0f, 8.0f}, {1.0f, 1000.0f}}, false);
...
{
  Lrya::Util::GraphEvaluator2d testGraph( {{1.0f, 2.0f}, {3.0f, 4.0f}});
  ...
  Lrya::Util::GraphEvaluator2d testGraph2( std::move(testGraph) ); // Move Constructor
...
TEST(GraphEvaluator2d, MoveAssignment)
{
  ...
  Lrya::Util::GraphEvaluator2d testGraph2;
...
TEST(GraphEvaluator2d, CopyConstructor)
{
  ...
  Lrya::Util::GraphEvaluator2d testGraph2( testGraph ); // Copy Constructor
...
{
  Lrya::Util::GraphEvaluator2d testGraph( {{-5.0f, 0.0f}, {0.0f, -10.0f}, {1.5f, 2.0f}, {2.0f, 123.456f}, {20.0f, 50.0f}} );
...
{
  Lrya::Util::GraphEvaluator2d testGraph;
...
{
  Lrya::Util::GraphEvaluator2d::Node node1(1.0f, 2.0f);
  Lrya::Util::GraphEvaluator2d::Node node2(1.0f, 2.0f);
  ...
  Lrya::Util::GraphEvaluator2d testGraph1( {{-5.0f,  -10.0f}, {-3.0f,  -2.0f}, {-1.0f,   0.0f}, { -1.0f, 100.0f}} );
  Lrya::Util::GraphEvaluator2d testGraph2 = testGraph1;
