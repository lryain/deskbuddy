...
{
  Lrya::Util::CircularBuffer<int> testBuff(5);
...
{
  Lrya::Util::CircularBuffer<int> testBufferNorm(100);
  Lrya::Util::CircularBuffer<int> testBufferArray(100);
...
TEST(CircularBuffer, MoveConstructor)
{
  ...
  Lrya::Util::CircularBuffer<int> testBuff2( std::move(testBuff) ); // Move Constructor
...
TEST(CircularBuffer, MoveAssignment)
{
  ...
  Lrya::Util::CircularBuffer<int> testBuff2(0);
...
TEST(CircularBuffer, CopyConstructor)
{
  ...
  Lrya::Util::CircularBuffer<int> testBuff2( testBuff ); // CopyConstructor
