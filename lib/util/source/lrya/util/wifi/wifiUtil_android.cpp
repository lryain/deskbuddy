...
void BindTransportToNetwork(Lrya::Util::UDPTransport* transport) {
...
void JNICALL
Java_com_lrya_util_WifiUtil_NativeScanCallback(JNIEnv* env, jobject clazz,
...
void JNICALL
Java_com_lrya_util_WifiUtil_NativeStatusCallback(JNIEnv* env, jobject clazz,
...
void JNICALL
Java_com_lrya_util_WifiUtil_NativeBindNetworkCallback(JNIEnv* env, jobject thiz, jlong netId)
{
...
void JNICALL
Java_com_lrya_util_WifiUtil_NativeBindLollipopCallback(JNIEnv* env, jobject thiz)
{
