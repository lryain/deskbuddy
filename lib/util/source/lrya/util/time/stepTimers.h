...
#define LRYA_RUN_STEP_TIMERS 0 // LRYA_DEVELOPER_CODE

namespace Lrya{ namespace Util {
namespace Time {
#if LRYA_RUN_STEP_TIMERS
...
struct ScopedStep : Lrya::Util::noncopyable
{
  // constructor
