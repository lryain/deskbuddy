...
{
  startTime = Lrya::Util::Time::UniversalTime::GetCurrentTimeValue();
}
...
{
  return Lrya::Util::Time::UniversalTime::GetNanosecondsElapsedSince(startTime);
}
