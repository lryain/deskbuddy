...
#ifndef __LRYA_UTIL_PTREE_PTREEMANDATORY_H__
#define __LRYA_UTIL_PTREE_PTREEMANDATORY_H__
...
#define PTREE_GET_CHILD_MANDATORY(tree, key)                            \
  Lrya::Util::PtreeTools::GetChildMandatory(                              \
    tree,                                                               \
    key,                                                                \
    __FILE__,                                                           \
    __LINE__)
#define PTREE_GET_MANDATORY(tree, key, val)                             \
  Lrya::Util::PtreeTools::GetMandatory(                                   \
    tree,                                                               \
    key,                                                                \
    val,                                                                \
    __FILE__,                                                           \
