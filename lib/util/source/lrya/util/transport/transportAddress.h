...
inline std::ostream& operator<<(std::ostream& os, const Lrya::Util::TransportAddress& base)
{
...
namespace std {
  template<>
  struct hash<Lrya::Util::TransportAddress>
  {
    inline std::size_t operator()(const Lrya::Util::TransportAddress& address) const
    {
