...
void PerfMetric::InitInternal(Util::Data::DataPlatform* dataPlatform, WebService::WebService* webService)
{
  ...
  _fileDir = dataPlatform->pathToResource(Lrya::Util::Data::Scope::Cache, "perfMetricLogs");
...
{
  LRYA_CPU_PROFILE("PerfMetric::Dump");
...
{
  LRYA_CPU_PROFILE("PerfMetric::DumpFramesSince");
