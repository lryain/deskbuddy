...
#include <stdint.h>
  ...
  #define LRYA_CPU_PROFILER_ENABLED 1
#else
  #define LRYA_CPU_PROFILER_ENABLED 0
#endif


#if LRYA_CPU_PROFILER_ENABLED
  #define LRYA_CPU_PROFILER_ENABLED_ONLY(expr)  expr
#else
  #define LRYA_CPU_PROFILER_ENABLED_ONLY(expr)
#endif
