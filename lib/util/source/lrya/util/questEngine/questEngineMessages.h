...
struct QuestStore
{
  std::vector<Lrya::Util::QuestEngine::EventPair> eventStats;
  std::vector<Lrya::Util::QuestEngine::NoticePair> notices;
  std::vector<Lrya::Util::QuestEngine::TriggerLog> ruleTriggers;
  ...
  explicit QuestStore(const std::vector<Lrya::Util::QuestEngine::EventPair>& eventStats,
    const std::vector<Lrya::Util::QuestEngine::NoticePair>& notices,
    const std::vector<Lrya::Util::QuestEngine::TriggerLog>& ruleTriggers)
