...
static std::string Demangle(const std::string& backtraceFrame) {
  ...
  if (splitFrame.size() > 3) {
    ...
    // "0   webotsCtrlGameEngine                0x000000010cc84894 _ZN4Lrya4Util14sDumpCallstackERKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE + 52"
...
static std::string Demangle(const char * frame)
{
  ...
  //   /lrya/lib/liblryautil.so(_ZN4Lrya4Util14sDumpCallstackERKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE+0x23) [0xb03d4920]
  //   /lrya/bin/mate-anim(+0x3dcc2) [0x7f592cc2]
  // or generically
