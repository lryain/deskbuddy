...
Locale::CountryISO2 Locale::CountryISO2FromString(const std::string& countryString,
                                                  bool* resultValid)
{
  std::string countryStringUpperCase = Lrya::Util::StringToUpper(countryString);
...
Locale::Language Locale::LanguageFromString(const std::string& languageString,
                                            bool* resultValid)
{
  std::string languageStringLowerCase = Lrya::Util::StringToLower(languageString);
...
std::string Locale::GetLocaleStringLowerCase() const
{
  ...
  return Lrya::Util::StringToLower(locale);
}

std::string Locale::GetUrlString() const
{
  std::string str = ToString();
  return Lrya::Util::StringToLower(str);
}
