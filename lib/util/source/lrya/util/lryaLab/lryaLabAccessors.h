...
#ifndef __util_lryaLab_lryaLabAccessors_H_
#define __util_lryaLab_lryaLabAccessors_H_
...
AudienceTagList GetKnownAudienceTags(const LryaLabDef& lab);

} // namespace LryaLab
} // namespace Util
} // namespace Lrya

#endif // __util_lryaLab_lryaLabAccessors_H_
