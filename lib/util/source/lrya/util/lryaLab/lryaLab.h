...
#ifndef __util_lryaLab_lryaLab_H_
#define __util_lryaLab_lryaLab_H_
...
public:
  ...
  //
  // Access read-only data from LryaLabDef
  //

  // Access underlying `LryaLabDef` struct containing raw experiment definitions
  const LryaLabDef& GetLryaLabDefinition() const;
...
private:
  ...
  // LryaLab data definitions
  LryaLabDef _lryaLabDef;
...
#endif // __util_lryaLab_lryaLab_H_
