...
protected:
  ...
  , _type(componentEnum)
  {
    ...
    LRYA_VERIFY(_type == enumForTypeT, 
...
public:
  ...
  T& GetComponent() const {
    ...
    LRYA_VERIFY(enumID == _type, 
                "DependencyManagedComponentWrapper.GetComponent.CastingToIncorrectType", "");
    LRYA_VERIFY(IsComponentValid(),"DependencyManagedComponentWrapper.GetComponent.ValueIsNotValid",""); 
  ...
  T* GetComponentPtr() const {
    ...
    LRYA_VERIFY(IsComponentValid(),"DependencyManagedComponentWrapper.GetComponentPtr.ValueIsNotValid",""); 
    auto* castPtr = static_cast<T*>(_derivedPtr);
    return castPtr;
  }
