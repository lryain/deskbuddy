...
def gypHelp():
  ...
  print "git clone git@github.com:lrya/lrya-gyp.git"
  print "echo PATH=$HOME/your_workspace/gyp:$PATH >> ~/.bash_profile"
  print ". ~/.bash_profile"

def main(scriptArgs):
  # configure logging
  UtilLog = logging.getLogger('lrya-util.configure')
  ...
  sys.path.insert(0, os.path.join(options.buildToolsPath, 'tools/lryabuild'))
  ...
  clad_src_dir = os.path.join(projectRoot, 'source', 'lrya', 'clad')
  clad_dst_dir = os.path.join(projectRoot, 'source', 'lrya', 'messages')
  ...
  generator.processFolder(['source/lrya/util' ], ['project/gyp/util.lst'])
  generator.processFolder(['source/lrya/audioUtil' ], ['project/gyp/audioUtil.lst'])
  generator.processFolder(['source/lrya/utilUnitTest'], ['project/gyp/utilUnitTest.lst'])
  generator.processFolder(['source/lrya/networkApp'], ['project/gyp/networkApp.lst'])
  generator.processFolder(['source/lrya/clad'], ['project/gyp/clad.lst'])
  generator.processFolder(['source/lrya/messages'], ['project/gyp/messages.lst'])
