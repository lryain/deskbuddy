#!/usr/bin/env bash
#
# lib/util/tools/branch-scripts/deskmate-branch-update-spreadsheet.sh
#
...
cd ${SCRIPTDIR}
${SCRIPTDIR}/lrya-branch-update-spreadsheet.py ${spreadsheetId} ${sheet} ${srcbranch} ${dstbranch}
