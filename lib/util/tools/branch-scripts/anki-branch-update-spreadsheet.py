#!/usr/bin/env python3
#
# GIT list processing is taken from lrya git-log-cpr.py
...
#
APPLICATION_NAME = 'Lrya Branch Spreadsheet Update'
APPLICATION_SCOPE = 'https://www.googleapis.com/auth/spreadsheets'
CLIENT_SECRET_FILE = 'client_secret.json'
CREDENTIAL_FILE = 'sheets.googleapis.com-lrya-branch-update-spreadsheet.json'
...
def pretty_ticket(ticket):
  url = 'https://lryainc.atlassian.net/browse/{}'.format(ticket)
