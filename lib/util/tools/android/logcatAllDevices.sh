...
if [ "$#" == "0" ]; then
  args="-s -v threadtime Unity:I das:D dasJava:V libc:I DEBUG:D AndroidRuntime:W fmod:V BLEPeripheral:V VehicleConnection:D WifiMessagePort:V HockeyApp:V BackgroundConnectivity:D LryaUtil:V AudioCaptureSystem:V AudioSystem.Logging:V AudioSystem.Debugging:V"
