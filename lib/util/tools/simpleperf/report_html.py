...
class RecordData(object):
    ...
    # Lrya, allow symbol_cache to be overridden
    ...
    def _modify_name_for_html(self, name):
        return name # Lrya, not required .replace('>', '&gt;').replace('<', '&lt;')
...
def main():
    ...
    # Lrya, optionally take symbol_cache directory from the command-line
