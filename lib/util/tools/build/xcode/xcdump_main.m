...
void print_usage(void)
{
  printf("%s v%s Copyright (C) 2014 Lrya, Inc.\n\n", PROGRAM_NAME, VERSION);
  printf("Author: Brian Chapados <chapados@lrya.com>\n");
  ...
  printf("example:\n");
  printf("%s -p ~/repos/drive-basestation/projects/iOS/BaseStation.xcodeproj -t BaseStation -r ~/repos/drive-basestation/source/lrya\n", PROGRAM_NAME);
}
