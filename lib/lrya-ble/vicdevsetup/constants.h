 ...
 * Created: 10/3/2017
 *
 * Description: Lrya BLE Server constants
 *
...
namespace Lrya {
const size_t kLryaDeskmateMsgMaxSize=20;
const size_t kLryaDeskmateMsgPayloadMaxSize=18;
const size_t kLryaDeskmateMsgBaseSize=1;

enum DeskmateMsg_Command : uint8_t {
