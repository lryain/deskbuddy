...
class VicCubeTool : public Lrya::BluetoothDaemon::IPCClient {
 public:
  VicCubeTool(struct ev_loop* loop,
      ...
      , connection_id_(-1)
      , task_executor_(new Lrya::TaskExecutor(loop))
  {}
  ~VicCubeTool();
