/**
 * File: lrya_ble_uuids.h
 *
 * Author: seichert
 * Created: 2/9/2018
 *
 * Description: Lrya BLE UUIDs
 *
...
// This header defines constants specific to the Lrya BLE GATT Service.

namespace Lrya {

// For Deskmate
const std::string kLryaSingleMessageService_128_BIT_UUID("0000FEE3-0000-1000-8000-00805F9B34FB");
const std::string kLryaSingleMessageService_16_BIT_UUID("FEE3");
const std::vector<uint8_t> kLryaBluetoothSIGCompanyIdentifier({0xF8, 0x05});
const uint8_t kDeskmateProductIdentifier = (uint8_t) 'v';
const uint8_t kDeskmateProductEscapePodIdentifier = (uint8_t) 'e';
