...
$workspace_dir = $env:PROJECT_WORKSPACE # "LryaGithub" # The workspace directory that will handle our repo.

$git_username = $env:GIT_USERNAME # "lrya-smartling"
...
$git_repo_name = $env:GIT_REPO_NAME # "deskmate-wwise"
$git_repo_url = "${lrya_git_repos_url}/${git_repo_name}.git"
