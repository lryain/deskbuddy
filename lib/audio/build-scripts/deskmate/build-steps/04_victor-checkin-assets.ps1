...
$lrya_git_repos_url = "github.com/lrya"
...
$asset_svn_path = "deskmate-audio-assets"
...
if ($revision -ne "HEAD") {
  #$revision_commit_log = svn log -r $revision https://svn.lryacore.com/svn/deskmate-wwise/$branch
...
#$wwise_last_rev = svn log -l1 https://svn.lryacore.com/svn/deskmate-wwise/$branch | select-string -pattern 'r[0-9]'
...
$soundbanks_last_known_rev = (svn log -l20 https://svn.lryacore.com/svn/deskmate-audio-assets/trunk | select-string -pattern $commit_search_pattern)[0]
...
#$revision_commit_log = svn log -r "$log_range" https://svn.lryacore.com/svn/deskmate-wwise/$branch
#$revision_commit_log = [string]::join("`n", $revision_commit_log)
#$revision_commit_log = $revision_commit_log -replace "------------------------------------------------------------------------",""
#$revision_commit_log = $revision_commit_log -replace '"',"'"
...
svn co https://svn.lryacore.com/svn/deskmate-audio-assets/trunk $asset_svn_path --username $env:SVN_USERNAME --password $env:SVN_PASSWORD
