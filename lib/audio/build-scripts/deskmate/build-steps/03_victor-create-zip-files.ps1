...
$_SOUNDS_DIR_DESKMATE_LINUX =     "$_GSB_DIR\Victor_Linux"
...
# Asset Dirs
$_ASSETS_DIR = "assets"
$_TMP_OUTPUT_DIR_DESKMATE_LINUX =     "$_ASSETS_DIR\deskmate_linux"
$_TMP_OUTPUT_DIR_DEV_MAC =          "$_ASSETS_DIR\dev_mac"

# Metadata
$_APP_METADATA = "$_ASSETS_DIR\metadata"

$_SKU_DIR = "deskmate_robot"
$_DESKMATE_BANK_LIST_PATH = "$_METADATA_DIR\deskmate-banks-list.json"
$_DESKMATE_LINUX = "$_ASSETS_DIR\$_SKU_DIR\deskmate_linux"

# NOTE: We are currently only using Mac platform for Webots simulator
$_DESKMATE_DEV_MAC = "$_ASSETS_DIR\$_SKU_DIR\dev_mac"
...
# Make Dirs
mkdir $_TMP_OUTPUT_DIR_DESKMATE_LINUX
mkdir $_TMP_OUTPUT_DIR_DEV_MAC

mkdir $_APP_METADATA
mkdir $_DESKMATE_LINUX
mkdir $_DESKMATE_DEV_MAC
...
echo $_GSB_DIR
# Platform Paths
echo $_SOUNDS_DIR_DESKMATE_LINUX
echo $_SOUNDS_DIR_DEV_MAC
echo $_ASSETS_DIR
echo $_TMP_OUTPUT_DIR_DESKMATE_LINUX
echo $_TMP_OUTPUT_DIR_DEV_MAC
echo $_APP_METADATA
echo $_DESKMATE_BANK_LIST_PATH
echo $_DESKMATE_LINUX
echo $_DESKMATE_DEV_MAC
...
python $_BUNDLE_ASSETS_PYTHON_SCRIPT_PATH $_SOUNDS_DIR_DESKMATE_LINUX $_TMP_OUTPUT_DIR_DESKMATE_LINUX
CheckExitCode $lastExitCode
...
# Victor - Robot
python $_ORGANIZE_ASSETS_PYTHON_SCRIPT_PATH $_TMP_OUTPUT_DIR_DESKMATE_LINUX $_DESKMATE_LINUX $_DESKMATE_BANK_LIST_PATH --unzip-bundles
CheckExitCode $lastExitCode

# Victor - Dev-Webots
python $_ORGANIZE_ASSETS_PYTHON_SCRIPT_PATH $_TMP_OUTPUT_DIR_DEV_MAC $_DESKMATE_DEV_MAC $_DESKMATE_BANK_LIST_PATH --unzip-bundles
CheckExitCode $lastExitCode
...
python $_CONVERT_CSV_TO_JSON_SCRIPT_PATH $_AUDIO_BEHAVIOR_CSV_FILE_PATH "$_DESKMATE_LINUX\$_AUDIO_BEHAVIOR_FILE_NAME.json" -d
CheckExitCode $lastExitCode

python $_CONVERT_CSV_TO_JSON_SCRIPT_PATH $_AUDIO_BEHAVIOR_CSV_FILE_PATH "$_DESKMATE_DEV_MAC\$_AUDIO_BEHAVIOR_FILE_NAME.json" -d
CheckExitCode $lastExitCode

# Delete temp copy
if (Test-Path $_ASSETS_DIR) {
    Remove-Item $_TMP_OUTPUT_DIR_DESKMATE_LINUX -recurse
