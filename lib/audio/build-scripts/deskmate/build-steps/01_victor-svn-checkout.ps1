...
echo "INFO - svn co https://svn.lryacore.com/svn/deskmate-wwise/$branch -r $revision"
svn co https://svn.lryacore.com/svn/deskmate-wwise/$branch -r $revision $branch --username $env:SVN_USERNAME --password $env:SVN_PASSWORD
