...
#ifndef __LryaAudio_WwiseComponent_H__
#define __LryaAudio_WwiseComponent_H__
...
class WwiseComponent : private Lrya::Util::noncopyable {
...
#endif /* __LryaAudio_WwiseComponent_H__ */
