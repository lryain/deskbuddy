...
public:
  ...
  void SetPathResolver(Lrya::AudioEngine::AudioFilePathResolverFunc pathResolver);
...
protected:
  ...
  public:
    std::string path;
    Lrya::AudioEngine::ZipReader zipReader;
  };
  class ZipFileHandle
  {
  public:
  ...
  Lrya::AudioEngine::AudioFilePathResolverFunc  m_PathResolver;
