...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
LryaPluginInterface::LryaPluginInterface()
{
}
...
// Wave Portal Plugin
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::SetupWavePortalPlugIn()
{
  bool success = false;
#if USE_AUDIO_ENGINE
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void LryaPluginInterface::GiveWavePortalAudioDataOwnership(const StandardWaveDataContainer* audioData)
{
#if USE_AUDIO_ENGINE
  if ( (nullptr != _wavePortalPlugIn) && (nullptr != audioData) ) {
    const AudioDataStream* dataStream = new AudioDataStream( audioData->sampleRate,
                                                             ...
                                                             Lrya::Util::numeric_cast<uint32_t>(audioData->bufferSize),
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void LryaPluginInterface::ClearWavePortalAudioData()
{
#if USE_AUDIO_ENGINE
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::WavePortalHasAudioDataInfo() const
{
#if USE_AUDIO_ENGINE
  if ( _wavePortalPlugIn != nullptr ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::WavePortalIsActive() const
{
#if USE_AUDIO_ENGINE
  if ( _wavePortalPlugIn != nullptr ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void LryaPluginInterface::SetWavePortalInitCallback( PluginCallbackFunc callback )
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void LryaPluginInterface::SetWavePortalTerminateCallback( PluginCallbackFunc callback )
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::SetupStreamingWavePortalPlugIn()
{
  bool success = false;
#if USE_AUDIO_ENGINE
  using namespace PlugIns;
...
// Hijack Audio Plugin
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::SetupHijackAudioPlugInAndRobotAudioBuffers( uint32_t resampleRate, uint16_t samplesPerFrame )
{
  bool success = false;
#if USE_AUDIO_ENGINE
  using namespace PlugIns;
...
// Ak Alsa Sink Plugin
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::SetupAkAlsaSinkPlugIn( AudioUInt32 affinityMask )
{
  bool success = false;
#if USE_AUDIO_ENGINE
  using namespace PlugIns;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool LryaPluginInterface::AkAlsaSinkIsUsingSpeaker() const
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
uint32_t LryaPluginInterface::AkAlsaSinkGetSpeakerLatency_ms() const
{
  uint32_t latency = 0;
#if USE_AUDIO_ENGINE
