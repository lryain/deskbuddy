...
// TODO: Avoid public data (currently necessary to expose to static callback functions)
	...
	using SinkPluginTypes = Lrya::AudioEngine::PlugIns::AkAlsaSinkPluginTypes;
	
	// Custom local buffer to give us some slack between wwise audio production and alsa audio consumption
	Lrya::Util::FixedCircularBuffer<SinkPluginTypes::AudioChunk, SinkPluginTypes::kAkAlsaSinkBufferCount> _sinkPluginBuffer;
