...
{
  using namespace Lrya::AudioEngine::PlugIns;
...
AK_IMPLEMENT_PLUGIN_FACTORY(StreamingWavePortal, AkPluginTypeSource, AKCOMPANYID_LRYA, AKSOURCEID_STREAMINGWAVEPORTAL)
