...
#ifndef __LryaAudio_Plugins_StreamingWavePortalFx_H__
#define __LryaAudio_Plugins_StreamingWavePortalFx_H__
...
public:
  ...
  using StreamingWaveDataInstance = Lrya::AudioEngine::StreamingWaveDataInstance;
...
#endif // __LryaAudio_Plugins_StreamingWavePortalFx_H__
