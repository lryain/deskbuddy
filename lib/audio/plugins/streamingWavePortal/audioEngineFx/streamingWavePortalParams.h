...
#ifndef __LryaAudio_Plugins_StreamingWavePortalParams_H__
#define __LryaAudio_Plugins_StreamingWavePortalParams_H__
...
#endif // __LryaAudio_Plugins_StreamingWavePortalParams_H__
