...
#ifndef __LryaAudio_AudioTools_StandardWaveDataContainer_H__
#define __LryaAudio_AudioTools_StandardWaveDataContainer_H__
...
#endif // __LryaAudio_AudioTools_StandardWaveDataContainer_H__
