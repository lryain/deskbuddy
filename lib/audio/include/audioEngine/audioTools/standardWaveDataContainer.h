...
#ifndef __LryaAudio_StandardWaveDataContainer_H__
#define __LryaAudio_StandardWaveDataContainer_H__
...
struct AUDIOENGINE_EXPORT StandardWaveDataContainer
{
  ...
  {
    Lrya::Util::SafeDeleteArray(audioBuffer);
  }
...
#endif /* __LryaAudio_StandardWaveDataContainer_H__ */
