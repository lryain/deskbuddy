...
#ifndef __LryaAudio_MusicConductor_H__
#define __LryaAudio_MusicConductor_H__
...
class AUDIOENGINE_EXPORT MusicConductor : Lrya::Util::noncopyable {
...
#endif /* __LryaAudio_MusicConductor_H__ */
