...
#ifndef __LryaAudio_AudioMultiplexer_H__
#define __LryaAudio_AudioMultiplexer_H__
...
class AUDIOENGINE_EXPORT AudioMultiplexer : private Lrya::Util::noncopyable {
...
#endif /* __LryaAudio_AudioMultiplexer_H__ */
