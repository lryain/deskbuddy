...
#ifndef __LryaAudio_AudioMuxClient_H__
#define __LryaAudio_AudioMuxClient_H__
...
class AUDIOENGINE_EXPORT AudioMuxClient : private Lrya::Util::noncopyable
{
public:
...
#endif /* __LryaAudio_AudioMuxClient_H__ */
