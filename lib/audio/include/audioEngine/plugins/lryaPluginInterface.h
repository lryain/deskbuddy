...
#ifndef __LryaAudio_LryaPluginInterface_H__
#define __LryaAudio_LryaPluginInterface_H__
...
class AUDIOENGINE_EXPORT LryaPluginInterface : private Lrya::Util::noncopyable {
...
public:
  ...
  using PluginCallbackFunc = std::function<void( const LryaPluginInterface* pluginInstance )>;
...
#endif /* __Basestation_Audio_LryaPluginInterface_H__ */
