...
#ifndef __LryaAudio_PlugIns_StreamingWavePortalPlugIn_H__
#define __LryaAudio_PlugIns_StreamingWavePortalPlugIn_H__
...
#endif /* __LryaAudio_PlugIns_StreamingWavePortalPlugIn_H__ */
