...
#ifndef __LryaAudio_PlugIns_AkAlsaSinkPlugIn_H__
#define __LryaAudio_PlugIns_AkAlsaSinkPlugIn_H__
...
#if defined MATEOS && not defined EXCLUDE_LRYA_AUDIO_LIBS
...
#endif // __LryaAudio_PlugIns_AkAlsaSinkPlugIn_H__
