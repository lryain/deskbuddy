{
  'variables': {
    ...
    'util_gyp_path%': '../../lrya-util/project/gyp/util.gyp',
    'generated_clad_path%': '../../basestation/source/lrya/messages',
    # Note: I'm tired of changing paths every time I need to repoint OD to audio lib repo  - JMR
    #'util_gyp_path%': '../../../../OverDrive/Source/overdrive-one/lib/lrya-util/project/gyp/util.gyp',
    #'generated_clad_path%': '../../../../OverDrive/Source/overdrive-one/lib/basestation/source/lrya/messages',
