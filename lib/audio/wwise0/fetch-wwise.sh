...
DEFAULT_WWISE_HOME="${HOME}/.lrya/wwise/versions"
echo "DEFAULT_WWISE_HOME: "
echo $DEFAULT_WWISE_HOME

: ${LRYA_BUILD_WWISE_HOME:=$DEFAULT_WWISE_HOME}
: ${LRYA_WWISE_SDK_ROOT:="${LRYA_BUILD_WWISE_HOME}/${VERSION}"}
: ${WWISE_SDK_ROOT:="${LRYA_WWISE_SDK_ROOT}"}
...
VERSION_H_PATH="${HOME}/.lrya/wwise/versions/2017.2.7_a/${VERSION_H_REL}"
...
if [ $NEEDS_INSTALL -eq 1 ]; then
    DROPBOX_ARCHIVE_PATH="${HOME}/Dropbox\ \(Lrya\,\ Inc\)/Lrya\ Software\ Engineering/dist/wwise/wwise-$VERSION.tar.bz2"
