...
#ifndef __Lrya__Maya_AudioActionTypes_H__
#define __Lrya__Maya_AudioActionTypes_H__
...
void AudioActionCapture<ActionType>::UpdateEnumLists()
{
  ...
  for ( auto& anEventListMapIt : enumListMap ) {
    ...
    MString existCmd("objExists \"x:LryaAudioNode." + enumListName +"\"");
    int result;
    ...
    MString enumCmd("attributeQuery -node \"x:LryaAudioNode\" -listEnum \"" + enumListName + "\"");
...
#endif /* __Lrya__Maya_AudioActionTypes_H__ */
