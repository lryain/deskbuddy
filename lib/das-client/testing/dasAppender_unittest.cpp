...
TEST(DasAppenderTest, DasAppenderConstructor) {
  Lrya::Das::DasAppender* testAppender = new Lrya::Das::DasAppender(testDASDir,testDASURL);
...
TEST(DasAppenderTest, DasAppenderCleanupOldEmptyInProgress) {
  ...
  std::string inProg2 = testDASDir + "/02." + Lrya::Das::DasLogFileAppender::kDasInProgressExtension;
  std::string inProg3 = testDASDir + "/03." + Lrya::Das::DasLogFileAppender::kDasInProgressExtension;
