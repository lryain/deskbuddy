...
protected:
  virtual void SetUp() {
    ...
    appender_ = new Lrya::Das::DasGameLogAppender(testDirectory.c_str(), gameID);
  }
  ...
  std::string StringFromContentsOfLogFile() {
    ...
    std::string logFileContents = LryaUtil::StringFromContentsOfFile(logFilePath);
...
protected:
  ...
  Lrya::Das::DasGameLogAppender* appender_;
};
...
TEST_F(DasGameLogAppenderTest, WriteMessageWithData) {
  ...
  data[Lrya::Das::kPhysicalIdGlobalKey] = "0xbeef1234";
  appender_->append(DASLogLevel_Info, "TestEvent1", "TestValue1", this_id_, nullptr, nullptr, 0, &globals_, data);
  appender_->flush();
...
TEST_F(DasGameLogAppenderTest, WriteMessageWithLotsOfGlobalsAndData) {
  ...
  data[Lrya::Das::kTimeStampGlobalKey] = "123455555";
  data[Lrya::Das::kMessageLevelGlobalKey] = "info";
  data[Lrya::Das::kDataGlobalKey] = "some data";
  globals_[Lrya::Das::kPhysicalIdGlobalKey] = "0xbeef5678";
  data[Lrya::Das::kPhoneTypeGlobalKey] = "\"android phone\"";
  data[Lrya::Das::kUnitIdGlobalKey] = "0xffff-1234-abcd";
  data[Lrya::Das::kApplicationVersionGlobalKey] = "1.5.4,f";
  globals_[Lrya::Das::kUserIdGlobalKey] = "original-value";
  data[Lrya::Das::kUserIdGlobalKey] = "0xaaaa-987623-bbbb";
  data[Lrya::Das::kGroupIdGlobalKey] = "qa";
  ...
  expectedData += globals_[Lrya::Das::kGameIdGlobalKey];
  expectedData += ",qa,,1\n";
