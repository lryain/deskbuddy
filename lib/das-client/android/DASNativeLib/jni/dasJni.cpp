...
/*
 * Class:     com_lrya_daslib_DAS
 * Method:    nativeLog
 * Signature: (ILjava/lang/String;Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_nativeLog(JNIEnv *env, jclass clazz,
...
Java_com_lrya_daslib_DAS_IsEventEnabledForLevel(JNIEnv *env, jclass clazz,
 ...
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_Configure(JNIEnv *env, jclass clazz,
 ...
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_Close(JNIEnv *env, jclass clazz) {
  DASClose();
}
 ...
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_SetGlobal(JNIEnv *env, jclass clazz,
 ...
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_EnableNetwork(JNIEnv *env, jclass clazz, jint jReason)
{
 ...
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_DisableNetwork(JNIEnv *env, jclass clazz, jint jReason)
{
...
Java_com_lrya_daslib_DAS_GetNetworkingDisabled(JNIEnv *env, jclass clazz)
{
 ...
 */
JNIEXPORT void JNICALL
Java_com_lrya_daslib_DAS_SetLevel(JNIEnv *env, jclass clazz,
                                  jstring jEventName, jint dasLogLevel) {
  const char *eventName = env->GetStringUTFChars(jEventName, nullptr);
...
jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  jclass localClass = env->FindClass("com/lrya/daslib/DAS");
