/**
 * File: cubeBleClient_mateos.cpp
 *
 * Author: Matt Michini
 * Created: 12/1/2017
 *
 * Description:
 *               Defines interface to BLE central process which communicates with cubes (mate-os specific implementations)
 *
...
#ifdef SIMULATOR
#error SIMULATOR should NOT be defined by any target using cubeBleClient_mateos.cpp
#endif
