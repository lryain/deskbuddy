...
# python2 tools/deskmate_chrome_tracing.py --debug --outfile test.json
...
def main():
  ...
  parser = argparse.ArgumentParser(description='viewer for lrya cpu tracing profiles')
  ...
  if options.release:
    json_files = ["./_build/mac/Release/playbackLogs/webotsCtrlAnim/mate-anim-tracing.json",
                  "./_build/mac/Release/playbackLogs/webotsCtrlGameEngine2/mate-engine-tracing.json"]
  elif options.debug:
    json_files = ["./_build/mac/Debug/playbackLogs/webotsCtrlAnim/mate-anim-tracing.json",
                  "./_build/mac/Debug/playbackLogs/webotsCtrlGameEngine2/mate-engine-tracing.json"]
  else:
    json_files = []
    for file in ["mate-engine-tracing.json", "mate-anim-tracing.json"]:
      os.system("adb pull /data/data/com.lrya.deskmate/cache/"+file+" /tmp/"+file)
