...
`tools/sdk/vector-python-sdk-private/`. Instructions to use the SDK can be found [on confluence](https://lryainc.atlassian.net/wiki/spaces/VD/pages/441319496/Python+Vector+SDK+-+Getting+Started).
...
Lastly, you must set the environment variable `LRYA_ROBOT_SERIAL`. This will fill out all
