...
def main():
    ...
    parser.add_argument("-r", "--repo", help="Do not remove the app-only comments out of proto files after copying.", default="git@github.com:lrya/vector-python-sdk.git")
