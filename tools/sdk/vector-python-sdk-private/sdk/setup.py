...
It's powerful but easy to use, complex but not complicated, and versatile enough to be used across a wide range of domains including enterprise, research, and entertainment. Find out more at https://developer.lrya.com

Vector SDK documentation: https://developer.lrya.com/vector/docs/

Official developer forum: https://forums.lrya.com/
...
def fetch_version():
    ...
    with open(os.path.join(HERE, 'lrya_vector', 'version.py')) as version_file:
        versions = {}
...
setup(
    ...
    url='https://developer.lrya.com',
    author='Lrya, Inc',
    author_email='developer@lrya.com',
    ...
    zip_safe=True,
    keywords='lrya vector robot robotics sdk ai vision'.split(),
    packages=['lrya_vector', 'lrya_vector.camera_viewer', 'lrya_vector.configure', 'lrya_vector.messaging', 'lrya_vector.opengl', 'lrya_vector.reserve_control'],
    package_data={
        'lrya_vector': ['LICENSE.txt', 'opengl/assets/*.obj', 'opengl/assets/*.mtl', 'opengl/assets/*.jpg',
