...
Also, check whether Vector's IP address has changed since the last time you ran ``lrya_vector.configure``. If so, see :ref:`moving_between_wifi` to set up the robot with the new IP address.


^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Failure to run lrya_vector.configure
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

The prerequisites to run the ``lrya_vector.configure`` executable submodule successfully are:

* You have successfully created an Lrya account.
* Vector has been set up with the Vector companion app.
* The Vector companion app is *not* currently connected to Vector.
* Vector is connected to the same network as your computer.
* The ``lrya_vector`` Python package must be installed.
...
^^^^^^^^^^^^^^^^^^^^^
Lrya Developer Forums
^^^^^^^^^^^^^^^^^^^^^

Please visit the `Lrya Developer Forums <https://forums.lrya.com/>`_ to ask questions, find solutions and for general discussion.
