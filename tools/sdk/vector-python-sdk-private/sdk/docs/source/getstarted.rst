...
Please visit our `Lrya Developer Forums <https://forums.lrya.com/>`_ where you can:
...
On the computer, open Terminal (macOS/Linux) or Command Prompt (Windows) and type ``cd lrya_vector_sdk_examples``, where *lrya_vector_sdk_examples* is the directory you extracted the examples into, and press **Enter**.
