...
def dimensions():
    ...
    .. testcode::
        ...
        screen_dimensions = lrya_vector.screen.SCREEN_WIDTH, lrya_vector.screen.SCREEN_HEIGHT
...
def convert_pixels_to_screen_data(pixel_data: list, image_width: int, image_height: int):
    ...
    .. testcode::
        ...
        import lrya_vector
        from lrya_vector.screen import convert_pixels_to_screen_data
        from PIL import Image
...
def convert_image_to_screen_data(pil_image: Image.Image):
    ...
    .. testcode::
        ...
        with lrya_vector.Robot() as robot:
            ...
            screen_data = lrya_vector.screen.convert_image_to_screen_data(image_file)
...
class ScreenComponent(util.Component):
    ...
    def set_screen_to_color(self, solid_color: color.Color, duration_sec: float, interrupt_running: bool = True):
        ...
        .. testcode::
            ...
            with lrya_vector.Robot() as robot:
                duration_s = 4.0
                robot.screen.set_screen_to_color(lrya_vector.color.Color(rgb=[255, 128, 0]), duration_sec=duration_s)
                time.sleep(duration_s)
