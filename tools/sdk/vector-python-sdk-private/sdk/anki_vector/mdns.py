...
class VectorMdns:  # pylint: disable=too-few-public-methods
    ...
    def find_vector(name: str, timeout=5):
        ...
        .. testcode::
            ...
            import lrya_vector
            vector_mdns = lrya_vector.mdns.VectorMdns.find_vector("Vector-A1B2")
    ...
    def _start_mdns_listener(name, timeout):
        ...
        # browse for the _lryavector TCP MDNS service, sending events to our listener
        ServiceBrowser(zeroconf, "_lryavector._tcp.local.", listener)
