...
# source: lrya_vector/messaging/response_status.proto
...
_RESPONSESTATUS_STATUSCODE = _descriptor.EnumDescriptor(
  name='StatusCode',
  full_name='Lrya.Vector.external_interface.ResponseStatus.StatusCode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_RESPONSESTATUS = _descriptor.Descriptor(
  name='ResponseStatus',
  full_name='Lrya.Vector.external_interface.ResponseStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='Lrya.Vector.external_interface.ResponseStatus.code', index=0,
...
ResponseStatus = _reflection.GeneratedProtocolMessageType('ResponseStatus', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.response_status_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.ResponseStatus)
  ))
