...
# source: lrya_vector/messaging/behavior.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lrya_vector/messaging/behavior.proto',
  package='Lrya.Vector.external_interface',
  syntax='proto3',
  serialized_pb=_b('\n$lrya_vector/messaging/behavior.proto\x12\x1e\x41nki.Vector.external_interface\x1a$lrya_vector/messaging/messages.proto\"\x10\n\x0e\x43ontrolRelease\"\xae\x01\n\x0e\x43ontrolRequest\x12I\n\x08priority\x18\x01 \x01(\x0e\x32\x37.Lrya.Vector.external_interface.ControlRequest.Priority\"Q\n\x08Priority\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x16\n\x12OVERRIDE_BEHAVIORS\x10\n\x12\x0b\n\x07\x44\x45\x46\x41ULT\x10\x14\x12\x13\n\x0fRESERVE_CONTROL\x10\x1e\"\xbe\x01\n\x16\x42\x65haviorControlRequest\x12I\n\x0f\x63ontrol_release\x18\x01 \x01(\x0b\x32..Lrya.Vector.external_interface.ControlReleaseH\x00\x12I\n\x0f\x63ontrol_request\x18\x02 \x01(\x0b\x32..Lrya.Vector.external_interface.ControlRequestH\x00\x42\x0e\n\x0crequest_type\"\x18\n\x16\x43ontrolGrantedResponse\"\x15\n\x13\x43ontrolLostResponse\"\x1d\n\x1bReservedControlLostResponse\"\x82\x03\n\x17\x42\x65haviorControlResponse\x12Z\n\x18\x63ontrol_granted_response\x18\x01 \x01(\x0b\x32\x36.Lrya.Vector.external_interface.ControlGrantedResponseH\x00\x12Q\n\x12\x63ontrol_lost_event\x18\x02 \x01(\x0b\x32\x33.Lrya.Vector.external_interface.ControlLostResponseH\x00\x12\x43\n\nkeep_alive\x18\x03 \x01(\x0b\x32-.Lrya.Vector.external_interface.KeepAlivePingH\x00\x12\x62\n\x1breserved_control_lost_event\x18\x04 \x01(\x0b\x32;.Lrya.Vector.external_interface.ReservedControlLostResponseH\x00\x42\x0f\n\rresponse_typeb\x06proto3')
  ,
  dependencies=[lrya__vector_dot_messaging_dot_messages__pb2.DESCRIPTOR,])



_CONTROLREQUEST_PRIORITY = _descriptor.EnumDescriptor(
  name='Priority',
  full_name='Lrya.Vector.external_interface.ControlRequest.Priority',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CONTROLRELEASE = _descriptor.Descriptor(
  name='ControlRelease',
  full_name='Lrya.Vector.external_interface.ControlRelease',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_CONTROLREQUEST = _descriptor.Descriptor(
  name='ControlRequest',
  full_name='Lrya.Vector.external_interface.ControlRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='priority', full_name='Lrya.Vector.external_interface.ControlRequest.priority', index=0,
...
_BEHAVIORCONTROLREQUEST = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.BehaviorControlRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='control_release', full_name='Lrya.Vector.external_interface.BehaviorControlRequest.control_release', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='control_request', full_name='Lrya.Vector.external_interface.BehaviorControlRequest.control_request', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='request_type', full_name='Lrya.Vector.external_interface.BehaviorControlRequest.request_type',
...
_CONTROLGRANTEDRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.ControlGrantedResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_CONTROLLOSTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.ControlLostResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_RESERVEDCONTROLLOSTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.ReservedControlLostResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_BEHAVIORCONTROLRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.BehaviorControlResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='control_granted_response', full_name='Lrya.Vector.external_interface.BehaviorControlResponse.control_granted_response', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='control_lost_event', full_name='Lrya.Vector.external_interface.BehaviorControlResponse.control_lost_event', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keep_alive', full_name='Lrya.Vector.external_interface.BehaviorControlResponse.keep_alive', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reserved_control_lost_event', full_name='Lrya.Vector.external_interface.BehaviorControlResponse.reserved_control_lost_event', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='response_type', full_name='Lrya.Vector.external_interface.BehaviorControlResponse.response_type',
      index=0, containing_type=None, fields=[]),
  ],
...
_BEHAVIORCONTROLRESPONSE.fields_by_name['keep_alive'].message_type = lrya__vector_dot_messaging_dot_messages__pb2._KEEPALIVEPING
...
ControlRelease = _reflection.GeneratedProtocolMessageType('ControlRelease', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.ControlRelease)
  ))
...
ControlRequest = _reflection.GeneratedProtocolMessageType('ControlRequest', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.ControlRequest)
  ))
...
BehaviorControlRequest = _reflection.GeneratedProtocolMessageType('BehaviorControlRequest', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.BehaviorControlRequest)
  ))
...
ControlGrantedResponse = _reflection.GeneratedProtocolMessageType('ControlGrantedResponse', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.ControlGrantedResponse)
  ))
...
ControlLostResponse = _reflection.GeneratedProtocolMessageType('ControlLostResponse', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.ControlLostResponse)
  ))
...
ReservedControlLostResponse = _reflection.GeneratedProtocolMessageType('ReservedControlLostResponse', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.ReservedControlLostResponse)
  ))
...
BehaviorControlResponse = _reflection.GeneratedProtocolMessageType('BehaviorControlResponse', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.behavior_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.BehaviorControlResponse)
  ))
