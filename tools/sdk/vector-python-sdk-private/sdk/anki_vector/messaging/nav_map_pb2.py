...
# source: lrya_vector/messaging/nav_map.proto
...
_NAVMAPQUADINFO = _descriptor.Descriptor(
  name='NavMapQuadInfo',
  full_name='Lrya.Vector.external_interface.NavMapQuadInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='content', full_name='Lrya.Vector.external_interface.NavMapQuadInfo.content', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='depth', full_name='Lrya.Vector.external_interface.NavMapQuadInfo.depth', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='color_rgba', full_name='Lrya.Vector.external_interface.NavMapQuadInfo.color_rgba', index=2,
...
_NAVMAPINFO = _descriptor.Descriptor(
  name='NavMapInfo',
  full_name='Lrya.Vector.external_interface.NavMapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='root_depth', full_name='Lrya.Vector.external_interface.NavMapInfo.root_depth', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_size_mm', full_name='Lrya.Vector.external_interface.NavMapInfo.root_size_mm', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_center_x', full_name='Lrya.Vector.external_interface.NavMapInfo.root_center_x', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_center_y', full_name='Lrya.Vector.external_interface.NavMapInfo.root_center_y', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_center_z', full_name='Lrya.Vector.external_interface.NavMapInfo.root_center_z', index=4,
...
_NAVMAPFEEDREQUEST = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.NavMapFeedRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='frequency', full_name='Lrya.Vector.external_interface.NavMapFeedRequest.frequency', index=0,
...
_NAVMAPFEEDRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Lrya.Vector.external_interface.NavMapFeedResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='origin_id', full_name='Lrya.Vector.external_interface.NavMapFeedResponse.origin_id', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='map_info', full_name='Lrya.Vector.external_interface.NavMapFeedResponse.map_info', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quad_infos', full_name='Lrya.Vector.external_interface.NavMapFeedResponse.quad_infos', index=2,
...
NavMapQuadInfo = _reflection.GeneratedProtocolMessageType('NavMapQuadInfo', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.nav_map_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.NavMapQuadInfo)
  ))
...
NavMapInfo = _reflection.GeneratedProtocolMessageType('NavMapInfo', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.nav_map_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.NavMapInfo)
  ))
...
NavMapFeedRequest = _reflection.GeneratedProtocolMessageType('NavMapFeedRequest', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.nav_map_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.NavMapFeedRequest)
  ))
...
NavMapFeedResponse = _reflection.GeneratedProtocolMessageType('NavMapFeedResponse', (_message.Message,), dict(
  ...
  __module__ = 'lrya_vector.messaging.nav_map_pb2'
  # @@protoc_insertion_point(class_scope:Lrya.Vector.external_interface.NavMapFeedResponse)
  ))
