...
:attr:`lrya_vector.robot.Robot.audio` and can be used to play audio data on the robot.
"""
...
class AudioComponent(util.Component):
    ...
    The :class:`lrya_vector.robot.Robot` or :class:`lrya_vector.robot.AsyncRobot` instance
