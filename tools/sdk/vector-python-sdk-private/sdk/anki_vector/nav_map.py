...
To use the map you must first call :meth:`lrya_vector.nav_map.NavMapComponent.init_nav_map_feed`
...
class NavNodeContentTypes(Enum):  # pylint: disable=too-few-public-methods
    ...
    #: The node contains a :class:`~lrya_vector.objects.LightCube`.
...
class NavMapGrid:
    ...
    def __init__(self, msg: protocol.NavMapFeedResponse, logger: Logger):
        #: The origin ID for the map. Only maps and :class:`~lrya_vector.util.Pose`
    ...
    def get_content(self, x: float, y: float) -> protocol.NavNodeContentType:
        ...
        .. testcode::
            ...
            with lrya_vector.Robot(enable_nav_map_feed=True) as robot:
...
class NavMapComponent(util.Component):
    ...
    The :class:`lrya_vector.robot.Robot` or :class:`lrya_vector.robot.AsyncRobot` instance hosts this component.
