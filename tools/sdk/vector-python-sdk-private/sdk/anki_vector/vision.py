...
:attr:`lrya_vector.robot.Robot.vision` and can be used to enable/disable vision
...
class VisionComponent(util.Component):  # pylint: disable=too-few-public-methods
    ...
    The :class:`lrya_vector.robot.Robot` or :class:`lrya_vector.robot.AsyncRobot` instance owns this vision component.
