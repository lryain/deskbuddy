...
class BehaviorComponent(util.Component):
    ...
    async def go_to_pose(self,
        ...
        .. testcode::
            ...
            import lrya_vector
            from lrya_vector.util import degrees, Angle, Pose
    ...
    async def drive_straight(self,
        ...
        .. testcode::
            ...
            import lrya_vector
            from lrya_vector.util import distance_mm, speed_mmps
    ...
    async def set_head_angle(self,
        ...
        .. testcode::
            ...
            import lrya_vector
            from lrya_vector.util import degrees
            from lrya_vector.behavior import MIN_HEAD_ANGLE, MAX_HEAD_ANGLE
    ...
    async def set_lift_height(self,
        ...
        .. testcode::
            ...
            import lrya_vector
            from lrya_vector.behavior import MIN_LIFT_HEIGHT_MM, MAX_LIFT_HEIGHT_MM
            import time
    ...
    async def go_to_object(self,
        ...
        .. testcode::
            import lrya_vector
            from lrya_vector.util import distance_mm
...
class ReserveBehaviorControl():
    ...
    via the executable module :class:`lrya_vector.reserve_control`:

        .. code-block:: bash

            python3 -m lrya_vector.reserve_control
    ...
    may be used to reserve behavior control while in scope:
        ...
        .. code-block:: python
            ...
            import lrya_vector
            from lrya_vector import behavior
