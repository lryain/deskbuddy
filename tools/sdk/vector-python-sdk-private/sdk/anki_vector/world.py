...
class World(util.Component):
    ...
    def __init__(self, robot):
        ...
        #: :class:`lrya_vector.objects.Charger`: Vector's charger.
        #: ``None`` if no charger connected or known about yet.
        self._charger = None  # type: lrya_vector.objects.Charger
    ...
    def all_objects(self):
        ...
        Returns:
            A generator yielding :class:`lrya_vector.faces.Face`, :class:`lrya_vector.faces.LightCube`,
            :class:`lrya_vector.faces.Charger`, :class:`lrya_vector.faces.CustomObject` and
            :class:`lrya_vector.faces.FixedCustomObject` instances.
        """
    ...
    def visible_faces(self) -> Iterable[faces.Face]:
        ...
        Returns:
            A generator yielding :class:`lrya_vector.faces.Face` instances.
        """
    ...
    async def define_custom_box(self,
        ...
        .. testcode::
            ...
            with lrya_vector.Robot(enable_custom_object_detection=True) as robot:
                robot.world.define_custom_box(custom_object_type=lrya_vector.objects.CustomObjectTypes.CustomType00,
                                              marker_front=  lrya_vector.objects.CustomObjectMarkers.Circles2,
                                              marker_back=   lrya_vector.objects.CustomObjectMarkers.Circles3,
                                              marker_top=    lrya_vector.objects.CustomObjectMarkers.Circles4,
                                              marker_bottom= lrya_vector.objects.CustomObjectMarkers.Circles5,
                                              marker_left=   lrya_vector.objects.CustomObjectMarkers.Triangles2,
                                              marker_right=  lrya_vector.objects.CustomObjectMarkers.Triangles3,
    ...
    async def define_custom_cube(self,
        ...
        .. testcode::
            ...
            import lrya_vector
            with lrya_vector.Robot(enable_custom_object_detection=True) as robot:
                robot.world.define_custom_cube(custom_object_type=lrya_vector.objects.CustomObjectTypes.CustomType00,
                                               marker=lrya_vector.objects.CustomObjectMarkers.Circles2,
                                               size_mm=20.0,
                                               marker_width_mm=50.0, marker_height_mm=50.0)
    ...
    async def define_custom_wall(self,
        ...
        .. testcode::
            ...
            import lrya_vector
            with lrya_vector.Robot(enable_custom_object_detection=True) as robot:
                robot.world.define_custom_wall(custom_object_type=lrya_vector.objects.CustomObjectTypes.CustomType00,
                                               marker=lrya_vector.objects.CustomObjectMarkers.Circles2,
