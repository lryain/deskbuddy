...
The :class:`lrya_vector.world.World` object keeps track of faces the robot currently
...
class EvtFaceObserved():  # pylint: disable=too-few-public-methods
    ...
    .. testcode::
        ...
        with lrya_vector.Robot(enable_face_detection = True,
    ...
    :param image_rect: An :class:`lrya_vector.util.ImageRect`: defining where the face is within Vector's camera view
    :param name: The name of the face
    :param pose: The :class:`lrya_vector.util.Pose`: defining the position and rotation of the face
    """
...
class Expression(Enum):
    ...
    Call :func:`lrya_vector.robot.Robot.vision.enable_face_detection(detect_faces=True)` to enable recognition.
    """
...
class Face(objects.ObservableObject):
    ...
    def expression(self) -> str:
        ...
        :meth:`lrya_vector.robot.Robot.vision.enable_face_detection(detect_faces=True, estimate_emotion=True)` to enable
    ...
    def expression_score(self) -> List[int]:
        ...
        :meth:`lrya_vector.robot.Robot.vision.enable_face_detection(detect_faces=True, estimate_emotion=True)` wasn't
