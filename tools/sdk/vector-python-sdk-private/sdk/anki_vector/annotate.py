...
:class:`lrya_vector.camera.CameraImage` and
:class:`lrya_vector.camera.CameraComponent` to add annotations
...
:attr:`lrya_vector.camera.CameraComponent.image_annotator`.
"""
...
class ImageText:  # pylint: disable=too-few-public-methods
    ...
    .. testcode::
        ...
        import lrya_vector
        from lrya_vector import annotate
        ...
        with lrya_vector.Robot(show_viewer=True, enable_face_detection=True, enable_custom_object_detection=True) as robot:
...
class Annotator:
    ...
    def __init__(self, img_annotator, priority=None):
        ...
        #: :class:`~lrya_vector.world.World`: The world object for the robot who owns the camera
...
class ObjectAnnotator(Annotator):  # pylint: disable=too-few-public-methods
    ...
    This handles :class:`lrya_vector.objects.LightCube`,
    :class:`lrya_vector.objects.Charger` and
    :class:`lrya_vector.objects.CustomObject`.
    """
    priority = 100
...
class FaceAnnotator(Annotator):  # pylint: disable=too-few-public-methods
    ...
    This handles the display of :class:`lrya_vector.faces.Face` objects.
    """
    priority = 100
    box_color = 'green'
...
class ImageAnnotator:
    ...
    This is instantiated by :class:`lrya_vector.world.World` and is accessible as
    :class:`lrya_vector.camera.CameraComponent.image_annotator`.
    ...
    .. testcode::
        ...
        with lrya_vector.Robot(show_viewer=True) as robot:
    ...
    def __init__(self, world, **kw):
        super().__init__(**kw)
        #: :class:`lrya_vector.world.World`: World object that created the annotator.
        self.world = world
    ...
    def annotate_image(self, image: Image.Image, scale: float = None, fit_size: Tuple[int, int] = None, resample_mode: int = RESAMPLE_MODE_NEAREST) -> Image.Image:
        """Called by :class:`~lrya_vector.camera.CameraComponent` to annotate camera images.
