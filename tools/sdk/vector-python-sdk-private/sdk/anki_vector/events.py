...
class Events(Enum):
    ...
    new_camera_image = "new_camera_image"           #: Python event containing a processed camera image (:class:`lrya_vector.camera.CameraImage` instance)
...
class EventHandler:
    ...
    def start(self, connection: Connection):
        """Start listening for events. Automatically called by the :class:`lrya_vector.robot.Robot` class.
    ...
    def close(self):
        """Stop listening for events. Automatically called by the :class:`lrya_vector.robot.Robot` class.
        """
        self.listening_for_events = False
        try:
