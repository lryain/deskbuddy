...
class RemoteControlVector:
    ...
    def __init__(self, robot):
        ...
        default_anims_for_keys = ["anim_turn_left_01",  # 0
                                  "anim_blackjack_deskmatewin_01",  # 1
...
def run():
    ...
    with lrya_vector.AsyncRobot(args.serial, enable_face_detection=True, enable_custom_object_detection=True) as robot:
...
if __name__ == '__main__':
    try:
        ...
        pass
    except lrya_vector.exceptions.VectorConnectionException as e:
