...
import time
import lrya_vector
from lrya_vector.connection import ControlPriorityLevel


def main():
    args = lrya_vector.util.parse_command_args()
    with lrya_vector.Robot(args.serial, behavior_control_level=ControlPriorityLevel.OVERRIDE_BEHAVIORS_PRIORITY) as robot:
