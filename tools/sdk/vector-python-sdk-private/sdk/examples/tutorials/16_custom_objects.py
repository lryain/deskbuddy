...
def main():
    ...
    with lrya_vector.Robot(args.serial,
        ...
        robot.events.subscribe(handle_object_appeared, lrya_vector.events.Events.object_appeared)
        robot.events.subscribe(handle_object_disappeared, lrya_vector.events.Events.object_disappeared)
