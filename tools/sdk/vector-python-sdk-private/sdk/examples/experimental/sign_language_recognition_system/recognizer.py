...
class SignLanguageRecognizer():
    ...
    async def predict_with_camera_feed(self, robot: lrya_vector.Robot) -> None:
    ...
    if args.predict:
        ...
        with lrya_vector.Robot(args.serial) as robot:
            ...
            try:
                ...
                frame_of_interest = lrya_vector.util.RectangleOverlay(util.NetworkConstants.IMAGE_WIDTH, util.NetworkConstants.IMAGE_HEIGHT)
