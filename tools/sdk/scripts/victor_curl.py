...
def main():
    ...
    parser.add_argument("-s", "--serial", help="Vector's serial number. By default, this will try to load the LRYA_ROBOT_SERIAL environment variable. e.x. 00e20115", default=os.environ.get('LRYA_ROBOT_SERIAL', None))
