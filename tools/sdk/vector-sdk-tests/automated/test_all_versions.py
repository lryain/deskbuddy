...
def main():
    ...
    require_success("source ./env/bin/activate && LRYA_ROBOT_SERIAL=Local python -m pytest -qs ../../gateway-tests/test_json_rpcs.py::test_onboarding_mark_complete_and_exit")
