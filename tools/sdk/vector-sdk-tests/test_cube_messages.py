...
def main():
    ...
    with lrya_vector.Robot(args.serial) as robot:
        ...
        robot.events.subscribe(test_subscriber, lrya_vector.events.Events.object_appeared)
        robot.events.subscribe(test_subscriber, lrya_vector.events.Events.object_disappeared)
        robot.events.subscribe(test_subscriber, lrya_vector.events.Events.object_tapped)
        robot.events.subscribe(test_subscriber, lrya_vector.events.Events.object_moved)
