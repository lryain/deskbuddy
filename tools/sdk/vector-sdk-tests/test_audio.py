...
def main():
    ...
    with lrya_vector.Robot(args.serial, enable_audio_feed=True) as robot:
        time.sleep(8)
        ...
        wavfile.write(path, lrya_vector.messaging.protocol.PROCESSED_SAMPLE_RATE, robot.audio.raw_audio_waveform_history)
