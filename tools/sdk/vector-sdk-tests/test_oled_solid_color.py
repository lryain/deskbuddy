...
def main():
    ...
    with lrya_vector.Robot(args.serial) as robot:
        ...
        for _ in range(4):
            robot.screen.set_screen_to_color(lrya_vector.color.Color(rgb=[255, 128, 0]), duration_sec=1.0)
            time.sleep(1.0)
            robot.screen.set_screen_to_color(lrya_vector.color.Color(rgb=[48, 192, 48]), duration_sec=1.0)
            time.sleep(1.0)
            robot.screen.set_screen_to_color(lrya_vector.color.Color(rgb=[0, 128, 255]), duration_sec=1.0)
            time.sleep(1.0)
            robot.screen.set_screen_to_color(lrya_vector.color.Color(rgb=[96, 0, 192]), duration_sec=1.0)
            time.sleep(1.0)
