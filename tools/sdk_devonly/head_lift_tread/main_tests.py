...
from lrya_vector.util import degrees, distance_mm, speed_mmps
...
def Main():
  args = lrya_vector.util.parse_test_args()
  robot = lrya_vector.Robot(args.name, args.ip, str(args.cert), port="443")
  robot.connect()
