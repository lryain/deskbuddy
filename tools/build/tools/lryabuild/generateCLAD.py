...
def generateMessageBuffersCsharp(basestation_dir, unity_dir, clad_emitter_dir=None, verbose=False):
    message_buffers_src=os.path.join(basestation_dir, 'source', 'lrya', 'clad')
    message_buffers_dst=os.path.join(unity_dir, 'Assets', 'Libs', 'Lrya', 'Messages')
...
if __name__ == '__main__':
  ...
  result = generateMessageBuffers(os.path.join(projectRoot, 'source', 'lrya', 'clad'), os.path.join(projectRoot, 'source', 'generated'))
  if result != 0:
