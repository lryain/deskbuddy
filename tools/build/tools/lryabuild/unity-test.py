...
class UnityBuildConfig(object):
    ...
    def parse_arguments(self, argv):
        lrya_builder = builder.Builder()

        parser = argparse.ArgumentParser(parents=[lrya_builder.argument_parser()],
...
class UnityBuild(object):
    ...
    def run_smoketest_command_line(self):
        ...
        procArgs.extend(["-executeMethod", 'Lrya.TestScenario.RunTest'])
