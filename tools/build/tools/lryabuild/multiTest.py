...
parser.add_argument('--work_path', const=True, action='store', dest='workPath', nargs='?',
                    default=None, help='location of LRYAWORKROOT')
parser.add_argument('--config_path', const=True, action='store', dest='configPath', nargs='?',
                    default=None, help='location of LRYACONFIGROOT')
...
if args.workPath:
    os.environ['LRYAWORKROOT'] = args.workPath
if args.configPath:
    os.environ['LRYACONFIGROOT'] = args.configPath
if args.gtestOutput:
...
def runTestCase(testCase):
    ...
    # prepare work root
    workRoot=None
    if 'LRYAWORKROOT' in os.environ:
        workRoot = os.environ['LRYAWORKROOT']
    if not workRoot:
