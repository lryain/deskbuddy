require File.join(File.dirname(__FILE__), '..', 'lib', 'lrya_gem_bundle')
...
class Localization
  ...
  def code
    ...
    Dir.chdir(project_root) do |d|
      ...
      %x{find -E . -iregex '.*\.(m|mm)$' -print0 | xargs -0 genstrings -s "LryaLocalizedString" -o #{localized_resource_dir}}
