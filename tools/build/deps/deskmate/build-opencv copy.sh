...
PROTOBUF_DIR=/home/lryain/deskmate-dev/tools/build/dist/protobuf
# PROTOBUF_DIR=/home/lryain/deskmate-dev/3rd/protobuf
echo "-------> PROTOBUF_DIR: ${PROTOBUF_DIR}"
OPENCV_DIR=${BUILDDIR}/build-opencv/opencv
...
# Build for vicOS
echo "Building opencv ${OPENCV_REVISION_TO_BUILD} for deskmate (vicOS) ...."
