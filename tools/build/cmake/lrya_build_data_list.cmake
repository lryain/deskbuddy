#
# lrya_build_data_list.cmake
#
# Helper macros to integrate cmake + metabuild.py
#
macro(lrya_build_data_list target_name srclist_dir)
...
if (EXISTS ${DATA_LIST_FILE})
  ...
  message(FATAL_ERROR ${DATA_LIST_FILE} " not found. Did you forget to add your BUILD.in to build-deskmate.sh?")
endif()
...
elseif (MATEOS)
  set(_ab_datafile "${srclist_dir}/${target_name}_mateos.data.lst")
else()
  set(_ab_datafile "")
endif()
...
macro(lrya_build_absolute_data_list target_name srclist_dir)
  lrya_build_data_list(${target_name} ${srclist_dir})
