#
# lrya_build_source_list.cmake
#
# Helper macros to integrate cmake + metabuild.py
#
macro(lrya_build_source_list target_name srclist_dir)
...
if (EXISTS ${SRC_LIST_FILE})
  ...
  message(FATAL_ERROR ${SRC_LIST_FILE} " not found. Did you forget to add your BUILD.in to build-deskmate.sh?")
endif()
...
elseif (MATEOS)
  set(_ab_srcfile "${srclist_dir}/${target_name}_mateos.srcs.lst")
  set(_ab_hdrfile "${srclist_dir}/${target_name}_mateos.headers.lst")
else()
  set(_ab_srcfile "")
  set(_ab_hdrfile "")
endif()
...
macro(lrya_build_absolute_source_list target_name srclist_dir)
