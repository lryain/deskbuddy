...
BUILD_FOLDER=${TOPLEVEL}/_build/mateos/${LRYA_BUILD_TYPE}
...
curl -v --data-binary @$SYMBOLS_FILE 'https://lrya.sp.backtrace.io:6098/post?format=symbols&token='${BACKTRACE_UPLOAD_TOKEN}
