...
int main(int argc, char ** argv)
{
  ...
  while(!wasQuitPressed) {
    ...
    captureImagesResult = Lrya::CaptureImages(cameraId, numImages, imageSize, capturedImages, captureTime, wasQuitPressed, startCaptureImmediately, showPreview, showCrosshair, cameraSettingsGui);
