...
_GIT_COZMO_PR_URI=https://$LRYA_SMARTLING_ACCESS_TOKEN:x-oauth-basic@api.github.com/repos/lrya/cozmo-one/pulls
...
if [ "$_status" ]; then
    ...
    $GIT config user.email "lrya-smartling@lrya.com"
    $GIT config user.name "lrya-smartling"
