...
bool LryaProtoGenerator::Generate( const FileDescriptor* file,
                                   ...
                                   std::string* error ) const
{
  ...
  for( int i = 0; i < file->message_type_count(); i++ ) {
    ...
    // but we could annotate messages with "// @@lrya_gen_code=true" and look for that in
...
bool LryaProtoGenerator::GenerateConstructors( const FileDescriptor* file,
...
bool LryaProtoGenerator::GenerateTagAccessors( const FileDescriptor* file,
                                               const Descriptor* message,
                                               compiler::GeneratorContext* context,
...
bool LryaProtoGenerator::GenerateTags( const FileDescriptor* file,
