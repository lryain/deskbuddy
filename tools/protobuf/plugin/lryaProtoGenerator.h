...
#ifndef __LRYA_PROTO_GENERATOR_H__
#define __LRYA_PROTO_GENERATOR_H__
...
class LryaProtoGenerator : public google::protobuf::compiler::CodeGenerator 
{
public:
  virtual ~LryaProtoGenerator() = default;
...
#endif // __LRYA_PROTO_GENERATOR_H__
