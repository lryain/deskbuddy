...
if [[ $ANIM_GROUP_LIST = *[![:space:]]* ]]; then
    echo "This script doesn't know how to handle deskmate usage of raw animation groups ('ag_*'). Failing"
    exit 1
fi
...
${GIT_PROJ_ROOT}/project/deskmate/build-deskmate.sh -c Debug -p mac -I
