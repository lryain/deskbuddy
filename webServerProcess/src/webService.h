...
public:
  ...
  void Start(Lrya::Util::Data::DataPlatform* platform, const Json::Value& config);
  void Update();
  void Stop();
  ...
  const Lrya::Util::Data::DataPlatform* GetPlatform() { return _platform; }
...
private:
  ...
  Json::Value _config;
  Lrya::Util::Data::DataPlatform* _platform;
