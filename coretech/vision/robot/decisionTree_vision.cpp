...
namespace Lrya
{
  namespace Embedded
  {
    ...
    {
      LryaConditionalErrorAndReturn(probeXOffsets != NULL && probeYOffsets != NULL,
        "FiducialMarkerDecisionTree::FiducialMarkerDecisionTree",
        "probes are NULL");

      LryaConditionalErrorAndReturn(numProbeOffsets > 0,
        "FiducialMarkerDecisionTree::FiducialMarkerDecisionTree",
        "numProbeOffsets > 0");
    ...
    {
      LryaConditionalErrorAndReturnValue(AreValid(*this, image, homography),
      ...
      LryaError("FiducialMarkerDecisionTree::Classify", "Decision tree ran out of bounds");
      ...
      const u8 meanGrayvalueThreshold, s32 &label) const
    {
      ...
      if(labelIndexStart == labelIndexEnd) {
        ...
        LryaError("FiducialMarkerDecisionTree::Classify",
      ...
      bool &isVerified) const
    {
      ...
      if(labelIndexStart == labelIndexEnd) {
        ...
        // at this leaf node
        isVerified = false;
        LryaAssert(this->leafLabels != NULL);
        LryaAssert(labelIndexStart >= 0 && labelIndexEnd <= this->numLeafLabels);
