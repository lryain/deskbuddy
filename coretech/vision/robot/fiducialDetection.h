...
#ifndef _LRYACORETECHEMBEDDED_VISION_VISIONKERNELS_H_
#define _LRYACORETECHEMBEDDED_VISION_VISIONKERNELS_H_
...
#endif //_LRYACORETECHEMBEDDED_VISION_VISIONKERNELS_H_
