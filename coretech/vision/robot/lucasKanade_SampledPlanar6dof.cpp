...
non-disclosure agreement with Lrya, inc.
**/
    ...
    namespace TemplateTracker
    {
        ...
        : LucasKanadeTracker_Generic(Transformations::TRANSFORM_PROJECTIVE, templateImage, templateQuadIn, scaleTemplateRegionPercent, numPyramidLevels, transformType, onchipScratch)
      {
        ...
        */
        ...
        LryaConditionalErrorAndReturn(lastResult == RESULT_OK, "LKTracker_SampledPlanar6dof", "Failed to compute initial pose constructing tracker");
        ...
        */
        ...
        LryaConditionalErrorAndReturn(setR_result == RESULT_OK,
          "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
        ...
        LryaConditionalErrorAndReturn(this->templateSamplePyramid.IsValid(),
          "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
          "Unable to allocate templateSamplePyramid FixedLengthList.");

        LryaConditionalErrorAndReturn(this->verificationSamples.IsValid(),
          "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
          "Unable to allocate verificationSamples FixedLengthList.");

        LryaConditionalErrorAndReturn(this->AtAPyramid.IsValid(),
          "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
        ...
        for(s32 iScale=0; iScale<numPyramidLevels; iScale++)
        {
          ...
          LryaConditionalErrorAndReturn(curAtA.IsValid(),
            "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
          ...
          //
          {
            ...
            LryaConditionalErrorAndReturn(this->templateSamplePyramid[iScale].IsValid(),
              "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
            ...
            s32 numSelected = 0;
            {
              ...
              LryaConditionalErrorAndReturn(templateImageAtScale.IsValid(),
                                            "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
...
#             if USE_BLURRING
              ...
              if((lastResult = Interp2_Projective<u8,u8>(templateImageBoxFiltered, templateCoordinates, transformation.get_homography(), this->transformation.get_centerOffset(initialImageScaleF32), templateImageAtScale, INTERPOLATE_LINEAR)) != RESULT_OK) {
                LryaError("LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof", "Interp2_Projective failed with code 0x%x", lastResult);
                return;
              }
...
#             endif // USE_BLURRING
              ...
              if(numFiducialSamplesAtScale > 0) {
                ...
                LryaConditionalErrorAndReturn(templateBrightValue > templateDarkValue,
                  "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
              ...
              if((lastResult = Matrix::MeanAndVar<u8,f32>(templateImageAtScale, this->normalizationMean[iScale], tempVariance)) != RESULT_OK) {
                LryaError("LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof", "MeanAndVar failed with code 0x%x", lastResult);
                return;
              }
              LryaConditionalError(this->normalizationMean[iScale] < 0.f || this->normalizationMean[iScale] > 255.f,
                "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
                "Template mean out of reasonable bounds [0,255] - was %.f", this->normalizationMean[iScale]);
              LryaConditionalError(tempVariance > 0.f,
                "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
              ...
              LryaConditionalErrorAndReturn(templateImageXGradient.IsValid(),
                "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
              ...
              if((lastResult = ImageProcessing::ComputeXGradient<u8,f32,f32>(templateImageAtScale, templateImageXGradient)) != RESULT_OK) {
                LryaError("LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof", "ComputeXGradient failed with code 0x%x", lastResult);
                return;
              }

              // Compuate Y gradient image
              Array<f32> templateImageYGradient(numPointsY, numPointsX, offchipScratch);
              LryaConditionalErrorAndReturn(templateImageYGradient.IsValid(),
                "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
              ...
              if((lastResult = ImageProcessing::ComputeYGradient<u8,f32,f32>(templateImageAtScale, templateImageYGradient)) != RESULT_OK) {
                LryaError("LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof", "ComputeYGradient failed with code 0x%x", lastResult);
                return;
              }
                ...
                // Using the computed gradients, find a set of the max values, and store them
              {
                ...
                LryaConditionalErrorAndReturn(magnitudeVector.IsValid(),
                "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
                ...
                */

                {
                  ...
                  LryaConditionalErrorAndReturn(magnitudeImage.IsValid(),
                    "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
                    "Out of memory allocating magnitudeImage. Could not allocate %dx%d points.", numPointsX, numPointsY);
                  {
                    ...
                    LryaConditionalErrorAndReturn(tmpMagnitude.IsValid(),
                      "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
...

                  {
                    ...
                    LryaConditionalErrorAndReturn(magnitudeImageNLMS.IsValid(),
                      "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
              ...
              if((lastResult = Matrix::Vectorize<f32,f32>(false, templateImageXGradient, xGradientVector)) != RESULT_OK) {
                LryaError("LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
            ...
            if(numSelected == 0) {
              ...
              LryaWarn("LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
        ...
        //
        {
          ...
          if(numFiducialSquareSamples > 0) {
            ...
            LryaConditionalErrorAndReturn(lastResult == RESULT_OK,
              "LucasKanadeTracker_SampledPlanar6dof::LucasKanadeTracker_SampledPlanar6dof",
        ...
        MemoryStack scratch)
      {
        ...
        LryaConditionalErrorAndReturnValue(startIndex < this->verificationSamples.get_size(),
        ...
        Array<f32> verifyGrayscaleVector(1, numSamplesX*numSamplesY, scratch);
        {
          ...
          LryaConditionalErrorAndReturnValue(lastResult == RESULT_OK, lastResult,
        ...
        LryaConditionalErrorAndReturnValue(xVerifyVector.IsValid(), RESULT_FAIL_MEMORY,
          "LucasKanadeTracker_SampledPlanar6dof::CreateVerificationSamples",
          "Failed to allocate xVerifyVector.");

        LryaConditionalErrorAndReturnValue(yVerifyVector.IsValid(), RESULT_FAIL_MEMORY,
          "LucasKanadeTracker_SampledPlanar6dof::CreateVerificationSamples",
      ...
      {
        LryaConditionalError(atScale >=0 && atScale < this->templateSamplePyramid.get_size(),
      ...
      {
        LryaConditionalErrorAndReturnValue(AreEqualSize(3, 3, R), RESULT_FAIL_INVALID_SIZE,
      ...
      {
#if !LRYACORETECH_EMBEDDED_USE_OPENCV
        return RESULT_FAIL;
#else
        //if(!this->IsValid())
        //  return RESULT_FAIL;
        ...
        return RESULT_OK;
#endif // #if !LRYACORETECH_EMBEDDED_USE_OPENCV
      }
...
#       undef __NEXT_IMAGE__
      ...
      Result LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance_angle, const f32 convergenceTolerance_distance, const Transformations::TransformType curTransformType, bool &verify_converged, MemoryStack scratch)
      {
        ...
        LryaConditionalErrorAndReturnValue(whichScale >= 0 && whichScale < this->numPyramidLevels,
          RESULT_FAIL_INVALID_PARAMETER, "LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack", "whichScale is invalid");

        LryaConditionalErrorAndReturnValue(convergenceTolerance_angle > 0.0f && convergenceTolerance_distance > 0.0f,
        ...
        LryaConditionalErrorAndReturnValue(nextImageHeight == templateImageHeight && nextImageWidth == templateImageWidth,
        ...
        LryaConditionalErrorAndReturnValue(((1<<initialImagePowerS32)*nextImageWidth) == baseImageWidth,
      ...
      f32 LucasKanadeTracker_SampledPlanar6dof::GetCurrentGain() const
      {
        if(this->useGainScheduling) {
          ...
          LryaAssert(Kp >= this->Kp_min && Kp <= this->Kp_max);
          return Kp;
        } else {
      ...
      Result LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack_Translation(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance_distance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          /*
          if(numInBounds < 16) {
          LryaWarn("LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack_Translation", "Template drifted too far out of image.");
          return RESULT_OK;
          }
          */
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack_Translation", "numericalFailure");
            return RESULT_OK;
          }
      ...
      Result LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack_Projective(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance_angle, const f32 convergenceTolerance_distance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          /*
          if(numInBounds < 16) {
          LryaWarn("LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack_Projective", "Template drifted too far out of image.");
          return RESULT_OK;
          }
          */
          ...
          */
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_SampledPlanar6dof::IterativelyRefineTrack_Projective", "numericalFailure");
            return RESULT_OK;
          }
      ...
      Result LucasKanadeTracker_SampledPlanar6dof::ApproximateSelect(const Array<f32> &magnitudeVector, const s32 numBins, const s32 numToSelect, s32 &numSelected, Array<s32> &magnitudeIndexes)
      {
        ...
        if(foundThreshold < -0.1f) {
          LryaWarn("LucasKanadeTracker_SampledPlanar6dof::ApproximateSelect", "Could not find valid threshold");
      ...
      Result LucasKanadeTracker_SampledPlanar6dof::ApproximateSelect(const Array<f32> &magnitudeImage, const s32 numBins, const s32 numRegions, const s32 numToSelect, s32 &numSelected, Array<s32> &magnitudeIndexes)
      {
        ...
        LryaConditionalErrorAndReturnValue(magnitudeIndexes.get_size(0)*magnitudeIndexes.get_size(1) == nrows*ncols,
        ...
        for(s32 i_region=0; i_region<numRegions; ++i_region) {
          ...
          for(s32 j_region=0; j_region<numRegions; ++j_region) {
            ...
            /*
            if(foundThreshold < -0.1f) {
            LryaWarn("LucasKanadeTracker_SampledPlanar6dof::ApproximateSelect",
            ...
            */
            ...
            if(foundThreshold > 0.f) {
              ...
              //LryaWarn("ApproximateSelect", "Finished region (%d,%d), have %d selected", i_region, j_region, numSelected);
            } // if(foundThreshold > 0.f)
