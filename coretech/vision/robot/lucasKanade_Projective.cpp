    ...
    namespace TemplateTracker
    {
      ...
      Result LucasKanadeTracker_Projective::IterativelyRefineTrack_Translation(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          if(numInBounds < 16) {
            LryaWarn("LucasKanadeTracker_Projective::IterativelyRefineTrack_Translation", "Template drifted too far out of image.");
            return RESULT_OK;
          }
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_Projective::IterativelyRefineTrack_Translation", "numericalFailure");
            return RESULT_OK;
          }
      ...
      Result LucasKanadeTracker_Projective::IterativelyRefineTrack_Affine(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          if(numInBounds < 16) {
            LryaWarn("LucasKanadeTracker_Projective::IterativelyRefineTrack_Affine", "Template drifted too far out of image.");
            return RESULT_OK;
          }
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_Projective::IterativelyRefineTrack_Affine", "numericalFailure");
            return RESULT_OK;
          }
      ...
      Result LucasKanadeTracker_Projective::IterativelyRefineTrack_Projective(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          if(numInBounds < 16) {
            LryaWarn("LucasKanadeTracker_Projective::IterativelyRefineTrack_Projective", "Template drifted too far out of image.");
            return RESULT_OK;
          }
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_Projective::IterativelyRefineTrack_Projective", "numericalFailure");
            return RESULT_OK;
          }
