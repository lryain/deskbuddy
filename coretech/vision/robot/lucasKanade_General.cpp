    ...
    namespace TemplateTracker
    {
      ...
      , isValid(false)
      {
        ...
        LryaConditionalErrorAndReturn(templateImageHeight > 0 && templateImageWidth > 0,
          "LucasKanadeTracker_Generic::LucasKanadeTracker_Generic", "template widths and heights must be greater than zero, and multiples of %d", LRYA_VISION_IMAGE_WIDTH_MULTIPLE);
        ...
        LryaConditionalErrorAndReturn(transformType <= maxSupportedTransformType,
