  ...
  namespace Embedded
  {
    namespace Transformations
    {
      ...
      Result PlanarTransformation_f32::Init(const TransformType transformType, const Quadrilateral<f32> &initialCorners, const Array<f32> &initialHomography, const Point<f32> &centerOffset, MemoryStack &memory)
      {
        ...
        LryaConditionalErrorAndReturnValue(transformType==TRANSFORM_TRANSLATION || transformType==TRANSFORM_AFFINE || transformType==TRANSFORM_PROJECTIVE,
      ...
      {
        LryaConditionalErrorAndReturnValue(update.IsValid(),
          RESULT_FAIL_INVALID_OBJECT, "PlanarTransformation_f32::Update", "update is not valid");

        LryaConditionalErrorAndReturnValue(update.get_size(0) == 1,
        ...
        if(this->transformType == TRANSFORM_TRANSLATION) {
          LryaConditionalErrorAndReturnValue(updateType == TRANSFORM_TRANSLATION,
          ...
          LryaConditionalErrorAndReturnValue(updateType == TRANSFORM_TRANSLATION || updateType == TRANSFORM_AFFINE,
            RESULT_FAIL_INVALID_PARAMETER, "PlanarTransformation_f32::Update", "cannot update this transform with the update type %d", updateType);
        } else if(this->transformType == TRANSFORM_PROJECTIVE) {
          LryaConditionalErrorAndReturnValue(updateType == TRANSFORM_TRANSLATION|| updateType == TRANSFORM_AFFINE || updateType == TRANSFORM_PROJECTIVE,
            RESULT_FAIL_INVALID_PARAMETER, "PlanarTransformation_f32::Update", "cannot update this transform with the update type %d", updateType);
        } else {
          LryaAssert(false);
        }
        ...
        if(updateType == TRANSFORM_TRANSLATION) {
          LryaConditionalErrorAndReturnValue(update.get_size(1) == TRANSFORM_TRANSLATION>>8,
            RESULT_FAIL_INVALID_SIZE, "PlanarTransformation_f32::Update", "update is the incorrect size");
          ...
          if(updateType == TRANSFORM_AFFINE) {
            LryaConditionalErrorAndReturnValue(update.get_size(1) == TRANSFORM_AFFINE>>8,
              RESULT_FAIL_INVALID_SIZE, "PlanarTransformation_f32::Update", "update is the incorrect size");
            ...
            LryaConditionalErrorAndReturnValue(update.get_size(1) == TRANSFORM_PROJECTIVE>>8,
              RESULT_FAIL_INVALID_SIZE, "PlanarTransformation_f32::Update", "update is the incorrect size");
            ...
            LryaError("PlanarTransformation_f32::Update", "Unknown transformation type %d", updateType);
        ...
        ) const
      {
        ...
        LryaConditionalErrorAndReturnValue(in.get_size() == out.get_size(),
          RESULT_FAIL_INVALID_SIZE, "PlanarTransformation_f32::Transform", "input and output are different sizes");
      ...
      Result PlanarTransformation_f32::Deserialize(char *objectName, void** buffer, s32 &bufferLength, MemoryStack &memory)
      {
        ...
        LryaConditionalErrorAndReturnValue(this->homography.IsValid(),
      ...
      Result PlanarTransformation_f32::set_transformType(const TransformType transformType)
      {
        if(transformType == TRANSFORM_TRANSLATION || transformType == TRANSFORM_AFFINE || transformType == TRANSFORM_PROJECTIVE) {
          ...
          LryaError("PlanarTransformation_f32::set_transformType", "Unknown transformation type %d", transformType);
          return RESULT_FAIL_INVALID_PARAMETER;
        }
      ...
      Result PlanarTransformation_f32::set_homography(const Array<f32>& in)
      {
        ...
        //LryaAssert(FLT_NEAR(in[2][2], 1.0f));
      ...
      {
        LryaConditionalErrorAndReturnValue(AreValid(homography, xIn, yIn, xOut, yOut),
          RESULT_FAIL_INVALID_OBJECT, "PlanarTransformation_f32::TransformPoints", "Invalid objects");

        LryaConditionalErrorAndReturnValue(NotAliased(xIn, xOut, yIn, yOut),
        ...
        LryaConditionalErrorAndReturnValue(AreEqualSize(xIn, yIn, xOut, yOut),
        ...
        if(transformType == TRANSFORM_TRANSLATION) {
          ...
          LryaAssert(FLT_NEAR(homography[2][0], 0.0f));
          LryaAssert(FLT_NEAR(homography[2][1], 0.0f));
          LryaAssert(FLT_NEAR(homography[2][2], 1.0f));
        ...
        MemoryStack scratch) const
      {
        ...
        LryaConditionalErrorAndReturnValue(AreEqualSize(templateImage, nextImage),
