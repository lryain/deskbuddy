  ...
  namespace Embedded
  {
    namespace TemplateTracker
    {
        ...
        : isValid(false)
      {
        ...
        LryaConditionalErrorAndReturn(AreValid(templateImage, fastMemory, slowMemory),
        ...
        LryaConditionalErrorAndReturn(AreValid(this->templateEdges.xDecreasing, this->templateEdges.xIncreasing, this->templateEdges.yDecreasing, this->templateEdges.yIncreasing),
        ...
        LryaConditionalErrorAndReturn(this->templateIntegerCounts.IsValid() ,
          "BinaryTracker::BinaryTracker", "Could not allocate local memory");
        ...
        LryaConditionalErrorAndReturn(result == RESULT_OK,
      ...
      BinaryTracker::BinaryTracker(
        const Lrya::Vision::MarkerType markerType,
        const Array<u8> &templateImage,
        const Quadrilateral<f32> &templateQuad,
        ...
        : isValid(false)
      {
        ...
        //LryaConditionalErrorAndReturn(markerType == Lrya::Vision::MARKER_BATTERIES,
        //  "BinaryTracker::BinaryTracker", "markerType %d is not supported for header initialization", markerType);
        LryaError("BinaryTracker::BinaryTracker", "BinaryTracker needs to be updated now that Battery marker has been removed.");
        ...
        // Place the header image in the templateImage
        {
          ...
          if(false) { //markerType == Lrya::Vision::MARKER_BATTERIES) {
          ...
          LryaConditionalErrorAndReturn(binaryTemplate.IsValid(),
            "BinaryTracker::BinaryTracker", "Could not allocate local memory");
          ...
          LryaConditionalErrorAndReturn(binaryTemplateWithBorder.IsValid(),
            "BinaryTracker::BinaryTracker", "Could not allocate local memory");
      ...
      {
#if !LRYACORETECH_EMBEDDED_USE_OPENCV || defined(__GNUC__)
        return RESULT_FAIL;
#else
        //if(!this->IsValid())
        //  return RESULT_FAIL;
        ...
        MemoryStack slowScratch)
      {
        ...
        LryaConditionalErrorAndReturnValue(AreValid(nextImageEdges.xDecreasing, nextImageEdges.xIncreasing, nextImageEdges.yDecreasing, nextImageEdges.yIncreasing),
        ...
        MemoryStack scratch)
      {
        ...
        // Update the transformation
        {
          ...
          if(numericalFailure){
            LryaWarn("BinaryTracker::IterativelyRefineTrack_Projective", "numericalFailure");
            return RESULT_OK;
          }
        ...
        MemoryStack slowScratch)
      {
        ...
        // Update the transformation
        {
          ...
          if(numericalFailure){
            LryaWarn("BinaryTracker::IterativelyRefineTrack_List_Projective", "numericalFailure");
            return RESULT_OK;
          }
      ...
      s32 BinaryTracker::get_serializationSize() const
      {
        ...
        LryaAssert(numTemplatePixels < std::numeric_limits<s32>::max());
