...
#ifndef _LRYACORETECHEMBEDDED_VISION_TRANSFORMATIONS_H_
#define _LRYACORETECHEMBEDDED_VISION_TRANSFORMATIONS_H_
...
#endif //_LRYACORETECHEMBEDDED_VISION_TRANSFORMATIONS_H_
