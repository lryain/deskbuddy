...
#ifndef _LRYACORETECHEMBEDDED_COMMON_OPENCVLIGHT_VISION_H_
#define _LRYACORETECHEMBEDDED_COMMON_OPENCVLIGHT_VISION_H_
...
#endif // _LRYACORETECHEMBEDDED_COMMON_OPENCVLIGHT_VISION_H_
