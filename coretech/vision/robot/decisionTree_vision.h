...
#ifndef _LRYACORETECHEMBEDDED_VISION_DECISION_TREE_H_
#define _LRYACORETECHEMBEDDED_VISION_DECISION_TREE_H_
...
#endif // _LRYACORETECHEMBEDDED_VISION_DECISION_TREE_H_
