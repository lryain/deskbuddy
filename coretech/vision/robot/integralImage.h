...
#ifndef _LRYACORETECHEMBEDDED_VISION_INTEGRAL_IMAGE_H_
#define _LRYACORETECHEMBEDDED_VISION_INTEGRAL_IMAGE_H_
...
namespace Lrya
{
  namespace Embedded
  {
    ...
    {
      LryaAssert(AreValid(*this, output));

      // TODO: support these
      LryaAssert(filter.left <= 0);
      LryaAssert(filter.top <= 0);
      LryaAssert(filter.right >= 0);
      LryaAssert(filter.bottom >= 0);
...
#endif // _LRYACORETECHEMBEDDED_VISION_INTEGRAL_IMAGE_H_
