...
#ifndef _LRYACORETECHEMBEDDED_VISION_DRAW_VISION_DECLARATIONS_H_
#define _LRYACORETECHEMBEDDED_VISION_DRAW_VISION_DECLARATIONS_H_
...
#endif // _LRYACORETECHEMBEDDED_VISION_DRAW_VISION_DECLARATIONS_H_
