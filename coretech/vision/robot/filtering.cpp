  ...
  namespace Embedded
  {
    namespace ImageProcessing
    {
      template<> Result BinomialFilter<u8,u8,u8>(const Array<u8> &image, Array<u8> &imageFiltered, MemoryStack scratch)
      {
        ...
        LryaAssert(imageFilteredTmp.get_stride() % sizeof(u8) == 0);
      ...
      */
        ...
        Array<u8> &imageNorm, MemoryStack scratch)
      {
        ...
        LryaConditionalErrorAndReturnValue(image.IsValid(),
        ...
        LryaConditionalErrorAndReturnValue(imageNorm.IsValid(),
          RESULT_FAIL_INVALID_OBJECT,
          "BoxFilterNormalize",
          "Output normalized image is invalid.");

        LryaConditionalErrorAndReturnValue(AreEqualSize(image, imageNorm),
        ...
        LryaConditionalErrorAndReturnValue(integralImage.IsValid(),
      ...
      {
        LryaConditionalErrorAndReturnValue(image.IsValid() && filtered.IsValid(),
        ...
        LryaConditionalErrorAndReturnValue(imageWidth%8 == 0,
        ...
        LryaConditionalWarn(boxHeight*boxWidth <= 256,
      ...
      Result DownsampleBilinear(const Array<u8> &in, Array<u8> &out, MemoryStack scratch)
      {
        ...
        LryaConditionalErrorAndReturnValue(scale.x > 1.0f && scale.y > 1.0f,
        ...
        LryaConditionalErrorAndReturnValue(AreValid(inX0s_S32, inX1s_S32, alphaXs),
      ...
      Result FastGradient(const Array<u8> &in, Array<s8> &dx, Array<s8> &dy, MemoryStack scratch)
      {
        ...
        LryaConditionalErrorAndReturnValue(in.IsValid() && dy.IsValid() && dx.IsValid() && scratch.IsValid(),
