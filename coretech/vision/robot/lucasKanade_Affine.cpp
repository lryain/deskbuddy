    ...
    namespace TemplateTracker
    {
      ...
      Result LucasKanadeTracker_Affine::IterativelyRefineTrack_Translation(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          if(numInBounds < 16) {
            LryaWarn("LucasKanadeTracker_Affine::IterativelyRefineTrack_Translation", "Template drifted too far out of image.");
            return RESULT_OK;
          }
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_Affine::IterativelyRefineTrack_Translation", "numericalFailure");
            return RESULT_OK;
          }
      ...
      Result LucasKanadeTracker_Affine::IterativelyRefineTrack_Affine(const Array<u8> &nextImage, const s32 maxIterations, const s32 whichScale, const f32 convergenceTolerance, bool &verify_converged, MemoryStack scratch)
      {
        ...
        for(s32 iteration=0; iteration<maxIterations; iteration++) {
          ...
          if(numInBounds < 16) {
            LryaWarn("LucasKanadeTracker_Affine::IterativelyRefineTrack_Affine", "Template drifted too far out of image.");
            return RESULT_OK;
          }
          ...
          if(numericalFailure){
            LryaWarn("LucasKanadeTracker_Affine::IterativelyRefineTrack_Affine", "numericalFailure");
            return RESULT_OK;
          }
