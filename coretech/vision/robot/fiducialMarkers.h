...
#ifndef _LRYACORETECHEMBEDDED_VISION_FIDUCIAL_MARKER_H_
#define _LRYACORETECHEMBEDDED_VISION_FIDUCIAL_MARKER_H_
...
// #define RECOGNITION_METHOD RECOGNITION_METHOD_DECISION_TREES
...
{ 
  namespace Embedded
  {
    ...
    public:
      ...
      VisionMarkerImages(const s32 numDatabaseImages, const s32 databaseImageHeight, const s32 databaseImageWidth, u8 * pDatabaseImages, Lrya::Vision::MarkerType * pDatabaseLabelIndexes);
      ...
      const FixedLengthList<Lrya::Vision::MarkerType>& get_databaseLabelIndexes();
    ...
    protected:
      ...
      FixedLengthList<Lrya::Vision::MarkerType> databaseLabelIndexes; // (aka name, aka codeName)
...
#endif // _LRYACORETECHEMBEDDED_VISION_FIDUCIAL_MARKER_H_
