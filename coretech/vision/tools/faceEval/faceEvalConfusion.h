...
#ifndef __Lrya_Coretech_Vision_FaceConfusionEval_H__
#define __Lrya_Coretech_Vision_FaceConfusionEval_H__
...
#endif /* __Lrya_Coretech_Vision_FaceConfusionEval_H__ */
