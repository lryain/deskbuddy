...
#ifndef __Lrya_Coretech_Vision_FaceEval_SimpleArgParser_H__
#define __Lrya_Coretech_Vision_FaceEval_SimpleArgParser_H__
...
#endif /* __Lrya_Coretech_Vision_FaceEval_SimpleArgParser_H__ */
