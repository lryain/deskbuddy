...
#ifndef __Lrya_Coretech_Vision_FaceDetectionEval_H__
#define __Lrya_Coretech_Vision_FaceDetectionEval_H__
...
#endif /* __Lrya_Coretech_Vision_FaceDetectionEval_H__ */
