...
: IFaceEval(argParser)
{
  ...
  NativeLryaUtilConsoleSetValueWithString("DetectionMode", (_params.useStillMode ? "Still" : "Movie"));
  NativeLryaUtilConsoleSetValueWithString("DelayCount", std::to_string(_params.delayCount).c_str());
  NativeLryaUtilConsoleSetValueWithString("LostMaxRetry", "0");
  NativeLryaUtilConsoleSetValueWithString("LostMaxHold", "0");
  NativeLryaUtilConsoleSetValueWithString("FaceDetectionThreshold", std::to_string(_params.detectionThreshold*1000).c_str());
