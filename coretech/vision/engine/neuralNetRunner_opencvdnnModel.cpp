...
#if defined(LRYA_NEURALNETS_USE_OPENCVDNN)
...
# define GetFromConfig(keyName) \
  ...
  if(!LRYA_VERIFY(Util::IsFltGEZero(_params.min_score) && Util::IsFltLE(_params.min_score, 1.f),
...
#endif /* defined(LRYA_NEURALNETS_USE_OPENCVDNN) */
