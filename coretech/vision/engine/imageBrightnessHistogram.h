...
#ifndef __Lrya_Vision_Basestation_ImageBrightnessHistogram_H__
#define __Lrya_Vision_Basestation_ImageBrightnessHistogram_H__
...
#endif /* __Lrya_Vision_Basestation_ImageBrightnessHistogram_H__ */
