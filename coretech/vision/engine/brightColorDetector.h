 ...
 */
#ifndef __Lrya_Vision_BrightColorDetector_H__
#define __Lrya_Vision_BrightColorDetector_H__
...
private:
   ...
   *
   * @note Requires LRYACORETECH_USE_OPENCV to be on, otherwise it always returns 0.f
...
#endif /* __Lrya_Vision_BrightColorDetector_H_ */
