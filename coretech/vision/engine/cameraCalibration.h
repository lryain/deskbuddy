...
#ifndef LRYA_CORETECH_VISION_BASESTATION_CAMERA_CALIBRATION_H_
#define LRYA_CORETECH_VISION_BASESTATION_CAMERA_CALIBRATION_H_
...
namespace Lrya {
  ...
  namespace Vision {
    ...
    inline Radians CameraCalibration::ComputeVerticalFOV() const {
      return Radians(2.f*atan2f(0.5f*static_cast<f32>(GetNrows()),
                                     GetFocalLength_y()));
    }
    
    inline Radians CameraCalibration::ComputeHorizontalFOV() const {
      return Radians(2.f*atan2f(0.5f*static_cast<f32>(GetNcols()),
                                     GetFocalLength_x()));
    }
...
#endif // LRYA_CORETECH_VISION_BASESTATION_CAMERA_CALIBRATION_H_
