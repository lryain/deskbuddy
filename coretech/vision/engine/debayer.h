...
#ifndef __Lrya_Coretech_Vision_Debayer_H__
#define __Lrya_Coretech_Vision_Debayer_H__
...
public:
  ...
  /**
   * @brief Invoke debayering, return Lrya::Result::RESULT_SUCCESS on success and Lrya::Result::RESULT_FAIL otherwise.
   */
...
#endif /* __Lrya_Coretech_Vision_Debayer_H__ */
