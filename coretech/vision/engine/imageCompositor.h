...
#ifndef __Lrya_Coretech_Vision_Engine_ImageCompositor_H__
#define __Lrya_Coretech_Vision_Engine_ImageCompositor_H__
...
#endif /* __Lrya_Coretech_Vision_Engine_ImageCompositor_H__ */
