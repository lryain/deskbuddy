...
#ifndef LRYA_VISION_OBSERVABLE_OBJECT_H
#define LRYA_VISION_OBSERVABLE_OBJECT_H
...
namespace Lrya {
  namespace Vision {
    ...
    inline void ObservableObject::SetColor(const Lrya::ColorRGBA &color) {
      _color = color;
    }
...
#endif // LRYA_VISION_OBSERVABLE_OBJECT_H
