...
% im1 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00189.png'), [480,640]/8));
% im2 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00190.png'), [480,640]/8));
...
% im101 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00100.png'), [480,640]/8));
% im102 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00101.png'), [480,640]/8));
% templateQuad = [8.5213, 30.3085; 27.9255, 30.5638; 26.7766, 49.8404; 8.3936, 49.2021];
% test_lucasKanade2(im101, im102, templateQuad)

% im101 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00100.png'), [480,640]/2));
% im102 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00101.png'), [480,640]/2));
% templateQuad = [8.5213, 30.3085; 27.9255, 30.5638; 26.7766, 49.8404; 8.3936, 49.2021]*4;
% test_lucasKanade2(im101, im102, templateQuad)

% im315 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00315.png'), [480,640]/8));
% im316 = rgb2gray(imresize(imread('C:\Lrya\blockImages\blockImages00316.png'), [480,640]/8));
