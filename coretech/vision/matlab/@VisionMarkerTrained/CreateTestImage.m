...
imageSize = [320 240];
resolutionScaling = 2;
headerFilename = '~/Code/deskmate/lib/lrya/cozmo-engine/robot/test/data/newFiducials_320x240';
maxImages = 24;
figureColor = 'k';
...
uicontrol('Style', 'pushbutton', ...
    ...
    function writeFileFcn(src,~)
        ...
        fprintf(fid, 'const Lrya::Vision::MarkerType markerTypes_groundTruth[numMarkers_groundTruth] = {\n');
        for iMarkerNest = 1:numImages
            fprintf(fid, '\tLrya::Vision::MARKER_%s,\n', names{iMarkerNest});
        end
        fprintf(fid, '};\n\n');
