...
nearestNeighborString = sprintf( [...
  '// Autogenerated by VisionMarkerTrained.%s() on %s with Matlab %s\n\n' ...
  '// NOTE: (X,Y) probe locations are stored as SQ%d.%d\n\n' ...
  '#ifndef LRYA_COZMO_ROBOT_NEAREST_NEIGHBOR_LIBRARY_DATA_H\n' ...
  '#define LRYA_COZMO_ROBOT_NEAREST_NEIGHBOR_LIBRARY_DATA_H\n\n' ...
  ...
  mfilename, dateString, version, 15-numFractionalBits, numFractionalBits, ...
...
markerDefString = sprintf([ ...
    '// Autogenerated by VisionMarkerTrained.%s() on %s with Matlab %s\n\n' ...
    '#ifndef LRYA_COZMO_VISIONMARKERTYPES_H\n' ...
    '#define LRYA_COZMO_VISIONMARKERTYPES_H\n\n' ...
    ...
    mfilename, dateString, version, paramStr, dateString);
...
markerDefString = [markerDefString sprintf([ ...
  '} // namespace Vision\n' ...
  '} // namespace Lrya\n\n' ...
  '#endif // LRYA_COZMO_VISIONMARKERTYPES_H\n\n'])];
...
nearestNeighborString = [nearestNeighborString sprintf([ ...
    '} // namespace Embedded\n' ...
    '} // namespace Lrya\n\n' ...
    '#endif // LRYA_COZMO_ROBOT_NEAREST_NEIGHBOR_LIBRARY_DATA_H\n'])];
