...
function [tree, minimalTree, cTree, trainingFailures, testOnTrain_numCorrect, testOnTrain_numTotal] = decisionTree2_trainC(labelNames, labels, featureValues, probeLocationsXGrid, probeLocationsYGrid, varargin)
    ...
    %cTrainingExecutable = 'C:/Lrya/products-cozmo/build/Visual Studio 11/bin/RelWithDebInfo/run_trainDecisionTree.exe';
    cTrainingExecutable = 'C:/Lrya/products-cozmo/build/Visual Studio 11/bin/Debug/run_trainDecisionTree.exe';
    maxThreads = 4;
    maxSavingThreads = 8;
    ...
    if ~ispc()
        ...
        if ~isempty(strfind(cTrainingExecutable, 'C:/Lrya/products-cozmo'))
            cTrainingExecutable = [tildeToPath(), '/Documents/Lrya/products-cozmo/build/Xcode/bin/Debug/run_trainDecisionTree'];
%             cTrainingExecutable = [tildeToPath(), '/Documents/Lrya/products-cozmo/build/Xcode/bin/Release/run_trainDecisionTree'];
        end
    end
