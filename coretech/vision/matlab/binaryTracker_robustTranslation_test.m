...
% mask1 = imresize(imread('C:/Lrya/systemTestImages/cozmo_2014-01-29_11-41-05_12_mask.png'), [240,320]);
mask1 = imread('C:\Lrya\systemTestImages\cozmo_date2014_02_27_time14_56_37_frame0_mask.png');

%for i = 4:4:49
for i = 1:4:49
%     im1 = uint8(imresize(imread(sprintf('C:/Lrya/systemTestImages/cozmo_2014-01-29_11-41-05_%d.png',i-4)), [240,320]));
%     im2 = uint8(imresize(imread(sprintf('C:/Lrya/systemTestImages/cozmo_2014-01-29_11-41-05_%d.png',i)), [240,320]));
    im1 = uint8(imresize(imread(sprintf('C:/Lrya/systemTestImages/cozmo_date2014_02_27_time14_56_37_frame%d.png',i-1)), [240,320]));
    im2 = uint8(imresize(imread(sprintf('C:/Lrya/systemTestImages/cozmo_date2014_02_27_time14_56_37_frame%d.png',i)),   [240,320]));
