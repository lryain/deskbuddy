...
outputString = [outputString ...
    sprintf('const Lrya::Embedded::FiducialMarkerParserBit::Type bitTypes_type%d[NUM_BITS_TYPE_%d] = {\n', fiducialMarkerType, fiducialMarkerType) ...
    repmat('    Lrya::Embedded::FiducialMarkerParserBit::FIDUCIAL_BIT_NONE,\n', 1, numProbes) ...
    '};\n\n'];
