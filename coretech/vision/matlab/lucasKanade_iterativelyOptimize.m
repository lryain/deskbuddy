...
% im1 = imresize(im2double(rgb2gray(imread('C:\Lrya\blockImages\blockImages00020.png'))), [240,320]);
% im2 = imresize(im2double(rgb2gray(imread('C:\Lrya\blockImages\blockImages00021.png'))), [240,320]);
