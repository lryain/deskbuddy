...
#ifndef __Lrya_NeuralNets_NeuralNetModel_Interface_H__
#define __Lrya_NeuralNets_NeuralNetModel_Interface_H__
...
#endif /* __Lrya_NeuralNets_NeuralNetModel_Interface_H__ */
