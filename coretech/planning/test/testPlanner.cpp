...
GTEST_TEST(TestPlanner, PlanAroundBox)
{
  ...
  context.env.AddObstacleAllThetas(Lrya::RotatedRectangle(50.0, -10.0, 80.0, -10.0, 20.0));
...
GTEST_TEST(TestPlanner, PlanAroundBoxDumpAndImportContext)
{
  ...
  Lrya::Util::JsonWriter writer(jsonSS);
  context.Dump(writer);
  writer.Close();
...
GTEST_TEST(TestPlanner, PlanAroundBox_soft)
{
  ...
  context.env.AddObstacleAllThetas(Lrya::RotatedRectangle(50.0, -10.0, 80.0, -10.0, 20.0), 50.0);
  ...
  context.env.AddObstacleAllThetas(Lrya::RotatedRectangle(50.0, -10.0, 80.0, -10.0, 20.0), 1e-4);
...
GTEST_TEST(TestPlanner, MultipleGoalsWithSoftPenalty)
{
  ...
  Lrya::RotatedRectangle obstacleOnGoal0(150.0, -10.0, 250.0, -10.0, 20.0); // covers 0th goal
...
GTEST_TEST(TestPlanner, ReplanEasy)
{
  ...
  context.env.AddObstacleAllThetas(Lrya::RotatedRectangle(50.0, -100.0, 80.0, -100.0, 20.0));
...
GTEST_TEST(TestPlanner, ReplanHard)
{
  ...
  context.env.AddObstacleAllThetas(Lrya::RotatedRectangle(200.0, -10.0, 230.0, -10.0, 20.0));
