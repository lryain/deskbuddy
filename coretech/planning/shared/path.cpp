...
namespace Lrya
{
  namespace Planning
  {
                                                        ...
                                                        f32 *distAlongSegmentFromClosestPointToEnd) const
    {
      ...
      f32 r = seg->radius;
      Lrya::Radians startRad = seg->startRad;
      ...
      Lrya::Radians theta_line = ATAN2_FAST(dy,dx); // angle of line from circle center to robot
      Lrya::Radians theta_tangent = theta_line + Lrya::Radians((movingCCW ? 1 : -1 ) * M_PI_2_F);
