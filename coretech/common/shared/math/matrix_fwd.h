...
#ifndef _LRYACORETECH_MATRIX_H_
#define _LRYACORETECH_MATRIX_H_

static_assert(LRYACORETECH_USE_OPENCV, "Matrix class implementations require OpenCV");
