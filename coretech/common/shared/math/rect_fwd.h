...
#ifndef _LRYACORETECH_COMMON_RECT_H_
#define _LRYACORETECH_COMMON_RECT_H_

static_assert(LRYACORETECH_USE_OPENCV, "Rectangle implementation requires OpenCV");
...
#endif // _LRYACORETECH_COMMON_RECT_H_
