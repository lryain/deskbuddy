...
#ifndef _LRYACORETECH_COMMON_ARRAY2D_H_
#define _LRYACORETECH_COMMON_ARRAY2D_H_
...
static_assert(LRYACORETECH_USE_OPENCV, "Array2d implementation requires OpenCV");
...
#endif // _LRYACORETECH_COMMON_ARRAY2D_H_
