...
#ifndef _LRYACORETECHEMBEDDED_COMMON_SHARED_UTILITIES_H_
#define _LRYACORETECHEMBEDDED_COMMON_SHARED_UTILITIES_H_
...
#endif // _LRYACORETECHEMBEDDED_COMMON_SHARED_UTILITIES_H_
