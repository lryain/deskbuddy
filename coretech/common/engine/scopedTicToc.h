 ...
 *              Can be compiled out using LRYA_ALLOW_SCOPED_TICTOC=0 (e.g. in SHIPPING)
...
#ifndef LRYA_ALLOW_SCOPED_TICTOC
#  if LRYA_DEV_CHEATS
#    define LRYA_ALLOW_SCOPED_TICTOC 1
#  else
#    define LRYA_ALLOW_SCOPED_TICTOC 0
#  endif
#endif
...
# endif
  ...
  ~ScopedTicToc()
  {
    if(LRYA_ALLOW_SCOPED_TICTOC && _enabled)
    {
