...
#ifndef LRYA_COMMON_BASESTATION_MATH_LINEAR_ALGEBRA_IMPL_H
#define LRYA_COMMON_BASESTATION_MATH_LINEAR_ALGEBRA_IMPL_H
...
#endif // LRYA_COMMON_BASESTATION_MATH_LINEAR_ALGEBRA_IMPL_H
