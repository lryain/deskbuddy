 ...
 *
 *
 * Description: Implements templated methods for a general N-dimensional Quadrilateral class for holding
...
#ifndef _LRYACORETECH_COMMON_QUAD_IMPL_H_
#define _LRYACORETECH_COMMON_QUAD_IMPL_H_
...
static_assert(LRYACORETECH_USE_OPENCV, "Quad implementation requires OpenCV");
...
#endif // _LRYACORETECH_COMMON_QUAD_H_
