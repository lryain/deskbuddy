...
#ifndef __Lrya_Coretech_Common_PoseOriginList_H__
#define __Lrya_Coretech_Common_PoseOriginList_H__
...
public:
  ...
  // LRYA_VERIFY that each origin is still "owned". Return false if not.
...
#endif // __Lrya_Coretech_Common_PoseOriginList_H__
