 ...
 *        To get the implementations, you must include poseBase.h.
 *
 * Copyright: Lrya, Inc. 2014
 *
 **/

#ifndef __Lrya_Common_Math_PoseBase_H__
#define __Lrya_Common_Math_PoseBase_H__
...
public:
  ...
  // If unowned parents are not allowed, then a parent will be LRYA_VERIFY'd to have an owner
...
#endif /* __Lrya_Common_Math_PoseBase_H__ */
