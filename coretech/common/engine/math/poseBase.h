...
#ifndef _LRYACORETECH_MATH_POSEBASE_IMPL_H_
#define _LRYACORETECH_MATH_POSEBASE_IMPL_H_
...
{
  if(!LRYA_VERIFY(!fromPose.IsNull() && !toPose.IsNull() && !P_wrt_other.IsNull(),
...
#endif // _LRYACORETECH_MATH_POSEBASE_IMPL_H_
