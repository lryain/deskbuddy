...
#ifndef _Lrya_Common_Basestation_Utils_Data_DataPlatform_H__
#define _Lrya_Common_Basestation_Utils_Data_DataPlatform_H__
...
public:
  ...
  // returns a key for the current platform/OS (eg: osx, android, mateos, ios)
...
#endif //_Lrya_Common_Basestation_Utils_Data_DataPlatform_H__
