...
#ifndef _LRYACORETECHEMBEDDED_COMMON_ARRAY_PATTERNS_DECLARATIONS_H_
#define _LRYACORETECHEMBEDDED_COMMON_ARRAY_PATTERNS_DECLARATIONS_H_
...
#endif // _LRYACORETECHEMBEDDED_COMMON_ARRAY_PATTERNS_DECLARATIONS_H_
