...
#ifndef _LRYACORETECHEMBEDDED_COMMON_FIXED_LENGTH_LIST_DECLARATIONS_H_
#define _LRYACORETECHEMBEDDED_COMMON_FIXED_LENGTH_LIST_DECLARATIONS_H_
...
#endif // _LRYACORETECHEMBEDDED_COMMON_FIXEDLENGTHLIST_DECLARATIONS_H_
