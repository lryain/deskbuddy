...
#ifndef _LRYACORETECHEMBEDDED_COMMON_DECISION_TREE_H_
#define _LRYACORETECHEMBEDDED_COMMON_DECISION_TREE_H_
...
#endif // _LRYACORETECHEMBEDDED_COMMON_DECISION_TREE_H_
