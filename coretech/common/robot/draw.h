...
#ifndef _LRYACORETECHEMBEDDED_COMMON_DRAW_H_
#define _LRYACORETECHEMBEDDED_COMMON_DRAW_H_
...
namespace Lrya
{
  namespace Embedded
  {
    ...
    {
      LryaConditionalErrorAndReturnValue(AreValid(image, points),
...
#endif // _LRYACORETECHEMBEDDED_COMMON_DRAW_H_
