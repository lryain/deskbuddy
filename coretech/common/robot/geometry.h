...
#ifndef _LRYACORETECHEMBEDDED_COMMON_POINT_H_
#define _LRYACORETECHEMBEDDED_COMMON_POINT_H_
...
#pragma mark --- Pose Implementations ---
      ...
      MemoryStack scratch)
    {
      ...
      LryaAssert(AreEqualSize(3, 3, R1));
      LryaAssert(AreEqualSize(3, 3, R2));
      LryaAssert(AreEqualSize(3, 3, Rdiff));
...
#endif // _LRYACORETECHEMBEDDED_COMMON_POINT_H_
