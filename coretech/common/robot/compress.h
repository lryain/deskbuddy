...
#ifndef _LRYACORETECHEMBEDDED_COMMON_COMPRESS_H_
#define _LRYACORETECHEMBEDDED_COMMON_COMPRESS_H_
...
namespace Lrya
{
  namespace Embedded
  {
      ...
      MemoryStack &memory)
    {
      ...
      LryaConditionalErrorAndReturnValue(result == RESULT_OK,
...
#endif // _LRYACORETECHEMBEDDED_COMMON_COMPRESS_H_
