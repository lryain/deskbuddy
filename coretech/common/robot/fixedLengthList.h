...
#ifndef _LRYACORETECHEMBEDDED_COMMON_FIXED_LENGTH_LIST_H_
#define _LRYACORETECHEMBEDDED_COMMON_FIXED_LENGTH_LIST_H_
...
namespace Lrya
{
  namespace Embedded
  {
    ...
    {
      LryaAssert(index >= 0 && index < this->array.get_size(1));
    ...
    {
      LryaAssert(this->get_maximumSize() >= input.get_maximumSize());
...
#endif // _LRYACORETECHEMBEDDED_COMMON_FIXEDLENGTHLIST_H_
