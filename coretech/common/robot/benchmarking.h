...
#ifndef _LRYACORETECHEMBEDDED_COMMON_BENCHMARKING_H_
#define _LRYACORETECHEMBEDDED_COMMON_BENCHMARKING_H_

#include "coretech/common/robot/config.h"
#include "coretech/common/robot/fixedLengthList_declarations.h"

#if !defined(LRYA_EMBEDDED_BENCHMARK)
#if defined(NDEBUG)
#define LRYA_EMBEDDED_BENCHMARK 0
#else
#define LRYA_EMBEDDED_BENCHMARK 1
#endif
...
#endif // _LRYACORETECHEMBEDDED_COMMON_BENCHMARKING_H_
