  ...
  namespace Embedded
  {
    ...
    u32 __SADD8(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<4; i++) {
        ...
        LryaAssert(CLIP(sum, static_cast<s32>(std::numeric_limits<s8>::min()), static_cast<s32>(std::numeric_limits<s8>::max())) == sum);
    ...
    u32 __UADD8(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<4; i++) {
        ...
        LryaAssert(CLIP(sum, static_cast<u32>(0), static_cast<u32>(std::numeric_limits<u8>::max())) == sum);
    ...
    u32 __UHADD8(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<4; i++) {
        ...
        LryaAssert(sum <= std::numeric_limits<u8>::max());
    ...
    u32 __SHSUB8(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<4; i++) {
        ...
        LryaAssert(CLIP(result, static_cast<s32>(std::numeric_limits<s8>::min()), static_cast<s32>(std::numeric_limits<s8>::max())) == result);
    ...
    u32 __UHSUB8(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<4; i++) {
        ...
        LryaAssert(result <= std::numeric_limits<u8>::max());
    ...
    u32 __SADD16(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<2; i++) {
        ...
        LryaAssert(CLIP(sum, static_cast<s32>(std::numeric_limits<s16>::min()), static_cast<s32>(std::numeric_limits<s16>::max())) == sum);
    ...
    u32 __UADD16(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<2; i++) {
        ...
        LryaAssert(CLIP(sum, static_cast<u32>(0), static_cast<u32>(std::numeric_limits<u16>::max())) == sum);
    ...
    u32 __UHADD16(const u32 val1, const u32 val2)
    {
      ...
      for(s32 i=0; i<2; i++) {
        ...
        LryaAssert(sum <= std::numeric_limits<u16>::max());
