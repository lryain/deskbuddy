...
#ifndef _LRYACORETECHEMBEDDED_COMMON_MEMORY_H_
#define _LRYACORETECHEMBEDDED_COMMON_MEMORY_H_
...
#define PUSH_MEMORY_STACK(memoryStack) \
  const ::Lrya::Embedded::MemoryStack memoryStack ## _pushedTmp(memoryStack);\
  ::Lrya::Embedded::MemoryStack memoryStack(memoryStack ## _pushedTmp);
...
#endif // _LRYACORETECHEMBEDDED_COMMON_MEMORY_H_
