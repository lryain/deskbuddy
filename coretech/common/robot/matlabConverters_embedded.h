...
#ifndef _LRYA_CORETECH_EMBEDDED_MATLAB_CONVERTERS_H_
#define _LRYA_CORETECH_EMBEDDED_MATLAB_CONVERTERS_H_
...
namespace Embedded {
  ...
  // Convert a Matlab mxArray to an Lrya::Array, without allocating memory
  template<typename Type> void mxArrayToArray(const mxArray * const array, Array<Type> &mat);

  // Convert a Matlab mxArray to an Lrya::Array. Allocate and return the Lrya::Array
  ...
  // Convert an Lrya::Array to a Matlab mxArray. Allocate and return the mxArray
  ...
  template<typename Type> void mxArrayToArray(const mxArray * const array, Array<Type> &mat)
  {
    LryaConditionalError(mxGetNumberOfDimensions(array) == 2,
    ...
    if(mxGetM(array) != nrows || mxGetN(array) != ncols) {
      LryaError("mxArrayToArray", "Matlab array size does not match Lrya::Embedded::Array size: (%d x %d) vs (%d x %d)",
    ...
    if(matlabClassId != templateClassId) {
      LryaError("mxArrayToArray", "mxArrayToArray<Type>(array,mat) - Matlab classId does not match with template %d!=%d", matlabClassId, templateClassId);
      return;
    }
  ...
  template<typename Type> Array<Type> mxArrayToArray(const mxArray * const matlabArray, MemoryStack &memory)
  {
    ...
    if(numDimensions != 2) {
      LryaError("mxArrayToArray", "mxArrayToArray<Type> - Matlab array must be 2D");
      return Array<Type>();
    }
    
    if(mxIsCell(matlabArray)) {
      LryaError("mxArrayToArray", "Input can't be a cell array. Use mxCellArrayToArray() instead.");
    ...
    if(matlabClassId != templateClassId) {
      LryaError("mxArrayToArray", "mxArrayToArray<Type> - Matlab classId does not match with template %d!=%d", matlabClassId, templateClassId);
      return Array<Type>();
    }
    ...
    if(!array.IsValid()) {
      LryaError("mxArrayToArray", "mxArrayToArray<Type> - Could not allocate array");
      return Array<Type>();
    }
  ...
  template<typename Type> Array<Array<Type> > mxCellArrayToArray(const mxArray * const matlabArray, MemoryStack &memory)
  {
    ...
    if(numDimensions != 2) {
      LryaError("mxCellArrayToArray", "mxCellArrayToArray<Type> - Matlab array must be 2D");
      return Array<Array<Type> >();
    }
    
    if(!mxIsCell(matlabArray)) {
      LryaError("mxCellArrayToArray", "Input must be a cell array");
      return Array<Array<Type> >();
    }
    ...
    if(matlabClassId != templateClassId) {
      LryaError("mxCellArrayToArray", "mxCellArrayToArray<Type> - Matlab classId does not match with template %d!=%d", matlabClassId, templateClassId);
      return Array<Array<Type> >();
    }
    ...
    if(!array.IsValid()) {
      LryaError("mxCellArrayToArray", "mxCellArrayToArray<Type> - Could not allocate array");
      return Array<Array<Type> >();
    }
  ...
  inline char* mxArrayToString(const mxArray * const matlabArray, MemoryStack &memory)
  {
    ...
    LryaConditionalErrorAndReturnValue(matlabClassId == mxCHAR_CLASS,
    ...
    LryaConditionalErrorAndReturnValue(curMatlabString,
    ...
    LryaConditionalErrorAndReturnValue(curCString,
  ...
  inline Array<char *> mxCellArrayToStringArray(const mxArray * const matlabArray, MemoryStack &memory)
  {
    ...
    if(numDimensions != 2) {
      LryaError("mxCellArrayToStringArray", "mxCellArrayToStringArray - Matlab array must be 2D");
      return Array<char *>();
    }
    
    if(!mxIsCell(matlabArray)) {
      LryaError("mxCellArrayToStringArray", "Input must be a cell array");
      return Array<char *>();
    }
    ...
    if(matlabClassId != mxCHAR_CLASS) {
      LryaError("mxCellArrayToStringArray", "mxCellArrayToStringArray - Matlab classId does not match with template %d!=%d", matlabClassId, mxCHAR_CLASS);
      return Array<char *>();
    }
    ...
    if(!array.IsValid()) {
      LryaError("mxCellArrayToStringArray", "mxCellArrayToStringArray - Could not allocate array");
      return Array<char *>();
    }
...
#endif // _LRYA_CORETECH_EMBEDDED_MATLAB_CONVERTERS_H_
