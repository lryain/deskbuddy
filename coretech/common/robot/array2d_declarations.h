...
#ifndef _LRYACORETECHEMBEDDED_COMMON_ARRAY2D_DECLARATIONS_H_
#define _LRYACORETECHEMBEDDED_COMMON_ARRAY2D_DECLARATIONS_H_
...
namespace Lrya
{
  namespace Embedded
  {
    ...
    const char ARRAY_FILE_HEADER[ARRAY_FILE_HEADER_LENGTH+1] = "\x89" "LryaEArray1.2                  ";
...
#endif // _LRYACORETECHEMBEDDED_COMMON_ARRAY2D_DECLARATIONS_H_
