...
#ifndef _LRYACORETECHEMBEDDED_COMMON_POINT_DECLARATIONS_H_
#define _LRYACORETECHEMBEDDED_COMMON_POINT_DECLARATIONS_H_
...
#endif // _LRYACORETECHEMBEDDED_COMMON_POINT_DECLARATIONS_H_
