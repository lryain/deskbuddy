...
#ifndef _LRYACORETECHEMBEDDED_COMMON_GTEST_LIGHT_H_
#define _LRYACORETECHEMBEDDED_COMMON_GTEST_LIGHT_H_

#include "coretech/common/robot/config.h"

#if LRYACORETECH_EMBEDDED_USE_GTEST
...
#else // #if LRYACORETECH_EMBEDDED_USE_GTEST
...
#define ASSERT_TRUE(condition)\
  if(!(condition)) { \
  _Lrya_Log(LRYA_LOG_LEVEL_ERROR,\
...
#endif // #if LRYACORETECH_EMBEDDED_USE_GTEST ... #else

#endif // #ifndef _LRYACORETECHEMBEDDED_COMMON_GTEST_LIGHT_H_
