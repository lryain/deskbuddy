...
#ifndef _LRYACORETECHEMBEDDED_COMMON_CONFIG_H_
#define _LRYACORETECHEMBEDDED_COMMON_CONFIG_H_
...
// To make processing faster, some kernels require image widths that are a multiple of LRYA_VISION_IMAGE_WIDTH_MULTIPLE
#define LRYA_VISION_IMAGE_WIDTH_SHIFT 4
#define LRYA_VISION_IMAGE_WIDTH_MULTIPLE (1<<LRYA_VISION_IMAGE_WIDTH_SHIFT)
...
#define LRYA_OUTPUT_DEBUG_NONE 0
#define LRYA_OUTPUT_DEBUG_PRINTF 10

#endif // _LRYACORETECHEMBEDDED_COMMON_CONFIG_H_
