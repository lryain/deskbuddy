...
#ifndef __Lrya_Vector_AnimationStreamer_H__
#define __Lrya_Vector_AnimationStreamer_H__
...
namespace Anim {
  ...
  public:
    ...
    // TODO: This could be removed in favor of just referring to ::Lrya::Cozmo, but avoiding touching too much code now.
    static const Tag kNotAnimatingTag = ::Lrya::Vector::kNotAnimatingTag;
...
#endif /* __Lrya_Vector_AnimationStreamer_H__ */
