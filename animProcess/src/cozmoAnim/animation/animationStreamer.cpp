...
#undef CONSOLE_GROUP
  ...
  Result AnimationStreamer::SetProceduralFace(const ProceduralFace& face, u32 duration_ms)
  {
    ...
    if (!(LRYA_VERIFY(RESULT_OK == result, "AnimationStreamer.SetProceduralFace.FailedToCreateAnim", "")))
    {
      return result;
    }
...
#     undef DEBUG_STREAM_KEYFRAME_MESSAGE
  ...
  {
    LRYA_CPU_PROFILE("AnimationStreamer::GetStreamableFace");
    ...
    else
    {
      ...
      if (s_faceDataReset)
      {
        ...
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_OverrideEyeParams");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_OverrideRightEyeParams");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_Gamma");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_FromLinear");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_ToLinear");

        NativeLryaUtilConsoleResetValueToDefault("ProcFace_DefaultScanlineOpacity");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_NominalEyeSpacing");
        ...
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_NoiseNumFrames");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_NoiseMinLightness");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_NoiseMaxLightness");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_NoiseFraction");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_NoiseFraction");

        NativeLryaUtilConsoleResetValueToDefault("ProcFace_UseAntiAliasedLines");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_EyeLightnessMultiplier");

        NativeLryaUtilConsoleResetValueToDefault("ProcFace_HotspotRender");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_HotspotFalloff");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_GlowRender");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_GlowSizeMultiplier");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_GlowLightnessMultiplier");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_GlowGaussianFilter");

        NativeLryaUtilConsoleResetValueToDefault("ProcFace_AntiAliasingSize");
        NativeLryaUtilConsoleResetValueToDefault("ProcFace_AntiAliasingGaussianFilter");
...
// 目前，这种情况仅出现在复合天气动画和唤醒词动画中，这两种动画都会绕过动作系统的轨道锁定。 
  ...
  {
    LRYA_CPU_PROFILE("AnimationStreamer::InsertStreamableFaceIntoCompImg");
                                                 ...
                                                 AnimationMessageWrapper& messageWrapper) const
  {
    ...
    if (_onCharger && _frozenOnCharger)
    {
      ...
      // on the floor.
      Lrya::Util::SafeDelete(messageWrapper.bodyMotionMessage);
      Lrya::Util::SafeDelete(messageWrapper.moveLiftMessage);
      Lrya::Util::SafeDelete(messageWrapper.moveHeadMessage);
      Lrya::Util::SafeDelete(messageWrapper.audioKeyFrameMessage);
    }
