...
namespace {
  ...
  Lrya::Vector::Anim::AnimEngine*             _animEngine = nullptr;
  Lrya::Vector::Anim::AnimationStreamer*            _animStreamer = nullptr;
  Lrya::Vector::Anim::StreamingAnimationModifier*   _streamingAnimationModifier = nullptr;
  Lrya::Vector::Audio::EngineRobotAudioInput* _engAudioInput = nullptr;
  Lrya::Vector::Audio::ProceduralAudioClient* _proceduralAudioClient = nullptr;
  const Lrya::Vector::Anim::AnimContext*      _context = nullptr;
  ...
  Lrya::Util::Dispatch::Queue* _dispatchQueue = nullptr;
  ...
  static void AddAnimation(ConsoleFunctionContextRef context)
  {
    ...
    if (path) {
      const std::string animationFolder = _context->GetDataPlatform()->pathToResource(Lrya::Util::Data::Scope::Resources, "/assets/animations/");
      ...
      Lrya::Util::Dispatch::Async(_dispatchQueue, [animationPath] {
...
void Process_checkCloudConnectivity(const Lrya::Vector::RobotInterface::CheckCloudConnectivity& msg)
{
  auto* micDataSystem = _context->GetMicDataSystem();
  if (micDataSystem != nullptr) {
...
void Process_setFullAnimTrackLockState(const Lrya::Vector::RobotInterface::SetFullAnimTrackLockState& msg)
{
...
void Process_addAnim(const Lrya::Vector::RobotInterface::AddAnim& msg)
{
...
void Process_playAnim(const Lrya::Vector::RobotInterface::PlayAnim& msg)
{
...
void Process_abortAnimation(const Lrya::Vector::RobotInterface::AbortAnimation& msg)
{
  LOG_INFO("AnimProcessMessages.Process_abortAnimation", "Tag: %d", msg.tag);
  _animStreamer->Abort(msg.tag);
}

void Process_displayProceduralFace(const Lrya::Vector::RobotInterface::DisplayProceduralFace& msg)
{
...
void Process_setFaceHue(const Lrya::Vector::RobotInterface::SetFaceHue& msg)
{
  ProceduralFace::SetHue(msg.hue);
}

void Process_setFaceSaturation(const Lrya::Vector::RobotInterface::SetFaceSaturation& msg)
{
  ProceduralFace::SetSaturation(msg.saturation);
}

void Process_displayFaceImageBinaryChunk(const Lrya::Vector::RobotInterface::DisplayFaceImageBinaryChunk& msg)
{
  _animStreamer->Process_displayFaceImageChunk(msg);
}

void Process_displayFaceImageGrayscaleChunk(const Lrya::Vector::RobotInterface::DisplayFaceImageGrayscaleChunk& msg)
{
  _animStreamer->Process_displayFaceImageChunk(msg);
}

void Process_displayFaceImageRGBChunk(const Lrya::Vector::RobotInterface::DisplayFaceImageRGBChunk& msg)
{
  _animStreamer->Process_displayFaceImageChunk(msg);
}

void Process_playAnimWithSpriteBoxRemaps(const Lrya::Vector::RobotInterface::PlayAnimWithSpriteBoxRemaps& msg)
{
  _animStreamer->Process_playAnimWithSpriteBoxRemaps(msg);
}

void Process_playAnimWithSpriteBoxKeyFrames(const Lrya::Vector::RobotInterface::PlayAnimWithSpriteBoxKeyFrames& msg)
{
  _animStreamer->Process_playAnimWithSpriteBoxKeyFrames(msg);
}

void Process_addSpriteBoxKeyFrames(const Lrya::Vector::RobotInterface::AddSpriteBoxKeyFrames& msg)
{
  _animStreamer->Process_addSpriteBoxKeyFrames(msg);
}

void Process_enableKeepFaceAlive(const Lrya::Vector::RobotInterface::EnableKeepFaceAlive& msg)
{
  _animStreamer->EnableKeepFaceAlive(msg.enable, msg.disableTimeout_ms);
}

void Process_setKeepFaceAliveFocus(const Lrya::Vector::RobotInterface::SetKeepFaceAliveFocus& msg)
{
  _animStreamer->SetKeepFaceAliveFocus(msg.enable);
}

void Process_addOrUpdateEyeShift(const Lrya::Vector::RobotInterface::AddOrUpdateEyeShift& msg)
{
  _animStreamer->ProcessAddOrUpdateEyeShift(msg);
}

void Process_removeEyeShift(const Lrya::Vector::RobotInterface::RemoveEyeShift& msg)
{
  _animStreamer->ProcessRemoveEyeShift(msg);
}

void Process_addSquint(const Lrya::Vector::RobotInterface::AddSquint& msg)
{
  _animStreamer->ProcessAddSquint(msg);
}

void Process_removeSquint(const Lrya::Vector::RobotInterface::RemoveSquint& msg)
{
  _animStreamer->ProcessRemoveSquint(msg);
}

void Process_postAudioEvent(const Lrya::AudioEngine::Multiplexer::PostAudioEvent& msg)
{
  _engAudioInput->HandleMessage(msg);
}

void Process_stopAllAudioEvents(const Lrya::AudioEngine::Multiplexer::StopAllAudioEvents& msg)
{
  _engAudioInput->HandleMessage(msg);
}

void Process_postAudioGameState(const Lrya::AudioEngine::Multiplexer::PostAudioGameState& msg)
{
  _engAudioInput->HandleMessage(msg);
}

void Process_postAudioSwitchState(const Lrya::AudioEngine::Multiplexer::PostAudioSwitchState& msg)
{
  _engAudioInput->HandleMessage(msg);
}

void Process_postAudioParameter(const Lrya::AudioEngine::Multiplexer::PostAudioParameter& msg)
{
  _engAudioInput->HandleMessage(msg);
}

void Process_setDebugConsoleVarMessage(const Lrya::Vector::RobotInterface::SetDebugConsoleVarMessage& msg)
{
...
void Process_startRecordingMicsRaw(const Lrya::Vector::RobotInterface::StartRecordingMicsRaw& msg)
{
  auto* micDataSystem = _context->GetMicDataSystem();
  if (micDataSystem == nullptr)
  {
...
void Process_startRecordingMicsProcessed(const Lrya::Vector::RobotInterface::StartRecordingMicsProcessed& msg)
{
  auto* micDataSystem = _context->GetMicDataSystem();
  if (micDataSystem == nullptr)
  {
...
void Process_startWakeWordlessStreaming(const Lrya::Vector::RobotInterface::StartWakeWordlessStreaming& msg)
{
  auto* micDataSystem = _context->GetMicDataSystem();
  if(micDataSystem == nullptr){
    return;
...
void Process_setTriggerWordResponse(const Lrya::Vector::RobotInterface::SetTriggerWordResponse& msg)
{
...
void Process_setLCDBrightnessLevel(const Lrya::Vector::RobotInterface::SetLCDBrightnessLevel& msg)
{
  FaceDisplay::getInstance()->SetFaceBrightness(msg.level);
}

void Process_playbackAudioStart(const Lrya::Vector::RobotInterface::StartPlaybackAudio& msg)
{
...
void Process_drawTextOnScreen(const Lrya::Vector::RobotInterface::DrawTextOnScreen& msg)
{
  FaceInfoScreenManager::getInstance()->SetCustomText(msg);
}

void Process_runDebugConsoleFuncMessage(const Lrya::Vector::RobotInterface::RunDebugConsoleFuncMessage& msg)
{
  // We are using messages generated by the CppLite emitter here, which does not support
  // variable length arrays. CLAD also doesn't have a char, so the "strings" in this message
  // are actually arrays of uint8's. Thus we need to do this reinterpret cast here.
  ...
  // TODO: Ideally, we'd send back a verify message that we (failed to) set this
  Lrya::Util::IConsoleFunction* consoleFunc = Lrya::Util::ConsoleSystem::Instance().FindFunction(funcName);
  if (consoleFunc) {
    enum { kBufferSize = 512 };
    char buffer[kBufferSize];
    const uint32_t res = NativeLryaUtilConsoleCallFunction(funcName, funcArgs, kBufferSize, buffer);
...
void Process_setConnectionStatus(const Lrya::Vector::SwitchboardInterface::SetConnectionStatus& msg)
{
...
void Process_showUrlFace(const RobotInterface::ShowUrlFace& msg)
{
  if(msg.show) {
    using namespace SwitchboardInterface;
    Lrya::Vector::SwitchboardInterface::SetConnectionStatus connMsg;
...
void Process_setBLEPin(const Lrya::Vector::SwitchboardInterface::SetBLEPin& msg)
{
  SetBLEPin(msg.pin);
}

void Process_rangeDataToDisplay(const Lrya::Vector::RobotInterface::RangeDataToDisplay& msg)
{
  FaceInfoScreenManager::getInstance()->DrawToF(msg.data);
}

void Process_sendBLEConnectionStatus(const Lrya::Vector::SwitchboardInterface::SendBLEConnectionStatus& msg)
{
  // todo
}
...
void Process_acousticTestEnabled(const Lrya::Vector::RobotInterface::AcousticTestEnabled& msg)
{
...
static void HandleRobotStateUpdate(const Lrya::Vector::RobotState& robotState)
{
...
Result AnimProcessMessages::Update(BaseStationTime_t currTime_nanosec)
{
  ...
  LRYA_CPU_PROFILE("AnimProcessMessages::Update");
  ...
  {
    LRYA_CPU_PROFILE("ProcessMessageFromRobot");
