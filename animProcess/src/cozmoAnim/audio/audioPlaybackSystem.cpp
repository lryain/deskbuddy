...
void AudioPlaybackSystem::LoadAudioPlaybackData( std::shared_ptr<AudioPlaybackJob> audiojob )
{
  ...
  Lrya::Util::SetThreadName( pthread_self(), kThreadName );
...
void AudioPlaybackSystem::BeginAudioPlayback()
{
  ...
  PlugIns::LryaPluginInterface* const plugin = audioController->GetPluginInterface();
  ...
  using namespace Lrya::AudioMetaData;
  {
