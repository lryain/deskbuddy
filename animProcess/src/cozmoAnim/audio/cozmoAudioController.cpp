...
//#define EXCLUDE_LRYA_AUDIO_LIBS 0
...
namespace {
static Lrya::Vector::Audio::CozmoAudioController* sThis = nullptr;
...
using APT = Lrya::AudioMetaData::GameParameter::ParameterType;
...
// Null-safe wrapper for Lrya::AudioMetaData::EnumToString()
std::string ToString(Lrya::AudioMetaData::GameObjectType v)
{
  const char * str = Lrya::AudioMetaData::EnumToString(v);
  if (str != nullptr) {
    return str;
  }
...
// Null-safe wrapper for Lrya::AudioMetaData::GameEvent::EnumToString()
std::string ToString(Lrya::AudioMetaData::GameEvent::GenericEvent v)
{
  const char * str = Lrya::AudioMetaData::GameEvent::EnumToString(v);
  if (str != nullptr) {
    return str;
  }
  return std::to_string(static_cast<uint64_t>(v));
...
// Null-safe wrapper for Lrya::AudioMetaData::GameState::EnumToString()
std::string ToString(Lrya::AudioMetaData::GameState::StateGroupType v)
{
  const char * str = Lrya::AudioMetaData::GameState::EnumToString(v);
  if (str != nullptr) {
    return str;
  }
  return std::to_string(static_cast<uint64_t>(v));
...
// Null-safe wrapper for Lrya::AudioMetaData::SwitchState::EnumToString()
std::string ToString(Lrya::AudioMetaData::SwitchState::SwitchGroupType v)
{
  const char * str = Lrya::AudioMetaData::SwitchState::EnumToString(v);
  if (str != nullptr) {
    return str;
  }
  return std::to_string(static_cast<uint64_t>(v));
...
using Language = Lrya::Util::Locale::Language;
...
#endif // defined(LRYA_PLATFORM_MATEOS)
#endif // defined(LRYA_PLATFORM_OSX)
...
#else
  PRINT_NAMED_WARNING("CozmoAudioController", "Audio Engine is disabled - EXCLUDE_LRYA_AUDIO_LIBS flag is set");
