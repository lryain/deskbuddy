...
class MicDataSystem : private Util::SignalHolder, private Lrya::Util::noncopyable {
public:
  ...
  const Lrya::Vector::RobotInterface::MicDirection& GetLatestMicDirectionMsg() const { return _latestMicDirectionMsg; }
