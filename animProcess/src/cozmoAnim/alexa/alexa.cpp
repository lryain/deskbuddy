...
{
  if( !LRYA_VERIFY( _impl == nullptr, "Alexa.CreateImpl.Exists", "Alexa implementation already exists" ) ) {
    DeleteImpl();
  }
...
{
  {
    ...
    if( LRYA_VERIFY( _impl != nullptr, "Alexa.DeleteImpl.DoesntExist", "Alexa implementation doesnt exist" ) ) {
