...
namespace Vector {
  ...
  CONSOLE_VAR_RANGED(float, maxDrawTime_ms,      LRYA_CPU_CONSOLEVARGROUP, 5, 5, 32);
  CONSOLE_VAR_ENUM(u8,      kDrawFace_Logging,   LRYA_CPU_CONSOLEVARGROUP, 0, Util::CpuProfiler::CpuProfilerLogging());
#endif
