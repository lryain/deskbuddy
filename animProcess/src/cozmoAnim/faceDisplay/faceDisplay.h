...
#ifndef LRYA_COZMOANIM_FACE_DISPLAY_H
#define LRYA_COZMOANIM_FACE_DISPLAY_H
...
{
  LRYAUTIL_FRIEND_SINGLETON(FaceDisplay); // Allows base class singleton access
...
#endif // LRYA_COZMOANIM_FACE_DISPLAY_H
