...
void FaceInfoScreenManager::Init(Anim::AnimContext* context, Anim::AnimationStreamer* animStreamer)
{
  ...
  // * Camera
  const bool hideSpecialDebugScreens = (FACTORY_TEST && Factory::GetEMR()->fields.PLAYPEN_PASSED_FLAG) || !LRYA_DEV_CHEATS;  // TODO: Use this line in master
  ...
  bool triggerRecognized)
{
  ...
  // (relative to a bar pointing at 12 o'clock on the drawn face, aka 6 o'clock relative to deskmate).
