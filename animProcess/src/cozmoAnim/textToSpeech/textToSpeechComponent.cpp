...
namespace {
  ...
  constexpr Lrya::AudioMetaData::GameObjectType kTTSGameObject = Lrya::AudioMetaData::GameObjectType::TextToSpeech;

  constexpr Lrya::AudioEngine::PlugIns::StreamingWavePortalPlugIn::PluginId_t kTtsPluginId = 0;
...
{
  using Lrya::Util::HidePersonallyIdentifiableInfo;
