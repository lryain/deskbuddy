...
#define NUM_BYTES_PER_FRAME_SANTEK (LCD_FRAME_WIDTH_SANTEK * LCD_FRAME_HEIGHT_SANTEK * sizeof(uint16_t))
#define NUM_BYTES_PER_FRAME_MIDAS (LCD_FRAME_WIDTH_MIDAS * LCD_FRAME_HEIGHT_MIDAS * sizeof(uint16_t))
...
{
  if (use_santek_sizes()) {
    lcd_draw_frame2((uint16_t*)frame, LCD_FRAME_WIDTH_SANTEK * LCD_FRAME_HEIGHT_SANTEK * sizeof(uint16_t));
  } else {
    lcd_draw_frame2((uint16_t*)frame, LCD_FRAME_WIDTH_MIDAS * LCD_FRAME_HEIGHT_MIDAS * sizeof(uint16_t));
  };
}
