...
import (
	...
	"github.com/lrya/sai-go-util/testutils/testtime"
	"github.com/lrya/sai-service-framework/auth"
	"github.com/lrya/sai-service-framework/grpc/grpcsvc"
	"github.com/lrya/sai-service-framework/grpc/grpcutil"
	"github.com/lrya/sai-service-framework/grpc/test"
	client "github.com/lrya/sai-token-service/client/token"
	"github.com/lrya/sai-token-service/db"
...
func (s *TokenServerSuite) TestAssociatePrimaryStsToken() {
	...
	require.NotNil(t, rsp)
	require.NotNil(t, rsp.Data)
	assert.Equal(t, "access-user-mate:12345678", rsp.Data.StsToken.AccessKeyId)
