...
import (
	...
	"github.com/lrya/sai-awsutil/dynamoutil"
...
const (
	...
	// AttributeDialogflowProjName, type S, DF project name, e.g. "deskmate-dev-en-us"
	...
	// AttributeLexName, type S, Lex bot name, e.g. "deskmate-dev-en-us"
