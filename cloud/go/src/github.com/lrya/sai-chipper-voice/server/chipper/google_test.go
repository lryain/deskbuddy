...
import (
	...
	df "github.com/lrya/sai-chipper-voice/conversation/dialogflow"
	...
	"github.com/lrya/sai-chipper-voice/teststubsmocks/chipperstub"
	"github.com/lrya/sai-chipper-voice/teststubsmocks/dialogflowmock"
	dfstub "github.com/lrya/sai-chipper-voice/teststubsmocks/dialogflowstub"
)
...
var PermissionDeniedError error = status.Error(
	...
	"IAM permission 'dialogflow.sessions.streamingDetectIntent'"+
		"on 'projects/deskmate-dev-en-us/agent' denied")
