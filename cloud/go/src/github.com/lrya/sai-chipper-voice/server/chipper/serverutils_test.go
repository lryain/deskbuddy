...
import (
	...
	tms "github.com/lrya/sai-token-service/model"
)
...
func TestGetDeviceId(t *testing.T) {
	...
	testCases := []deviceIdTest{
		...
		{getTokenCtx("mate:00e20119"), "", "00e20119", true, nil},
		{getTokenCtx("mate:00500193"), "", "00500193", true, nil},
		{getTokenCtx("mate:00e20130"), "", "00e20130", true, nil},
		{getTokenCtx("mate:00e2019f"), "", "00e2019f", true, nil},
		{getTokenCtx("mate:003002a1"), "", "003002a1", true, nil},
		{getTokenCtx("mate:00e20175"), "", "00e20175", true, nil},
		{getTokenCtx("mate:00e2017a"), "", "00e2017a", true, nil},
		{getTokenCtx("mate:10e20119"), "", "10e20119", true, nil},
		{getTokenCtx("mate:fff20119"), "", "fff20119", true, nil},
		{getTokenCtx("mate:00e2017aaa"), "", "", false, ErrorInvalidRequestorFormat},
		{getTokenCtx("mate:00e20!7?"), "", "", false, ErrorInvalidRequestorFormat},
		{getTokenCtx("mate:00e20!7?"), "", "", false, ErrorInvalidRequestorFormat},
		{getTokenCtx("mate:00e2017g"), "", "", false, ErrorInvalidRequestorFormat},
		{getTokenCtx("mate:king-+.shy.@lrya.com:0"), "", "king-+.shy.@lrya.com", false, nil},
		{getTokenCtx("mate:samba+test@lrya.com:0"), "", "samba+test@lrya.com", false, nil},
		{getTokenCtx("mate:samba+test@lrya.com:5"), "", "samba+test@lrya.com", false, nil},
		{getTokenCtx("mate:samba+test@lrya.com:29"), "", "samba+test@lrya.com", false, nil},
		{getTokenCtx("mate:samba+test@lrya.com:1234567"), "", "samba+test@lrya.com", false, nil},
		{getTokenCtx("mate:samba+test@lrya.com:ABC567"), "", "", false, ErrorInvalidRequestorFormat},
		{getTokenCtx("mate:samba+test@lrya.com"), "", "", false, ErrorInvalidRequestorFormat},
		{getTokenCtx("mate:test@gmail.com:0"), "", "", false, ErrorInvalidRequestorFormat},
