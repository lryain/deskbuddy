...
import (
	...
	"github.com/lrya/sai-chipper-fn/proto/chipperfnpb"
	"github.com/lrya/sai-go-util/log"
	token_model "github.com/lrya/sai-token-service/model"

	"github.com/lrya/sai-chipper-voice/client/chipperfn"
	"github.com/lrya/sai-chipper-voice/conversation/dialogflow"
	pb "github.com/lrya/sai-chipper-voice/proto/lrya/chipperpb"
	"github.com/lrya/sai-chipper-voice/server/chipperfunction"
	"github.com/lrya/sai-chipper-voice/server/chippermetrics"
)
...
var (
	validRobotId = regexp.MustCompile(`^mate:[a-f0-9]{8}$`)
	validDevID   = regexp.MustCompile(`^mate:[a-zA-Z0-9_.+-]+@lrya.com:[0-9]+$`)
...
// 2. otherwise, RequestorId must match the developer id format. e.g. device_id = "kingshy@lrya.com"
