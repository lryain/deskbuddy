...
```
CGO_ENABLED=1 CGO_LDFLAGS="-L$HOME/go/src/github.com/lrya/opus-go/libopus/mac/lib -lopus" \
  CGO_CPPFLAGS="-I $HOME/go/src/github.com/lrya/opus-go/libopus/mac/include" go build
```
