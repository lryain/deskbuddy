...
import (
	...
	"github.com/lrya/sai-das-client/das"
	"github.com/lrya/sai-das-simulator"
...
func SimHeartbeatCommand(parent *cli.Cmd, cfg **config.Config) {
	parent.Command(
		...
		func(cmd *cli.Cmd) {
			...
			productsOpt := cmd.StringsOpt("p product", nil, "Products to generate heartbeats for. One or more of od, ft, cozmo, cloud, mate, vicapp, or all")
