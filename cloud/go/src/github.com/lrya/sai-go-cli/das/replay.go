...
import (
	...
	daslib "github.com/lrya/sai-das-client/das"
	"github.com/lrya/sai-das-client/events"
...
func ReplayOneDayCommand(parent *cli.Cmd, cfg **config.Config) {
	parent.Command(
		...
		func(cmd *cli.Cmd) {
			...
			prodStr := cmd.StringOpt("p product", "", "Type of aggregated data to load. drive, od, ft, cozmo, cloud, mate, vicapp")
