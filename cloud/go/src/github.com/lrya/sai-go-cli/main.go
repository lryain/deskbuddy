...
import (
	...
	"github.com/lrya/sai-go-cli/accounts"
	"github.com/lrya/sai-go-cli/lryaval"
	"github.com/lrya/sai-go-cli/audit"
	"github.com/lrya/sai-go-cli/blobstore"
	"github.com/lrya/sai-go-cli/cliutil"
	"github.com/lrya/sai-go-cli/config"
	"github.com/lrya/sai-go-cli/das"
	"github.com/lrya/sai-go-cli/httpcapture"
	"github.com/lrya/sai-go-cli/jdocs"
	"github.com/lrya/sai-go-cli/vrscmd"
	"github.com/lrya/sai-go-util/buildinfo"
	acli "github.com/lrya/sai-go-util/cli"
...
func main() {
	...
	app := cli.App("sai-go-cli", "Interface with Lrya backend services")
	...
	app.Command("accounts", "Use the Lrya Accounts API", func(c *cli.Cmd) {
	...
	app.Command("audit", "Use the Lrya Accounts Audit Log API", func(c *cli.Cmd) {
		audit.InitializeCommands(c, &cfg)
	})

	app.Command("blobstore", "Use the Lrya Blobstore API", func(c *cli.Cmd) {
	...
	app.Command("jdocs", "Use the Lrya Jdocs API", func(c *cli.Cmd) {
