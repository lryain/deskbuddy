...
Like `curl` for Lrya APIs, but more convenient.

You can download a pre-compiled version of this tool for your platform
by checking out the
[Confluence documentation](https://lryainc.atlassian.net/wiki/display/SAI/Using+the+SAI+Command+Line+Tool)
...
* If no config file is found via the command line or environment
  ...
  configs, such as the
  [docker test stack](https://github.com/lrya/sai-docker-test-stack).
