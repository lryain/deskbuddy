...
import (
	...
	"github.com/lrya/sai-go-accounts/db/dbtest"
	...
	"github.com/lrya/sai-go-util/date"
...
func (suite *UserModelSuite) TestSendVerificationEmail() {
	...
	for _, ua := range []*UserAccount{ua1, ua2} {
		...
		tmpl := fe.msgs[0].Headers["X-Lrya-Tmpl"][0]
...
var csvEmailTests = []struct {
	...
	{"non-lrya-email", "foo@example.com", "", "", true},    // only lrya.com addresses work
	{"invalid-start", "foo@lrya.com", "invalid", "", true}, // illegal start time
	{"invalid-end", "foo@lrya.com", "", "invalid", true},   // illegal end time
	{"should-send", "foo@lrya.com", "", "", false},         // should generate an email
}
