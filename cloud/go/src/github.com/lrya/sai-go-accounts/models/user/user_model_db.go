...
import (
	...
	autil "github.com/lrya/sai-go-accounts/util"
	...
	"github.com/lrya/sai-go-util/task"
...
func (u *User) sendEmail(emailName string, msg *email.LryaEmail) error {
...
func EmailCSV(frm url.Values) error {
	...
	if !strings.HasSuffix(targetEmail, "@lrya.com") {
		alog.Error{"action": "email_csv", "status": "non-lrya email address", "email": targetEmail}.Log()
		return errors.New("Non lrya.com email field supplied")
	}
