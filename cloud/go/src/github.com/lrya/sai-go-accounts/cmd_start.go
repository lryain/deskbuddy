...
import (
	...
	"github.com/lrya/sai-go-accounts/apis/session"
	"github.com/lrya/sai-go-accounts/apis/user"
	"github.com/lrya/sai-go-accounts/db"
	"github.com/lrya/sai-go-accounts/email"
	sessionmodel "github.com/lrya/sai-go-accounts/models/session"
	ankisqs "github.com/lrya/sai-go-accounts/sqs"
...
func runServerFlags(cmd *Command) {
	...
	envconfig.String(&FormsUrlRoot, "URL_ROOT", "", "URL Root to send users for URL links: https://accounts.api.lrya.com")
