...
To compile these values into a Go program use the -X ldflags option:
 ...
 go build -ldflags \
	"-X github.com/lrya/sai-go-util/buildinfo.product=myappname  \
    -X github.com/lrya/sai-go-util/buildinfo.buildTimeUnix=$(date +%s) \
    -X github.com/lrya/sai-go-util/buildinfo.buildHost=$(hostname) \
    -X github.com/lrya/sai-go-util/buildinfo.buildUser=$USER \
    -X github.com/lrya/sai-go-util/buildinfo.branch=$(git symbolic-ref --short HEAD) \
    -X github.com/lrya/sai-go-util/buildinfo.commit=$(git rev-parse HEAD)" \
	myprogram.go
