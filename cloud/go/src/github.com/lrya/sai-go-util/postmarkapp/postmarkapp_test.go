...
func TestBatchSendOK(t *testing.T) {
	...
	msg1 := createMessage()
	msg1.To[0].Address = "tom+one@lrya.com"
	msg2 := createExampleComMessage()
	msg3 := createMessage()
	msg3.To[0].Address = "tom+two@lrya.com"
	...
	expRecvmsgs := []struct{ To string }{
		{`"Tom Eliaz" <tom+one@lrya.com>`},
		{`"Tom Eliaz" <tom+two@lrya.com>`}}
