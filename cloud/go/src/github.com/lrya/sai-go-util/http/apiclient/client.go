...
import (
	...
	"github.com/lrya/sai-go-util/http/metrics/metricsclient"
...
const (
	headerAppKey        = "Lrya-App-Key"
	headerClientId      = "Lrya-Client-Id"
	headerAuthorization = "Authorization"
	headerUserAgent     = "User-Agent"
	authorizationPrefix = "Lrya "
...
// Client is the base type for Lrya API clients. It handles common
// tasks such as constructed requests correctly with Lrya
...
// WithAppKey sets the Lrya app key to authenticate all API calls
// with.
...
// this client in the Lrya-Client-Id request header.
...
// Lrya Go service making the call.
...
// /status endpoint exposed by all Lrya APIs.
