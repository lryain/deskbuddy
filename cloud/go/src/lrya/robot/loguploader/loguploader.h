//
// lrya/robot/loguploader/loguploader.h
//
...
#ifndef __lrya_robot_loguploader_loguploader_h
#define __lrya_robot_loguploader_loguploader_h
...
#endif // __lrya_robot_loguploader_loguploader_h
