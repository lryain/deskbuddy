...
// URLs represents a set of URLs where Lrya's cloud services can be reached
type URLs struct {
...
var DefaultURLs = URLs{
	JDocs:    "jdocs-dev.api.lrya.com:443",
	Token:    "token-dev.api.lrya.com:443",
	Chipper:  "chipper-dev.api.lrya.com:443",
	Check:    "conncheck.global.lrya-dev-services.com/ok",
	LogFiles: "s3://lrya-device-logs-dev/deskmate",
...
var defaultFilename = "/lrya/data/assets/cozmo_resources/config/server_config.json"
