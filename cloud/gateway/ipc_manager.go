...
//   - mate-engine: There are both a CLAD (EngineCladIpcManager) and a Protobuf (EngineProtoIpcManager)
...
//   - mate-switchboard: There is a CLAD domain socket connecting gateway to switchboard. This socket is
//                      used to coordinate authentication between the two processes.
//   - mate-cloud: There is a CLAD domain socket connecting gateway to mate-cloud. This socket is used to
//                refresh the latest authentication tokens from mate-cloud. This socket is defined inside
...
// mate-gateway acts as the client in all of its domain socket connections since
...
// EngineProtoIpcManager handles passing Protobuf messages between mate-gateway and mate-engine.
...
// Write sends a Protobuf message to mate-engine. This will be handled by
...
// SwitchboardIpcManager handles passing CLAD messages between mate-gateway and mate-switchboard.
// field IpcManager: An anonymous field which basically acts like a subclass.
// field managerMutex: A mutex which prevents asynchronous reads and writes to the managedChannels map.
// field managedChannels: A mapping of messages to listening channels for the rpc handlers.
...
// Write sends a CLAD message to mate-switchboard.
...
// EngineCladIpcManager handles passing CLAD messages between mate-gateway and mate-engine.
// field IpcManager: An anonymous field which basically acts like a subclass.
// field managerMutex: A mutex which prevents asynchronous reads and writes to the managedChannels map.
// field managedChannels: A mapping of messages to listening channels for the rpc handlers.
...
// Write sends a CLAD message to mate-engine. This will be handled by
