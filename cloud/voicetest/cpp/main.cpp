...
using AudioSample = Lrya::AudioUtil::AudioSample;
...
{
  // add logging
  auto logger = std::make_unique<Lrya::Util::PrintfLoggerProvider>();
  Lrya::Util::gLoggerProvider = logger.get();

  // create audio capture system
  Lrya::AudioUtil::AudioCaptureSystem audioCapture{100};
