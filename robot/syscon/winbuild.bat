...
REM start /wait D:\Keil_v5\UV4\UV4.exe -c sysboot.uvprojx -j0
REM start /wait D:\Keil_v5\UV4\UV4.exe -c syscon.uvprojx -j0
...
start /wait D:\Keil_v5\UV4\UV4.exe -b sysboot.uvprojx -j0
...
start /wait D:\Keil_v5\UV4\UV4.exe -b syscon.uvproj -j0
