...
void lrya_start_hci_test( uint16_t freq_mhz, int test_pattern )
{
...
void main_exec(void) {
  ...
  if (--countdown > 0) {
    ...
    lrya_start_hci_test(cfg->freq_mhz, cfg->pattern);
  }
