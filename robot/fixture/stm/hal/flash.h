...
#define MAGIC_LRYA                0x494b4e41    // {'A','N','K','I'}
#define MAGIC_IKNA                0x414E4b49    // {'I','K','N','A'} or 'LRYA'

#define FACTORY_MAGIC_BLOCK_1     MAGIC_IKNA
#define FACTORY_MAGIC_BLOCK_2     MAGIC_LRYA
...
#define IS_BLOCK_A_VALID          (FLASH_BLOCK_A_MAGIC == MAGIC_LRYA)
