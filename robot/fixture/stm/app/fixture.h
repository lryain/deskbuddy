...
//<export start>
//<export heading> LRYA DESKMATE FIXTURE ERROR CODES
...
#define ERROR_SPINE_RX_ERROR              410 //driver (uart) overflow or dropped chars detected (internal error - Lrya code fault)
...
#define ERROR_CUBE_BAD_BINARY             710 // Fixture has corrupted binary (contact Lrya for firmware update)
