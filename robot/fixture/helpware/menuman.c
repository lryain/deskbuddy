...
MENU_ITEMS(TX1) = {
  ...
  MENU_SHELL("TX 11n  @ 2412MHz", "MCS_65_MBPS 1"),
  MENU_SHELL("TX 11g  @ 2412MHz", "11A_54_MBPS 1"),
  MENU_SHELL("TX 11b  @ 2412MHz", "11B_LONG_11_MBPS 1"),
  MENU_SHELL("Carrier @ 2412MHz", "CW 1"),
  MENU_SHELL("TX BLE  @ 2402MHz", "BLE 0x0"),
  MENU_SHELL("RX      @ 2402MHz", "RX 0x0"),
};
MENU_CREATE(TX1);
...
MENU_ITEMS(TX6) = {
  MENU_BACK(Main),
  MENU_SHELL("STOP", "STOP"),
  MENU_SHELL("TX 11n  @ 2437MHz", "MCS_65_MBPS 6"),
  MENU_SHELL("TX 11g  @ 2437MHz", "11A_54_MBPS 6"),
  MENU_SHELL("TX 11b  @ 2437MHz", "11B_LONG_11_MBPS 6"),
  MENU_SHELL("Carrier @ 2437MHz", "CW 6"),
  MENU_SHELL("TX BLE  @ 2440MHz", "BLE 0x13"),  // 19
  MENU_SHELL("RX      @ 2440MHz", "RX 0x13"),
};
MENU_CREATE(TX6);
...
MENU_ITEMS(TX11) = {
  MENU_BACK(Main),
  MENU_SHELL("STOP", "STOP"),
  MENU_SHELL("TX 11n  @ 2462MHz", "MCS_65_MBPS 11"),
  MENU_SHELL("TX 11g  @ 2462MHz", "11A_54_MBPS 11"),
...
MENU_ITEMS(TX13) = {
  MENU_BACK(Main),
  MENU_SHELL("STOP", "STOP"),
  MENU_SHELL("TX 11n  @ 2472MHz", "MCS_65_MBPS 13"),
  MENU_SHELL("TX 11g  @ 2472MHz", "11A_54_MBPS 13"),
  MENU_SHELL("TX 11b  @ 2472MHz", "11B_LONG_11_MBPS 13"),
  MENU_SHELL("Carrier @ 2472MHz", "CW 13"),
};
MENU_CREATE(TX13);
