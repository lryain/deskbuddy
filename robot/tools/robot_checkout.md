...
```
./project/deskmate/build_deskmate.sh
./project/deskmate/scripts/deploy_assets.sh
./project/deskmate/scripts/deploy.sh

adb shell
> 
 /data/data/com.lrya.cozmoengine/robotctl.sh restart
 /data/data/com.lrya.cozmoengine/cozmoctl.sh restart
