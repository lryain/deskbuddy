...
namespace Lrya {
  namespace Vector {
    namespace Localization {
      ...
      void ConvertToDriveCenterPose(const Lrya::Embedded::Pose2d &robotOriginPose,
                                    Lrya::Embedded::Pose2d &driveCenterPose);

      // Given a drive center pose, returns the robot origin pose
      void ConvertToOriginPose(const Lrya::Embedded::Pose2d &driveCenterPose,
                               Lrya::Embedded::Pose2d &robotOriginPose);
