...
//
// Robot DAS doesn't link with lryautils, so we have to duplicate parts of Lrya::Util::DAS
//
...
void DasLogEvent(int prio, const DasMsg & dasMsg)
{
  ...
  static_assert(Lrya::Vector::RobotInterface::DAS::EVENT_MARKER == '@', "DAS event marker does not match declarations");
