...
int spilcdInit(int iType, int bFlipped, int iChannel, int iSPIFreq, int iDC, int iReset, int iLED)
{
        ...
        setLCDLight(iLEDPin, 60); // Set Fan speed to 0 initially
...
static void spilcdWriteData16_(uint16_t us)
{
        spilcdWriteData16(us);
}
//
...
/**
 * spilcdWriteDataBlock包装方法
 */
void spilcdWriteDataBlock2(unsigned char *ucBuf, int iLen)
{
        spilcdWriteDataBlock(ucBuf, iLen);
}
//
