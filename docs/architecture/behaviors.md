...
**The behavior system documentation is [on confluence](https://lryainc.atlassian.net/wiki/spaces/CBS/overview).**
Look there for details, this is just a tiny overview.

The behavior system is the high level AI system that control's deskmates actions. At any given time, a "stack"
...
The default behavior is set in [deskmate_behavior_config.json](/resources/config/engine/behaviorComponent/deskmate_behavior_config.json)
