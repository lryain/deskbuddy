...
Those events then modify deskmate's *mood*, which is controlled by the *Mood Manager*
...
[here](https://lryainc.atlassian.net/wiki/spaces/COZMO/pages/48595096/Emotion+Behavior+Architecture). Note
