...
* Components
* Coretech: Lrya's robotics library



For a high-level hardware and software overview go [here](https://lryainc.atlassian.net/wiki/spaces/VD/pages/128352510/Victor+Prototype+Notes)
...
![deskmate_processes](images/deskmate_processes.png)
...
[Coretech](../../coretech) is a collection of Lrya-grown, product-independent, shareable code. There's some overlap with [`LryaUtil`](../../lib/util) (and indeed the two may someday merge), but it additionally contains robotics code (primarily vision and path planning) that can hopefully be used on future products.
