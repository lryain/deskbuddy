...
You must install a number of support extensions before you can build Lrya software.
...
Start by using "File -> Open" to open your top-level deskmate repo.
...
You can set additional build flags (e.g. "-p mac" vs "-p mateos") by editing 
