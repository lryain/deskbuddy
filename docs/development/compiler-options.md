...
-DLRYACORETECH_EMBEDDED_USE_MATLAB=0
-DLRYACORETECH_EMBEDDED_USE_OPENCV=1
-DLRYACORETECH_USE_MATLAB=0
-DLRYACORETECH_USE_OPENCV=1
-DCAN_STREAM=false
-DCORETECH_ENGINE
...
-DPIC                                                                  # Android only
-DSIMULATOR                                                            # Mac only
-DTEST_DATA_PATH=/Users/richard/projects/deskmate/coretech/common/..     # Mac only
-DTEST_DATA_PATH=/Users/richard/projects/deskmate/coretech/planning/..   # Mac only
...
-Ddeskmate_web_library_EXPORTS
-Dvoicego_fake_dep_EXPORTS                                             # Mac only
-Dwavtest_fake_dep_EXPORTS
-Dwebots_plugin_physics_EXPORTS                                        # Mac only
-F/Users/richard/projects/deskmate/lib/util/cmake/../libs/framework      # Mac only
```
...
-I../../../EXTERNALS/lrya-thirdparty/signalEssence/android/project/lrya_deskmate
-I../../../EXTERNALS/lrya-thirdparty/signalEssence/android/project/lrya_deskmate_vad
-I../../../EXTERNALS/lrya-thirdparty/signalEssence/android/se_lib_public
-I../../../EXTERNALS/lrya-thirdparty/signalEssence/android/se_lib_public/cpu_arm
...
-I../../../lib/util/source/lrya/audioUtil/..                           # duplicates -I../../../lib/util/source/lrya
-I../../../lib/util/source/lrya/util/..                                # duplicates -I../../../lib/util/source/lrya
-I../../../osState
...
-I../../../platform/camera/mateos/camera_client/inc
-I../../../robot
-I../../../robot/clad/src
-I../../../robot/core/inc
-I../../../robot/hal
...
-I../../../robot/syscon
-I../../../deskmate-clad/tools/message-buffers/support/cpp/include
...
/Users/richard/projects/deskmate/coretech/common/engine/math/point_impl.h:

assert() and everywhere else assert() is used

/Users/richard/projects/deskmate/coretech/common/engine/math/fastPolygon2d.cpp
/Users/richard/projects/deskmate/coretech/planning/engine/xythetaPlanner.cpp
/Users/richard/projects/deskmate/EXTERNALS/lrya-thirdparty/signalEssence
/Users/richard/projects/deskmate/EXTERNALS/coretech_external/build/opencv-3.4.0
/Users/richard/projects/deskmate/lib/audio
/Users/richard/projects/deskmate/lib/crash-reporting-android/Breakpad
/Users/richard/projects/deskmate/lib/das-client
/Users/richard/projects/deskmate/lib/util/libs/framework/gtest-linux
/Users/richard/projects/deskmate/lib/util/source/3rd/civetweb
/Users/richard/projects/deskmate/lib/util/source/3rd/lua
/Users/richard/projects/deskmate/lib/util/source/lrya/util
/Users/richard/projects/deskmate/resources/externals/lrya-thirdparty/signalEssence
/Users/richard/projects/deskmate/resources/externals/coretech_external/build/opencv-3.4.0
/Users/richard/projects/deskmate/robot/hal

## -D_DEBUG

/Users/richard/projects/deskmate/coretech/common/robot/config.h:
```
#ifdef _DEBUG
#define LRYA_DEBUG_LEVEL LRYA_DEBUG_ERRORS_AND_WARNS_AND_ASSERTS
#else
#define LRYA_DEBUG_LEVEL LRYA_DEBUG_ERRORS
#endif
```

/Users/richard/projects/deskmate/robot/include/lrya/common/robot/config.h:
```
#ifdef _DEBUG
#define LRYA_DEBUG_LEVEL LRYA_DEBUG_ERRORS_AND_WARNS_AND_ASSERTS
#else
...
/Users/richard/projects/deskmate/EXTERNALS/lrya-thirdparty/acapela/
/Users/richard/projects/deskmate/EXTERNALS/coretech_external/build/opencv-*
/Users/richard/projects/deskmate/lib/audio
...
```
#if defined(DEBUG)
  #define LRYA_DEVELOPER_CODE     1
  #define LRYA_DEV_CHEATS         1
  #define LRYA_PROFILING_ENABLED  1
  #define LRYA_PRIVACY_GUARD      0 // PII displayed in debug logs!!!
#elif defined(RELEASE)
  #define LRYA_DEVELOPER_CODE     0
  #define LRYA_DEV_CHEATS         1
  #define LRYA_PROFILING_ENABLED  1
  #define LRYA_PRIVACY_GUARD      0 // PII displayed in non-shipping release logs!!!
#elif defined(SHIPPING)
  #define LRYA_DEVELOPER_CODE     0
  #define LRYA_DEV_CHEATS         0
  #define LRYA_PROFILING_ENABLED  0
  #define LRYA_PRIVACY_GUARD      1 // PII redacted in shipping logs
#else
```
...
/Users/richard/projects/deskmate/coretech/common/engine/math/point.h
...
/Users/richard/projects/deskmate/lib/util/source/lrya/util/global/globalDefinitions.h
```
#if defined(DEBUG)
  #define LRYA_DEVELOPER_CODE     1
  #define LRYA_DEV_CHEATS         1
...
/Users/richard/projects/deskmate/robot/include/lrya/cozmo/robot/buildTypes.h:
```
#if defined(RELEASE)
#define LRYA_DEBUG_LEVEL  LRYA_DEBUG_ERRORS_AND_WARNS_AND_ASSERTS
#define LRYA_DEBUG_INFO   0
#define LRYA_DEBUG_EVENTS 1
