...
- Give the command to delete all the captured mic data: [`./project/deskmate/scripts/clear_micdata.sh`](/project/deskmate/scripts/clear_micdata.sh)
...
- Make sure your robot is connected to the network and you can `ssh` into it.
- Use the script that pulls all the stored mic captures from the robot: [./project/deskmate/scripts/pull_micdata.sh](/project/deskmate/scripts/pull_micdata.sh)
