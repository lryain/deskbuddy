/**
* File: deskmate/dasmgr/dasManager.h
*
...
#ifndef __deskmate_dasmgr_dasManager_h
#define __deskmate_dasmgr_dasManager_h

#include "dasConfig.h"
#include "coretech/common/shared/types.h" // Lrya Result
#include "util/dispatchQueue/taskExecutor.h" // Lrya TaskExecutor
#include "util/logging/logtypes.h" // Lrya LogLevel
...
private:
  ...
  using TaskExecutor = Lrya::Util::TaskExecutor;
