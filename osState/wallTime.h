...
{
  LRYAUTIL_FRIEND_SINGLETON(WallTime);
...
public:
  ...
  // OSState::HasTimezone()), UTC is the default on mate-os
  ...
  // similat to GetLocalTime(), mateos will default to UTC if no timezone is set (see OSState::HasTimezone())
