...
{
  LRYAUTIL_FRIEND_SINGLETON(OSState);
...
~OSState();
  ...
  // True if this is a disclaimer bot for internal Lrya Dev use
  bool IsLryaDevRobot();
...
protected:
   ...
   // but allows mate-dasmgr to check for ESN without crashing.
