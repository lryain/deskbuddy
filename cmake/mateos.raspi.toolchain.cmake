...
list(APPEND MATEOS_COMPILER_FLAGS ${OLD_C_FLAGS})
list(APPEND MATEOS_COMPILER_FLAGS_CXX ${OLD_CXX_FLAGS})
...
#  -fvisibility=hidden
#  -fsanitize=cfi
# 这个加上编译不了-no-canonical-prefixes
...
# message(STATUS "5.1 kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk --------------> CMAKE_CXX_FLAGS: ${CMAKE_CXX_FLAGS}")
# message(STATUS "5.2 kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk --------------> MATEOS_COMPILER_FLAGS: ${MATEOS_COMPILER_FLAGS}")
# message(STATUS "5.3 kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk --------------> MATEOS_COMPILER_FLAGS_CXX: ${MATEOS_COMPILER_FLAGS_CXX}")
# -DMATEOS -D_LIBCPP_DISABLE_AVAILABILITY -Qunused-arguments -ffunction-sections -fdata-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -march=armv7-a -mfloat-abi=hard -mfpu=neon -mthumb -Wformat -Werror=format-security
set(CMAKE_CXX_FLAGS           "${MATEOS_COMPILER_FLAGS} ${MATEOS_COMPILER_FLAGS_CXX} ${CMAKE_CXX_FLAGS}")
# set(CMAKE_CXX_FLAGS           "-DMATEOS -D_LIBCPP_DISABLE_AVAILABILITY -Qunused-arguments -ffunction-sections -fdata-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes ${MATEOS_COMPILER_FLAGS_CXX} ${CMAKE_CXX_FLAGS}")
# message(STATUS "5.4 kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk --------------> CMAKE_CXX_FLAGS: ${CMAKE_CXX_FLAGS}")
