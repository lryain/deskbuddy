...
function(generate_clad)
    ...
    if (genclad_LIBRARY)
        ...
        lrya_build_target_license(${genclad_LIBRARY} "LRYA")
    endif()
...
function(generate_clad_cpplite)
    ...
    set(CLAD_BASE_DIR "${CMAKE_SOURCE_DIR}/deskmate-clad/tools/message-buffers")
...
function(generate_clad_cpp)
    ...
    set(CLAD_DESKMATE_EMITTER_DIR ${CMAKE_SOURCE_DIR}/deskmate-clad/deskmateEmitters)
    set(CLAD_CPP_DECL "${CLAD_DESKMATE_EMITTER_DIR}/cozmo_CPP_declarations_emitter.py")
    set(CLAD_CPP_DECL_EXTS "_declarations.def")
    set(CLAD_CPP_DECL_FLAGS "")

    set(CLAD_CPP_SWITCH "${CLAD_DESKMATE_EMITTER_DIR}/cozmo_CPP_switch_emitter.py")
...
function(generate_clad_py)
    ...
    set(CLAD_DESKMATE_EMITTER_DIR ${CMAKE_SOURCE_DIR}/deskmate-clad/deskmateEmitters)
    set(CLAD_PY_DECL "${CLAD_DESKMATE_EMITTER_DIR}/cozmo_Python_declarations_emitter.py")
...
function(generate_clad_cs)
    ...
    set(CLAD_DESKMATE_EMITTER_DIR ${CMAKE_SOURCE_DIR}/deskmate-clad/deskmateEmitters)
    set(CLAD_CS_DECL "${CLAD_DESKMATE_EMITTER_DIR}/cozmo_CSharp_declarations_emitter.py")
