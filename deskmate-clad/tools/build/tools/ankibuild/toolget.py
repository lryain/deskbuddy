...
def get_lrya_tool_directory(name):
    d = os.path.join(os.path.expanduser("~"), ".lrya", name)
    util.File.mkdir_p(d)
    return d

def get_lrya_tool_downloads_directory(name):
    d = os.path.join(get_lrya_tool_directory(name), 'downloads')
    util.File.mkdir_p(d)
    return d

def get_lrya_tool_dist_directory(name):
    d = os.path.join(get_lrya_tool_directory(name), 'dist')
    util.File.mkdir_p(d)
    return d
