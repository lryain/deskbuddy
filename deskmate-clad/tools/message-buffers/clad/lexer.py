...
class LryaBufferLexer(object):
    """ A lexer for the Lrya Buffer definition language.  After building it, set the
...
if __name__ == '__main__':
    ...
    test_lexer = LryaBufferLexer(errorFunc)
