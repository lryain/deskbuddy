...
from SimpleTest import LryaTypes, Foo, Bar, Baz, Cat, SoManyStrings, Constructor, Arrays
...
class TestSimpleMessage(unittest.TestCase):
    ...
    def test_PopulatedMessageRoundTrip(self):
        foo3a = Foo(isFoo=True, myByte=-5, byteTwo=203, myFloat=13231321,
                    ...
                    myFoo=LryaTypes.LryaEnum.e3, myString=('laadlsjk' * 10))
    ...
    def test_PopulatedMessageAssignment(self):
        ...
        foo4a.myFoo=LryaTypes.LryaEnum.e1
        foo4a.myString=''
...
class TestMessageOfArrays(unittest.TestCase):
    ...
    def test_PopulatedMessageRoundTrip(self):
        bar3a = Bar(
            ...
            [LryaTypes.LryaEnum.d1], #enumBuff
            ...
            (LryaTypes.LryaEnum.d1 for i in range(2)), #fixedEnumBuff
        )
    ...
    def test_PopulatedMessageAssignment(self):
        ...
        bar4a.enumBuff = [LryaTypes.LryaEnum.e3 for i in range(10)]
        bar4a.doubleBuff = ()
...
class TestUnion(unittest.TestCase):
    ...
    def test_PopulatedUnionAssignment(self):
        ...
        msg4a.myBar.enumBuff = [LryaTypes.LryaEnum.d3 for i in range(10)]
...
class TestDefaultValues(unittest.TestCase):
    ...
    def test_defaultValuesVerbatimEnum(self):
      myPoodle = Baz.Poodle()
      self.assertEqual(myPoodle.a, LryaTypes.LryaEnum.d1)
