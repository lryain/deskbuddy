...
func TestFoo(t *testing.T) {
	myFoo := build.Foo{true, 0x7f, 0xfe, 0xafe, -123123,
		0xdeadbeef, build.LryaEnum_myReallySilly_EnumVal,
		"Blah Blah Blah"}
	otherFoo := build.Foo{}
...
func TestBar(t *testing.T) {
	myBar := build.Bar{[]bool{true, false, false},
		[]int8{0, 1, 2, 3, 4},
		[]int16{5, 6, 7},
		[]build.LryaEnum{build.LryaEnum_d1, build.LryaEnum_e1},
		...
		[2]build.LryaEnum{build.LryaEnum_e1, build.LryaEnum_e3}}
...
func TestDog(t *testing.T) {
	myDog := build.Dog{build.LryaEnum_e1, 5}
...
func TestOd432(t *testing.T) {
	...
	myFoo := build.Foo{true, 0x7f, 0xfe, 0xafe, -123123, 0xdeadbeef,
		build.LryaEnum_myReallySilly_EnumVal,
		"Blah Blah Blah"}
...
func TestUnion(t *testing.T) {
	...
	myFoo.MyFoo = build.LryaEnum_myReallySilly_EnumVal
	...
	myBar.EnumBuff = []build.LryaEnum{build.LryaEnum_myReallySilly_EnumVal,
		build.LryaEnum_e2}
