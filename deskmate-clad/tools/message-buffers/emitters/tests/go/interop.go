...
func testCFunky(t *testing.T) {
	m := build.Funky{A: build.LryaEnum_d1, B: 122}
...
func testCMonkey(t *testing.T) {
	var m build.Monkey
	m.A = build.Funky{A: build.LryaEnum_e1, B: 126}
	m.B = 3.0
...
func testCMusic(t *testing.T) {
	var m build.Music
	m.C = build.Funky{A: build.LryaEnum_d3, B: 119}
...
func testCFunkyMessage(t *testing.T) {
	var mu build.Music
	mu.C = build.Funky{A: build.LryaEnum_d3, B: 119}
