...
public class HelloWorld {
  public static bool Test_Foo() {
    Foo myFoo = new Foo(true, 0x7f, 0xfe, 0xafe, -123123,
                        0xdeadbeef, LryaTypes.LryaEnum.myReallySilly_EnumVal,
                        "Blah Blah Blah");
  ...
  public static bool Test_Bar() {
    ...
    myBar = new Bar(new bool[3] { true, false, false },
                    ...
                    new short[3] { 5, 6, 7 },
                    new LryaTypes.LryaEnum[2] { LryaTypes.LryaEnum.d1,
                                                LryaTypes.LryaEnum.e1 },
                    ...
                    new LryaTypes.LryaEnum[2] { LryaTypes.LryaEnum.e1,
                                                LryaTypes.LryaEnum.e3 });
  ...
  public static bool Test_Dog() {
    ...
    myDog = new Baz.Dog(LryaTypes.LryaEnum.e1, 5);
  ...
  public static bool Test_Poodle() {
    ...
    return (myPoodle.a == LryaTypes.LryaEnum.d1);
  }
  ...
  public static bool Test_Union() {
    ...
    myFoo.myFoo = LryaTypes.LryaEnum.myReallySilly_EnumVal;
    ...
    myBar.enumBuff = new LryaTypes.LryaEnum[2] { LryaTypes.LryaEnum.myReallySilly_EnumVal,
                                                 LryaTypes.LryaEnum.e2 };
