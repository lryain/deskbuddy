...
int run_camera_client(struct lrya_camera_handle *camera)
{
    ...
    while ( camera_status(camera) != LRYA_CAMERA_STATUS_RUNNING ) {
        usleep(30000);
    }
...
{
    struct lrya_camera_handle *camera;
