...
namespace {
  ...
  std::unordered_map<uint16_t, std::string> kFaultImageMap = {
    {FaultCode::SHUTDOWN_BATTERY_CRITICAL_TEMP, "/lrya/data/assets/cozmo_resources/config/sprites/independentSprites/battery_overheated.png"},
    {FaultCode::SHUTDOWN_BATTERY_CRITICAL_VOLT, "/lrya/data/assets/cozmo_resources/config/sprites/independentSprites/battery_low.png"},
  };
}
...
void usage(FILE * f)
{
  fprintf(f, "Usage: mate-faultCodeDisplay [-hr] nnn\n");
}
