/**
 * File: deskmateCrashReports/tombstoneHooks.cpp
 *
...
static void DebuggerHook(int signum, siginfo_t * info, void * ctx)
{
  ...
  deskmate_dump_tombstone_timeout(tid, nullptr, 0, -1);
  ...
  //
  // <lrya>
  // SA_RESTART doesn't seem to work reliably for all signals on mateos.
