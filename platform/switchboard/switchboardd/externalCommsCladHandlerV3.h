...
namespace Switchboard {
  class ExternalCommsCladHandlerV3 {
    public:
    using RtsConnectionSignal = Signal::Signal<void (const Lrya::Vector::ExternalComms::RtsConnection_3& msg)>;
    ...
    Lrya::Vector::ExternalComms::ExternalComms ReceiveExternalCommsMsg(uint8_t* buffer, size_t length) {
      ...
      if(extComms.GetTag() == Lrya::Vector::ExternalComms::ExternalCommsTag::RtsConnection) {
        ...
        Lrya::Vector::ExternalComms::RtsConnection_3 rtsMsg = rstContainer.Get_RtsConnection_3();
        
        switch(rtsMsg.GetTag()) {
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::Error:
            //
            break;
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsConnResponse: {
            _receiveRtsConnResponse.emit(rtsMsg);          
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsChallengeMessage: {
            _receiveRtsChallengeMessage.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsWifiConnectRequest: {
            _receiveRtsWifiConnectRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsWifiIpRequest: {
            _receiveRtsWifiIpRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsStatusRequest: {
            _receiveRtsStatusRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsWifiScanRequest: {
            _receiveRtsWifiScanRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsWifiForgetRequest: {
            _receiveRtsWifiForgetRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsOtaUpdateRequest: {
            _receiveRtsOtaUpdateRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsOtaCancelRequest: {
            _receiveRtsOtaCancelRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsWifiAccessPointRequest: {
            _receiveRtsWifiAccessPointRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsCancelPairing: {
            _receiveRtsCancelPairing.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsAck: {
            _receiveRtsAck.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsLogRequest: {
            _receiveRtsLogRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsForceDisconnect: {
            _receiveRtsForceDisconnect.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsCloudSessionRequest: {
            _receiveRtsCloudSessionRequest.emit(rtsMsg);
            break;
          }
          // RtsSsh
          case Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsSshRequest: {
