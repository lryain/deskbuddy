...
namespace Switchboard {
  class ExternalCommsCladHandlerV2 {
    public:
    using RtsConnectionSignal = Signal::Signal<void (const Lrya::Vector::ExternalComms::RtsConnection_2& msg)>;
    ...
    Lrya::Vector::ExternalComms::ExternalComms ReceiveExternalCommsMsg(uint8_t* buffer, size_t length) {
      ...
      if(extComms.GetTag() == Lrya::Vector::ExternalComms::ExternalCommsTag::RtsConnection) {
        ...
        Lrya::Vector::ExternalComms::RtsConnection_2 rtsMsg = rstContainer.Get_RtsConnection_2();
        
        switch(rtsMsg.GetTag()) {
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::Error:
            //
            break;
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsConnResponse: {
            _receiveRtsConnResponse.emit(rtsMsg);          
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsChallengeMessage: {
            _receiveRtsChallengeMessage.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsWifiConnectRequest: {
            _receiveRtsWifiConnectRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsWifiIpRequest: {
            _receiveRtsWifiIpRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsStatusRequest: {
            _receiveRtsStatusRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsWifiScanRequest: {
            _receiveRtsWifiScanRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsOtaUpdateRequest: {
            _receiveRtsOtaUpdateRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsOtaCancelRequest: {
            _receiveRtsOtaCancelRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsWifiAccessPointRequest: {
            _receiveRtsWifiAccessPointRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsCancelPairing: {
            _receiveRtsCancelPairing.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsAck: {
            _receiveRtsAck.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsLogRequest: {
            _receiveRtsLogRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsForceDisconnect: {
            _receiveRtsForceDisconnect.emit(rtsMsg);
            break;
          }
          // RtsSsh
          case Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsSshRequest: {
