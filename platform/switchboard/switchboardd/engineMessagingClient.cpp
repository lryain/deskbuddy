...
using GMessageTag = Lrya::Vector::ExternalInterface::MessageGameToEngineTag;
using GMessage = Lrya::Vector::ExternalInterface::MessageGameToEngine;
using EMessageTag = Lrya::Vector::ExternalInterface::MessageEngineToGameTag;
...
bool Lrya::Switchboard::EngineMessagingClient::Connect() {
  bool connected = _client.Connect(Lrya::Vector::ENGINE_SWITCH_CLIENT_PATH, Lrya::Vector::ENGINE_SWITCH_SERVER_PATH);
...
void EngineMessagingClient::HandleWifiScanRequest() {
  ...
  Lrya::Vector::SwitchboardInterface::WifiScanResponse rsp;
...
void EngineMessagingClient::HandleWifiConnectRequest(const std::string& ssid,
  ...
  Lrya::Vector::SwitchboardInterface::WifiConnectResponse rcp;
  rcp.status_code = 255;
...
void EngineMessagingClient::HandleHasBleKeysRequest() {
  Lrya::Vector::SwitchboardInterface::HasBleKeysResponse rsp;
...
void EngineMessagingClient::SetPairingPin(std::string pin) {
  Lrya::Vector::SwitchboardInterface::SetBLEPin sbp;
...
void EngineMessagingClient::SendBLEConnectionStatus(bool connected) {
  Lrya::Vector::SwitchboardInterface::SendBLEConnectionStatus msg;
  msg.connected = connected;
  SendMessage(GMessage::CreateSendBLEConnectionStatus(std::move(msg)));
}

void EngineMessagingClient::ShowPairingStatus(Lrya::Vector::SwitchboardInterface::ConnectionStatus status) {
  Lrya::Vector::SwitchboardInterface::SetConnectionStatus scs;
  scs.status = status;
