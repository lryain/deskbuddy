...
namespace Switchboard {
  class ExternalCommsCladHandlerV4 {
    public:
    using RtsConnectionSignal = Signal::Signal<void (const Lrya::Vector::ExternalComms::RtsConnection_4& msg)>;
    ...
    Lrya::Vector::ExternalComms::ExternalComms ReceiveExternalCommsMsg(uint8_t* buffer, size_t length) {
      ...
      if(extComms.GetTag() == Lrya::Vector::ExternalComms::ExternalCommsTag::RtsConnection) {
        ...
        Lrya::Vector::ExternalComms::RtsConnection_4 rtsMsg = rstContainer.Get_RtsConnection_4();
        
        switch(rtsMsg.GetTag()) {
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::Error:
            //
            break;
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsConnResponse: {
            _receiveRtsConnResponse.emit(rtsMsg);          
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsChallengeMessage: {
            _receiveRtsChallengeMessage.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsWifiConnectRequest: {
            _receiveRtsWifiConnectRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsWifiIpRequest: {
            _receiveRtsWifiIpRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsStatusRequest: {
            _receiveRtsStatusRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsWifiScanRequest: {
            _receiveRtsWifiScanRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsWifiForgetRequest: {
            _receiveRtsWifiForgetRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsOtaUpdateRequest: {
            _receiveRtsOtaUpdateRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsOtaCancelRequest: {
            _receiveRtsOtaCancelRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsWifiAccessPointRequest: {
            _receiveRtsWifiAccessPointRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsCancelPairing: {
            _receiveRtsCancelPairing.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsAck: {
            _receiveRtsAck.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsLogRequest: {
            _receiveRtsLogRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsForceDisconnect: {
            _receiveRtsForceDisconnect.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsCloudSessionRequest: {
            _receiveRtsCloudSessionRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsAppConnectionIdRequest: {
            _receiveRtsAppConnectionIdRequest.emit(rtsMsg);
            break;
          }
          // RtsSsh
          case Lrya::Vector::ExternalComms::RtsConnection_4Tag::RtsSshRequest: {
