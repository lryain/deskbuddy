...
void RtsHandlerV2::HandleRtsConnResponse(const Lrya::Vector::ExternalComms::RtsConnection_2& msg) {
...
void RtsHandlerV2::HandleRtsAck(const Vector::ExternalComms::RtsConnection_2& msg) {
  ...
  if(_state == RtsPairingPhase::AwaitingNonceAck &&
    ack.rtsConnectionTag == (uint8_t)Lrya::Vector::ExternalComms::RtsConnection_2Tag::RtsNonceMessage) {
    HandleNonceAck();
  } else {
    // ignore msg
    IncrementAbnormalityCount();
...
void RtsHandlerV2::SendWifiScanResult() {
  ...
  std::vector<Lrya::Vector::ExternalComms::RtsWifiScanResult_2> wifiScanResults;

  for(int i = 0; i < wifiResults.size(); i++) {
    Lrya::Vector::ExternalComms::RtsWifiScanResult_2 result = Lrya::Vector::ExternalComms::RtsWifiScanResult_2(wifiResults[i].auth,
...
void RtsHandlerV2::UpdateFace(Lrya::Vector::SwitchboardInterface::ConnectionStatus state) {
