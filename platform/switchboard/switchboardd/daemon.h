...
namespace Switchboard {
  ...
  class Daemon {
    ...
    private:
      const std::string kSwitchboardRunPath = "/run/mate-switchboard";
      const std::string kUpdateEngineEnvPath = "/run/mate-switchboard/update-engine.env";
      const std::string kUpdateEngineDisablePath = "/run/mate-switchboard/disable-update-engine";
      ...
      const std::string kUpdateEngineExecPath = "/lrya/bin/update-engine";
      const std::string kUpdateEngineServicePath = "/lib/systemd/system/update-engine.service";
      const std::string kServerConfigFilePath = "/lrya/data/assets/cozmo_resources/config/server_config.json";
      ...
      static void HandleLryabtdTimer(struct ev_loop* loop, struct ev_timer* w, int revents);
      ...
      void OnPairingStatus(Lrya::Vector::ExternalInterface::MessageEngineToGame message);
      bool TryConnectToEngineServer();
      bool TryConnectToTokenServer();
      bool TryConnectToLryaBluetoothDaemon();
