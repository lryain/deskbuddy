...
namespace Switchboard {
  class ExternalCommsCladHandlerV5 {
    public:
    using RtsConnectionSignal = Signal::Signal<void (const Lrya::Vector::ExternalComms::RtsConnection_5& msg)>;
    ...
    Lrya::Vector::ExternalComms::ExternalComms ReceiveExternalCommsMsg(uint8_t* buffer, size_t length) {
      Lrya::Vector::ExternalComms::ExternalComms extComms;
      ...
      if(extComms.GetTag() == Lrya::Vector::ExternalComms::ExternalCommsTag::RtsConnection) {
        Lrya::Vector::ExternalComms::RtsConnection rstContainer = extComms.Get_RtsConnection();
        Lrya::Vector::ExternalComms::RtsConnection_5 rtsMsg = rstContainer.Get_RtsConnection_5();
        
        switch(rtsMsg.GetTag()) {
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::Error:
            //
            break;
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsConnResponse: {
            _receiveRtsConnResponse.emit(rtsMsg);          
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsChallengeMessage: {
            _receiveRtsChallengeMessage.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsWifiConnectRequest: {
            _receiveRtsWifiConnectRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsWifiIpRequest: {
            _receiveRtsWifiIpRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsStatusRequest: {
            _receiveRtsStatusRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsWifiScanRequest: {
            _receiveRtsWifiScanRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsWifiForgetRequest: {
            _receiveRtsWifiForgetRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsOtaUpdateRequest: {
            _receiveRtsOtaUpdateRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsOtaCancelRequest: {
            _receiveRtsOtaCancelRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsWifiAccessPointRequest: {
            _receiveRtsWifiAccessPointRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsCancelPairing: {
            _receiveRtsCancelPairing.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsAck: {
            _receiveRtsAck.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsLogRequest: {
            _receiveRtsLogRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsForceDisconnect: {
            _receiveRtsForceDisconnect.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsCloudSessionRequest_5: {
            _receiveRtsCloudSessionRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsAppConnectionIdRequest: {
            _receiveRtsAppConnectionIdRequest.emit(rtsMsg);
            break;
          }
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsSdkProxyRequest: {
            _receiveRtsSdkProxyRequest.emit(rtsMsg);
            break;
          }
          // RtsSsh
          case Lrya::Vector::ExternalComms::RtsConnection_5Tag::RtsSshRequest: {
    ...
    static std::vector<uint8_t> SendExternalCommsMsg(Lrya::Vector::ExternalComms::ExternalComms msg) {
