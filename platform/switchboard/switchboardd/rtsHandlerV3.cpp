...
void RtsHandlerV3::HandleRtsConnResponse(const Lrya::Vector::ExternalComms::RtsConnection_3& msg) {
...
void RtsHandlerV3::ProcessCloudAuthResponse(bool isPrimary, Lrya::Vector::TokenError authError, std::string appToken, std::string authJwtToken) {
...
void RtsHandlerV3::HandleRtsAck(const Vector::ExternalComms::RtsConnection_3& msg) {
  ...
  if(_state == RtsPairingPhase::AwaitingNonceAck &&
    ack.rtsConnectionTag == (uint8_t)Lrya::Vector::ExternalComms::RtsConnection_3Tag::RtsNonceMessage) {
    HandleNonceAck();
  } else {
    // ignore msg
    IncrementAbnormalityCount();
...
void RtsHandlerV3::UpdateFace(Lrya::Vector::SwitchboardInterface::ConnectionStatus state) {
