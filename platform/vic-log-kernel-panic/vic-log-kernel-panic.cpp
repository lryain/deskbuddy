/**
* File: mate-log-kernel-panic.cpp
*
...
#define PROCNAME "mate-log-kernel-panic"
...
int main(int argc, const char * argv[])
{
  ...
  Lrya::Util::VictorLogger logger(PROCNAME);
  ...
  bool ok = Lrya::Vector::WriteMinidump(PROCNAME, dump_path);
  if (!ok) {
  ...
  ok = Lrya::Util::FileUtils::CopyFile(dump_path+".log", logpath);
  if (!ok) {
