...
#ifndef __Lrya_Cozmo_ProceduralFace_H__
#define __Lrya_Cozmo_ProceduralFace_H__
...
private:
  ...
  static std::unique_ptr<Lrya::Util::IConsoleFunction> _hueConsoleFunc;
  static std::unique_ptr<Lrya::Util::IConsoleFunction> _saturationConsoleFunc;
  ...
  using ConsoleVarPtr = std::unique_ptr<Lrya::Util::IConsoleVariable>;
...
#endif // __Lrya_Cozmo_ProceduralFace_H__
