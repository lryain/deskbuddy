...
std::unique_ptr<Lrya::Util::IConsoleFunction> ProceduralFace::_hueConsoleFunc = std::unique_ptr<Lrya::Util::IConsoleFunction>(new Lrya::Util::IConsoleFunction("ProcFace_Hue", HueConsoleFunction, CONSOLE_GROUP, "float hue") );
std::unique_ptr<Lrya::Util::IConsoleFunction> ProceduralFace::_saturationConsoleFunc = std::unique_ptr<Lrya::Util::IConsoleFunction>(new Lrya::Util::IConsoleFunction("ProcFace_Saturation", SaturationConsoleFunction, CONSOLE_GROUP, "float saturation") );
#undef CONSOLE_GROUP
...
void ProceduralFace::SetEyeArrayHelper(WhichEye eye, const std::vector<Value>& eyeArray)
{
  ...
  // https://lryainc.atlassian.net/browse/VIC-1964
...
void ProceduralFace::AddConsoleVar(T & var, const char * name, const char * group, const T & minVal, const T & maxVal)
{
  ...
  ConsoleVarPtr ptr(new Lrya::Util::ConsoleVar<T>(var, name, group, minVal, maxVal, true));
