...
#ifndef __Lrya_Cozmo_Basestation_Animations_Track_H__
#define __Lrya_Cozmo_Basestation_Animations_Track_H__
...
public:
  ...
  FRAME_TYPE& GetCurrentKeyFrame() const {
    LRYA_VERIFY(HasFramesLeft(),"Track.GetCurrentKeyframe.NoFramesLeft","");
    return *_frameIter;
  }
...
#endif //__Lrya_Cozmo_Basestation_Animations_Track_H__
