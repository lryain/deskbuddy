...
#ifndef LRYA_COZMO_CANNED_KEYFRAME_H
#define LRYA_COZMO_CANNED_KEYFRAME_H
...
namespace Vector {
  ...
  public:
    ...
    TimeStamp_t GetTimestampActionComplete_ms() const { 
      if(LRYA_DEV_CHEATS){
        LRYA_VERIFY(GetKeyframeDuration_ms() != 0, 
  ...
  public:
    ...
    Lrya::Vector::AnimEvent GetAnimEvent() const { return _event_id; }
  ...
  private:
    ...
    Lrya::Vector::AnimEvent _event_id;
...
#endif // LRYA_COZMO_CANNED_KEYFRAME_H
