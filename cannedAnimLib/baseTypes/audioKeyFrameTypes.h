...
#ifndef __Lrya_Cozmo_AudioKeyFrameTypes_H__
#define __Lrya_Cozmo_AudioKeyFrameTypes_H__
...
struct AudioParameterRef {
  ...
  float Value;
  uint32_t Time_ms;
  Lrya::AudioEngine::Multiplexer::CurveType Curve;
  AudioMetaData::GameObjectType GameObject;
  
  AudioParameterRef( AudioMetaData::GameParameter::ParameterType parameter = AudioMetaData::GameParameter::ParameterType::Invalid,
                     float value = 0.0f,
                     uint32_t time_ms = 0,
                     Lrya::AudioEngine::Multiplexer::CurveType curve = Lrya::AudioEngine::Multiplexer::CurveType::Linear,
                     AudioMetaData::GameObjectType gameObject = AudioMetaData::GameObjectType::Invalid )
  : Parameter( parameter )
  , Value( value )
  , Time_ms( time_ms )
...
#endif // __Lrya_Cozmo_AudioKeyFrameTypes_H__
