...
#include "lib/util/source/lrya/util/graphEvaluator/graphEvaluator2d.h"
...
void StimulationFaceDisplay::UpdateDependent(const RobotCompMap& dependentComps)
{
  ...
  const float stim = Lrya::Util::Clamp(moodManager.GetEmotionValue(EmotionType::Stimulated), 0.0f, 1.0f);
