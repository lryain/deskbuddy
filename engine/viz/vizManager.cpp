...
namespace Lrya {
  namespace Vector {
    ...
    {
      if (!LRYA_DEV_CHEATS || !_isConnected || !kSendAnythingToViz)
      {
        return;
      }
      
      LRYA_CPU_PROFILE("VizManager::SendMessage");
      ...
      
      {
        ...
        LRYA_CPU_PROFILE("VizClient.Send");
      ...
      if (LRYA_DEV_CHEATS && nullptr != DevLoggingSystem::GetInstance())
      {
    ...
    {
      LRYA_CPU_PROFILE("VizManager::ShowObjects");
    ...
    void VizManager::DrawRobot(const Pose3d& pose, const f32 headAngle, const f32 liftAngle) {
      LRYA_CPU_PROFILE("VizManager::DrawRobot");
    ...
    void VizManager::DrawCameraOval(const Point2f &center,
                                    ...
                                    const Lrya::ColorRGBA &color)
    {
      LRYA_CPU_PROFILE("VizManager::DrawCameraOval");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::DrawCameraLine");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::DrawCameraPoly");
      if (poly.size() < 2){
    ...
    {
      LRYA_CPU_PROFILE("VizManager::DrawCameraText");
    ...
    void VizManager::DrawObject(const u32 objectID,
      ...
      const Lrya::Point3f &size_mm,
      const Lrya::Pose3d &pose,
      const ColorRGBA& color,
      const f32* params,
      const std::string& text)
    {
      LRYA_CPU_PROFILE("VizManager::DrawObject");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::EraseVizObject");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::EraseAllVizObjects");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::EraseVizObjectType");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::AppendPathSegmentLine");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::AppendPathSegmentArc");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SetPathColor");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::EraseQuad");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::EraseSegments");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SetText");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SetDockingError");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendCameraParams");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendRobotState");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendCurrentAnimation");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendBehaviorStackDebug");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendVisionModeDebug");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendSaveState");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendVizMessage");
      SendMessage(event);
    }
    ...
    void VizManager::SendImageChunk(const ImageChunk& robotImageChunk)
    {
      ...
      LRYA_CPU_PROFILE("VizManager::SendImageChunk");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SendTrackerQuad");
    ...
    {
      LRYA_CPU_PROFILE("VizManager::SetOrigin");
    ...
    {
      auto helper = LryaEventUtil<VizManager, decltype(_eventHandlers)>(externalInterface, *this, _eventHandlers);
