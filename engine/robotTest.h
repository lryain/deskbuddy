...
// To enable PerfMetric in a build, define LRYA_PERF_METRIC_ENABLED as 1
#if !defined(LRYA_ROBOT_TEST_ENABLED)
  #if LRYA_DEV_CHEATS
    #define LRYA_ROBOT_TEST_ENABLED 1
  #else
    #define LRYA_ROBOT_TEST_ENABLED 0
  #endif
#endif
