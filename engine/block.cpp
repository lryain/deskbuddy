...
#pragma mark --- Generic Block Implementation ---
  ...
  , _vizHandle(VizManager::INVALID_HANDLE)
  {
    ...
    if(LRYA_DEVELOPER_CODE && (type != ObjectType::Block_LIGHTCUBE_GHOST))
    {
                      ...
                      const bool turnOffUnspecifiedLEDs)
  {
    ...
    for(u8 iLED=0; iLED<NUM_LEDS; ++iLED) {
      ...
      if(shiftedLEDs & FIRST_BIT) {
        ...
        _ledState[iLED].onColor      = ::Lrya::NamedColors::BLACK;
        _ledState[iLED].offColor     = ::Lrya::NamedColors::BLACK;
