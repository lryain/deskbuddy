    ...
    : IBEICondition(config)
{
  ...
  LRYA_VERIFY(Vision::SalientPointTypeFromString(targetSalientPoint, _targetSalientPointType),
...
void
Lrya::Vector::ConditionSalientPointDetected::GetRequiredVisionModes(std::set<Lrya::Vector::VisionModeRequest>& requiredVisionModes) const
{
