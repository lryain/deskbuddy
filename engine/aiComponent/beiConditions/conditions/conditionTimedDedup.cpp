...
: IBEICondition(config)
{
  ...
  LRYA_VERIFY(_instanceParams.subCondition, "ConditionTimedDedup.Constructor.Config.NullSubCondition", "" );
}  
...
: IBEICondition(IBEICondition::GenerateBaseConditionConfig(BEIConditionType::TimedDedup))
{
  ...
  LRYA_VERIFY(_instanceParams.subCondition, "ConditionTimedDedup.Constructor.Direct.NullSubCondition", "" );
}
