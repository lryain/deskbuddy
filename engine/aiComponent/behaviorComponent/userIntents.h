...
#define USER_INTENT_DEV_MODE LRYA_DEVELOPER_CODE
...
#if USER_INTENT_DEV_MODE
#define USER_INTENT(name) Lrya::Vector::UserIntentTagFromString(#name)
#else
#define USER_INTENT(name) Lrya::Vector::UserIntentTag::name
#endif
