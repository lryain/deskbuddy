...
void BehaviorAudioComponent::Init(BehaviorExternalInterface& behaviorExternalInterface)
{
  ...
  if(externalInterface != nullptr){
    auto handleSetSparkMusicState = [this, &behaviorExternalInterface](const LryaEvent<ExternalInterface::MessageGameToEngine>& musicState){
  ...
  auto handleStateChangeWrapper = [this, &behaviorExternalInterface](const LryaEvent<RobotPublicState>& stateEvent){
