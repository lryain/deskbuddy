...
#define BEHAVIOR_ID_DEV_MODE LRYA_DEVELOPER_CODE
...
#if BEHAVIOR_ID_DEV_MODE
#define BEHAVIOR_ID(name) Lrya::Vector::BehaviorTypesWrapper::BehaviorIDFromString(#name)
#define BEHAVIOR_CLASS(name) Lrya::Vector::BehaviorTypesWrapper::BehaviorClassFromString(#name)
#else
#define BEHAVIOR_ID(name) Lrya::Vector::BehaviorID::name
#define BEHAVIOR_CLASS(name) Lrya::Vector::BehaviorClass::name
#endif
