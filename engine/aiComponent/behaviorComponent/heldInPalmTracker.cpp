...
#include "lib/util/source/lrya/util/entityComponent/dependencyManagedEntity.h"
...
{
  LRYA_VERIFY(kMinCliffsToConfirmHeldInPalmPickup > 0,
  ...
  LRYA_VERIFY(kMinCliffsToConfirmHeldInPalmPickup <= CliffSensorComponent::kNumCliffSensors,
              "HIPTracker.CTor.InvalidNumberOfCliffsToConfirmHeldInPalmPickup",
...
{
  LRYA_VERIFY(robotInfo.IsBeingHeld(), "HIPTracker.WasRobotPlacedInPalmWhileHeld",
              "Robot NOT being held, check is invalid");
  LRYA_VERIFY(!robotInfo.IsOnChargerContacts(), "HIPTracker.WasRobotPlacedInPalmWhileHeld",
...
{
  LRYA_VERIFY(robotInfo.IsBeingHeld(), "HIPTracker.HasDetectedEnoughCliffsSincePickup",
              "Robot NOT being held, check is invalid");
  LRYA_VERIFY(!robotInfo.IsOnChargerContacts(), "HIPTracker.HasDetectedEnoughCliffsSincePickup",
              "Robot still on charger contacts, check is invalid");
