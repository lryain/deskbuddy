                                                    ...
                                                    std::shared_ptr<T>& outPtr) const
{
  ...
  if( LRYA_VERIFY(behavior != nullptr,
     ...
     LRYA_VERIFY(behavior != nullptr && GetBehaviorClass(behavior) == requiredClass,
       ...
       if( LRYA_VERIFY(outPtr != nullptr, "BehaviorContainer.FindBehaviorByIDAndDowncast.CastFailed",
                       "BehaviorID: %s requiredClass: %s",
                       BehaviorTypesWrapper::BehaviorIDToString(behaviorID),
                       GetClassString(requiredClass).c_str()) ) {
         return true;
