    ...
    void BehaviorKnowledgeGraphQuestion::BehaviorUpdate()
    {
      if (IsActivated())
      {
        ...
        else if (EState::Responding == _dVars.state)
        {
          ...
          // if we're playing our response, allow deskmate to be interrupted
          // require deskmate to be on the ground prior to being picked up, else ignore it if he's already in the air
