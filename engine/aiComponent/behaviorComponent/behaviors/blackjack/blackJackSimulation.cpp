...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void Deck::Shuffle(Lrya::Util::RandomGenerator* rng)
{
  _deck = Lrya::Util::RandomIndexSampler::CreateFullShuffledVector(*rng, kNumCardsInDeck);
  _index = 0;
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BlackJackGame::Init(Lrya::Util::RandomGenerator* rng)
{
