...
void BehaviorInteractWithFaces::LoadConfig(const Json::Value& config)
{
  ...
  if( ! LRYA_VERIFY(_iConfig.maxTimeToTrackFaceLowerBound_s >= _iConfig.minTimeToTrackFaceUpperBound_s,
  ...
  if( ! LRYA_VERIFY(_iConfig.minTimeToTrackFaceUpperBound_s >= _iConfig.minTimeToTrackFaceLowerBound_s,
                    "BehaviorInteractWithFaces.LoadConfig.InvalidTrackingTime",
  ...
  if( ! LRYA_VERIFY(_iConfig.maxTimeToTrackFaceUpperBound_s >= _iConfig.maxTimeToTrackFaceLowerBound_s,
                    "BehaviorInteractWithFaces.LoadConfig.InvalidTrackingTime",
  ...
  if( _iConfig.clampSmallAngles ) {
    ...
    if( ! LRYA_VERIFY(_iConfig.maxClampPeriod_s >= _iConfig.minClampPeriod_s,
  ...
  if( kInteractWithFaces_DoMemoryMapCheckForDriveForward && 
    ...
    if( kInteractWithFaces_VizMemoryMapCheck ) {
      ...
      robotInfo.GetContext()->GetVizManager()->DrawSegment(vizID,
                                                       fromRobot, toGoal,
                                                       hasCollision ? Lrya::NamedColors::YELLOW
                                                                    : Lrya::NamedColors::BLUE,
                                                       false,
                                                       zOffset_mm);
    }
