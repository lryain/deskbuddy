...
{
  LRYA_VERIFY(_iConfig.iCantDoThatBehavior->WantsToBeActivated(),
...
{
  LRYA_VERIFY(_iConfig.lookAtFaceInFront->WantsToBeActivated(),
...
void BehaviorWallTimeCoordinator::TransitionToShowWallTime()
{
  ...
  LRYA_VERIFY(_iConfig.showWallTime->WantsToBeActivated(),
              "BehaviorWallTimeCoordinator.TransitionToShowWallTime.BehaviorDoesntWantToBeActivated", "");
