...
Lrya::Vector::BehaviorTimerUtilityCoordinator* sCoordinator = nullptr;
}
...
bool BehaviorTimerUtilityCoordinator::CheckAndDelegate( IBehavior* behavior, bool runCallbacks )
{
  ...
  if( LRYA_VERIFY( behavior->WantsToBeActivated(),
...
{  
  auto startTimerCallback = [this](){
    ...
    if( LRYA_VERIFY(intentData != nullptr &&
