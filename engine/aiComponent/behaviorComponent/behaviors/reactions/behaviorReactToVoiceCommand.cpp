  ...
  _triggerDirection( kMicDirectionUnknown )
{
  ...
  {
    LRYA_VERIFY( AnimationTriggerFromString(animGetIn, _iVars.animListeningGetIn),
  ...
  {
    LRYA_VERIFY( AnimationTriggerFromString(animLoop, _iVars.animListeningLoop),
  ...
  {
    LRYA_VERIFY( AnimationTriggerFromString(animGetOut, _iVars.animListeningGetOut),
  ...
  if( !config[kNotifyOnWifiErrorsKey].isNull() )
  {
    ...
    LRYA_VERIFY( RecentOccurrenceTracker::ParseConfig(config[kNotifyOnWifiErrorsKey],
  ...
  if( !config[kNotifyOnCloudErrorsKey].isNull() )
  {
    ...
    LRYA_VERIFY( RecentOccurrenceTracker::ParseConfig(config[kNotifyOnCloudErrorsKey],
                                                      numErrorsToTriggerAnim,
                                                      errorTrackingWindow_s),
                 "BehaviorReactToVoiceCommand.Constructor.InvalidConfig",
...
void BehaviorReactToVoiceCommand::HandleStreamFailure()
{
  ...
  if( hasSSID ) {
    ...
    {
      if( LRYA_VERIFY(_iVars.noCloudBehavior != nullptr,
    ...
    {
      if( LRYA_VERIFY(_iVars.noWifiBehavior != nullptr,
  ...
  if( errorBehavior ) {
    ...
    auto errorBehaviorCallback = [this,errorBehavior](){
      if( LRYA_VERIFY( errorBehavior->WantsToBeActivated(),
