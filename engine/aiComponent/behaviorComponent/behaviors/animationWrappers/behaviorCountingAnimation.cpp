 ...
 : ICozmoBehavior(config)
{
  ...
  if(LRYA_VERIFY(config.isMember(JsonKeys::SlowLoopBeginSizeKey),
                 "BehaviorCountingAnimation.Constructor.MissingSlowLoopBeginSize", "")) {
    if(LRYA_VERIFY(config[JsonKeys::SlowLoopBeginSizeKey].isUInt(),
  ...
  if(LRYA_VERIFY(config.isMember(JsonKeys::SlowLoopEndSizeKey),
                 "BehaviorCountingAnimation.Constructor.MissingSlowLoopEndSize", "")) {
    if(LRYA_VERIFY(config[JsonKeys::SlowLoopEndSizeKey].isUInt(),
