  ...
  : ICozmoBehavior(config)
{
  ...
  LRYA_VERIFY( (_iConfig.maxNumResumes == 0) == (_iConfig.resumeAnim == AnimationTrigger::Count),
...
void BehaviorDriveToFace::InitBehavior()
{
  ...
  LRYA_VERIFY( _iConfig.findFaceBehavior != nullptr,
...
{
  LRYA_VERIFY( _iConfig.findFaceBehavior->WantsToBeActivated(),
