...
{
  LRYA_VERIFY(_iConfig.storageIsFullBehavior->WantsToBeActivated(), 
...
void BehaviorTakeAPhotoCoordinator::TransitionToDriveOffCharger()
{
  ...
  if(isOnCharger){
    LRYA_VERIFY(_iConfig.driveOffChargerBehavior->WantsToBeActivated(), 
...
{
  LRYA_VERIFY(_iConfig.frameFacesBehavior->WantsToBeActivated(),
