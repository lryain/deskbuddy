  ...
  : _context(context)
{
  ...
  if( gi != nullptr ) {
    auto handleEvent = [this](const LryaEvent<external_interface::GatewayWrapper>& msg) {
    ...
    // handle request
    auto handleRequest = [this](const LryaEvent<external_interface::GatewayWrapper>& msg) {
