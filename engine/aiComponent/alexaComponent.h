...
private:
  ...
  void HandleAppEvents( const LryaEvent<external_interface::GatewayWrapper>& event );
  void HandleAnimEvents( const LryaEvent<RobotInterface::RobotToEngine>& event );
  ...
  std::list<Lrya::Util::IConsoleFunction> _consoleFuncs;
