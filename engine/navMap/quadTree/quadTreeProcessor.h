...
#ifndef LRYA_COZMO_QUAD_TREE_PROCESSOR_H
#define LRYA_COZMO_QUAD_TREE_PROCESSOR_H
...
private:
  ...
  using NodeSetPerType = std::unordered_map<EContentType, NodeSet, Lrya::Util::EnumHasher>;
