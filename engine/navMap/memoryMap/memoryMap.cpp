...
ColorRGBA GetNodeVizColor(MemoryMapDataPtr node)
{
  ...
  Lrya::ColorRGBA color = Lrya::NamedColors::WHITE; // default that any other rule overrides

  using namespace ExternalInterface;
  switch(node->GetExternalContentType())
  {
    case ENodeContentTypeEnum::Unknown                : { color = Lrya::NamedColors::DARKGRAY; color.SetAlpha(0.2f); break; }
    case ENodeContentTypeEnum::ClearOfObstacle        : { color = Lrya::NamedColors::GREEN;    color.SetAlpha(0.5f); break; }
    case ENodeContentTypeEnum::ClearOfCliff           : { color = Lrya::NamedColors::DARKGREEN;color.SetAlpha(0.8f); break; }
    case ENodeContentTypeEnum::ObstacleCube           : { color = Lrya::NamedColors::RED;      color.SetAlpha(0.5f); break; }
    case ENodeContentTypeEnum::ObstacleUnrecognized   : { color = Lrya::NamedColors::BLACK;    color.SetAlpha(0.5f); break; }
    case ENodeContentTypeEnum::Cliff                  : { 
      ...
      if(!cliffData->isFromCliffSensor && cliffData->isFromVision) {
        ...
        color = Lrya::NamedColors::BLACK;
      }
      color.SetAlpha(0.8f); 
      break; 
    }
    case ENodeContentTypeEnum::InterestingEdge        : { color = Lrya::NamedColors::MAGENTA;  color.SetAlpha(0.5f); break; }
    case ENodeContentTypeEnum::NotInterestingEdge     : { color = Lrya::NamedColors::PINK;     color.SetAlpha(0.8f); break; }
    case ENodeContentTypeEnum::ObstacleProx           : { 
      color = (Lrya::NamedColors::CYAN * scale) + (Lrya::NamedColors::GREEN * (1 - scale));  
      color.SetAlpha(0.5f + .5*scale); 
      break; 
    }
    case ENodeContentTypeEnum::ObstacleProxExplored   : { 
      color = (Lrya::NamedColors::BLUE * scale) + (Lrya::NamedColors::GREEN * (1 - scale));  
      color.SetAlpha(0.5f + .5*scale); 
      break; 
    }
  }
