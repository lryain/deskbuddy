...
{
  LRYA_CPU_PROFILE("RobotConnectionManager::Update");
...
const Lrya::Util::Stats::StatsAccumulator& RobotConnectionManager::GetQueuedTimes_ms() const
{
#if TRACK_INCOMING_PACKET_LATENCY
  return _queuedTimes_ms.GetPrimaryAccumulator();
#else
  static Lrya::Util::Stats::StatsAccumulator sNullStats;
  return sNullStats;
...
#endif // LRYA_PROFILE_ENGINE_SOCKET_BUFFER_STATS
