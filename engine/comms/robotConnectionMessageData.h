...
#define TRACK_INCOMING_PACKET_LATENCY_TIMESTAMP_MS() ::Lrya::Util::GetCurrentNetTimeStamp()
#else
#define TRACK_INCOMING_PACKET_LATENCY_TIMESTAMP_MS() ::Lrya::Util::kNetTimeStampZero
#endif
