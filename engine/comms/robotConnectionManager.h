...
//
#ifndef LRYA_PROFILE_ENGINE_SOCKET_BUFFER_STATS
#define LRYA_PROFILE_ENGINE_SOCKET_BUFFER_STATS 0
#endif
...
public:
  ...
  const Lrya::Util::Stats::StatsAccumulator& GetQueuedTimes_ms() const;
...
#if LRYA_PROFILE_ENGINE_SOCKET_BUFFER_STATS
  using Histogram = Lrya::Util::Histogram;
