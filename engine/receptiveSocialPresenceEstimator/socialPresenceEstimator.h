...
#ifndef __DESKMATE_SOCIALPRESENCEESTIMATOR_H__
#define __DESKMATE_SOCIALPRESENCEESTIMATOR_H__
...
public:
  ...
  void OnRobotObservedFace(const LryaEvent<ExternalInterface::MessageEngineToGame>& msg);
  void OnRobotObservedMotion(const LryaEvent<ExternalInterface::MessageEngineToGame>& msg);
  void OnRobotObservedSalientPoint(const LryaEvent<ExternalInterface::MessageEngineToGame>& msg);
...
#endif // __DESKMATE_SOCIALPRESENCEESTIMATOR_H__
