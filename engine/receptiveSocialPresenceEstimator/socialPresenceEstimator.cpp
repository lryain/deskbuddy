...
void SocialPresenceEstimator::OnRobotObservedFace(const LryaEvent<ExternalInterface::MessageEngineToGame>& msg)
{
...
void SocialPresenceEstimator::OnRobotObservedMotion(const LryaEvent<ExternalInterface::MessageEngineToGame>& msg)
{
...
void SocialPresenceEstimator::OnRobotObservedSalientPoint(const LryaEvent<ExternalInterface::MessageEngineToGame>& msg)
{
