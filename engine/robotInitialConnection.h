...
#ifndef __Lrya_Cozmo_Basestation_RobotInitialConnection_H__
#define __Lrya_Cozmo_Basestation_RobotInitialConnection_H__
...
private:
  void HandleFactoryFirmware(const LryaEvent<RobotInterface::RobotToEngine>&);
  void HandleFirmwareVersion(const LryaEvent<RobotInterface::RobotToEngine>&);
  void HandleRobotAvailable(const LryaEvent<RobotInterface::RobotToEngine>&);
