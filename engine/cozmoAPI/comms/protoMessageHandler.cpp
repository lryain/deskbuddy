...
{
  LRYA_CPU_PROFILE("ProtoMH::DeliverToExternal");
...
{
  LRYA_CPU_PROFILE("ProtoMH::ProcessMessageBytes");
...
{
  LRYA_CPU_PROFILE("ProtoMH::Broadcast_GatewayWrapper");
  ...
  _eventMgr.Broadcast(LryaEvent<external_interface::GatewayWrapper>(
...
{
  LRYA_CPU_PROFILE("ProtoMH::BroadcastMove_GatewayWrapper");
...
Signal::SmartHandle ProtoMessageHandler::Subscribe(const external_interface::GatewayWrapperTag& tagType,
                                                std::function<void(const LryaEvent<external_interface::GatewayWrapper>&)> messageHandler)
{
...
{
  LRYA_CPU_PROFILE("ProtoMH::ProcessMessages");
...
{
  LRYA_CPU_PROFILE("ProtoMH::Update");
  ...
  {
    LRYA_CPU_PROFILE("ProtoMH::BroadcastThreadedMessages");
