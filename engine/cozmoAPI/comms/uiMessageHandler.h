...
#include "engine/events/lryaEventMgr.h"
...
namespace Lrya {
  namespace Vector {
    ...
    public:
      ...
      virtual Signal::SmartHandle Subscribe(const ExternalInterface::MessageEngineToGameTag& tagType, std::function<void(const LryaEvent<ExternalInterface::MessageEngineToGame>&)> messageHandler) override;
      
      virtual Signal::SmartHandle Subscribe(const ExternalInterface::MessageGameToEngineTag& tagType, std::function<void(const LryaEvent<ExternalInterface::MessageGameToEngine>&)> messageHandler) override;
      
      inline u32 GetHostUiDeviceID() const { return _hostUiDeviceID; }
      
      LryaEventMgr<ExternalInterface::MessageEngineToGame>& GetEventMgrToGame() { return _eventMgrToGame; }
      LryaEventMgr<ExternalInterface::MessageGameToEngine>& GetEventMgrToEngine() { return _eventMgrToEngine; }
    ...
    private:
      ...
      void HandleEvents(const LryaEvent<ExternalInterface::MessageGameToEngine>& event);
      ...
      LryaEventMgr<MessageEngineToGame>   _eventMgrToGame;
      LryaEventMgr<MessageGameToEngine>   _eventMgrToEngine;
