...
public:
  ...
  virtual Signal::SmartHandle Subscribe(const external_interface::GatewayWrapperTag& tagType, std::function<void(const LryaEvent<external_interface::GatewayWrapper>&)> messageHandler) override;

  LryaEventMgr<external_interface::GatewayWrapper>& GetEventMgr() { return _eventMgr; }
...
private:
  ...
  LryaEventMgr<external_interface::GatewayWrapper>        _eventMgr;
