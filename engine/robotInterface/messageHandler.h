...
#ifndef __Lrya_Cozmo_Basestation_RobotInterface_MessageHandler_H__
#define __Lrya_Cozmo_Basestation_RobotInterface_MessageHandler_H__
...
public:
  ...
  Signal::SmartHandle Subscribe(const RobotInterface::RobotToEngineTag& tagType, std::function<void(const LryaEvent<RobotInterface::RobotToEngine>&)> messageHandler) {
...
private:
  LryaEventMgr<RobotInterface::RobotToEngine> _eventMgr;
...
#endif //__Lrya_Cozmo_Basestation_RobotInterface_MessageHandler_H__
