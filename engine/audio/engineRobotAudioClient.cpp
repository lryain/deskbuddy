...
void EngineRobotAudioClient::SubscribeAudioCallbackMessages( Robot* robot )
{
  ...
  using localHandlerType = void(EngineRobotAudioClient::*)(const LryaEvent<RobotInterface::RobotToEngine>&);
  ...
  auto robotVolumeCallbackFunc = [this] ( const LryaEvent<ExternalInterface::MessageGameToEngine>& message )
  {
  ...
  auto audioBehaviorStackUpdateFunc = [this] ( const LryaEvent<ExternalInterface::MessageEngineToGame>& message )
  {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void EngineRobotAudioClient::HandleRobotEngineMessage( const LryaEvent<RobotInterface::RobotToEngine>& message )
{
