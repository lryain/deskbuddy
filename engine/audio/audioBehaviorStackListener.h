...
#ifndef __Lrya_Engine_AudioBehaviorStackListener__H_
#define __Lrya_Engine_AudioBehaviorStackListener__H_
...
#endif /* __Lrya_Engine_AudioBehaviorStackListener__H_ */
