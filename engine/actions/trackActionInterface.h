...
#ifndef __Lrya_Cozmo_Basestation_TrackActionInterface_H__
#define __Lrya_Cozmo_Basestation_TrackActionInterface_H__
...
#endif /* __Lrya_Cozmo_Basestation_TrackActionInterface_H__ */
