...
#ifndef __Lrya_Cozmo_Basestation_VisuallyVerifyActions_H__
#define __Lrya_Cozmo_Basestation_VisuallyVerifyActions_H__
...
#endif /* __Lrya_Cozmo_Basestation_VisuallyVerifyActions_H__ */
