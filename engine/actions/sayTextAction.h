...
#ifndef __Lrya_Cozmo_Actions_SayTextAction_H__
#define __Lrya_Cozmo_Actions_SayTextAction_H__
...
private:
  ...
  // VIC-2151: Fit-to-duration not supported on deskmate
...
#endif /* __Lrya_Cozmo_Actions_SayTextAction_H__ */
