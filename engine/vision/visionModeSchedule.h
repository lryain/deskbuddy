...
#ifndef __Lrya_Cozmo_Basestation_VisionModeSchedule_H__
#define __Lrya_Cozmo_Basestation_VisionModeSchedule_H__
...
#endif /* __Lrya_Cozmo_Basestation_VisionModeSchedule_H__ */
