  ...
  if (kMotionDetectionDebug) {
    ...
    // Draw the text
    {
      ...
      if (_regionSelector->IsTopActivated())
      {
        ...
        imageToDisplay.DrawText(origin, text, Lrya::NamedColors::RED, scale);
      }
      if (_regionSelector->IsBottomActivated())
      {
        ...
        imageToDisplay.DrawText(origin, text, Lrya::NamedColors::BLUE, scale);
      }
      if (_regionSelector->IsLeftActivated())
      {
        ...
        imageToDisplay.DrawText(origin, text, Lrya::NamedColors::YELLOW, scale);
      }
      if (_regionSelector->IsRightActivated())
      {
        ...
        imageToDisplay.DrawText(origin, text, Lrya::NamedColors::GREEN, scale);
      }
    }
    ...
    { // Top line
      ...
      imageToDisplay.DrawLine(topLeft, topRight, Lrya::NamedColors::RED, thickness);
    }
    { // Bottom line
      const int thickness = 1;
    ...
    { // Left line
      ...
      imageToDisplay.DrawLine(topLeft, bottomLeft, Lrya::NamedColors::RED, thickness);
    }
    { // Right line
      const int thickness = 1;
      ...
      imageToDisplay.DrawLine(topRight, BottomRight, Lrya::NamedColors::RED, thickness);
    }
    ...
    //Draw the motion centroids -- scaled back to the working resolution
    {
      if (_regionSelector->IsTopActivated())
      {
        ...
        imageToDisplay.DrawFilledCircle(centroid, Lrya::NamedColors::RED, 10);
      }
      if (_regionSelector->IsBottomActivated())
      {
        const Point2f centroid(msg.bottom_img_x / scaleMultiplier, msg.bottom_img_y / scaleMultiplier);
        imageToDisplay.DrawFilledCircle(centroid, Lrya::NamedColors::BLUE, 10);
      }
      if (_regionSelector->IsLeftActivated())
      {
        const Point2f centroid(msg.left_img_x / scaleMultiplier, msg.left_img_y / scaleMultiplier);
        imageToDisplay.DrawFilledCircle(centroid, Lrya::NamedColors::YELLOW, 10);
      }
      if (_regionSelector->IsRightActivated())
      {
        const Point2f centroid(msg.right_img_x / scaleMultiplier, msg.right_img_y / scaleMultiplier);
        imageToDisplay.DrawFilledCircle(centroid, Lrya::NamedColors::GREEN, 10);
      }
    }
