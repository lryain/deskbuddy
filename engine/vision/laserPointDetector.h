...
#ifndef __Lrya_Cozmo_Basestation_LaserPointDetector_H__
#define __Lrya_Cozmo_Basestation_LaserPointDetector_H__
...
#endif /* __Lrya_Cozmo_Basestation_LaserPointDetector_H__ */
