...
RawPixelsClassifier::RawPixelsClassifier(const CozmoContext *context, Lrya::Vision::Profiler* profiler)
...
bool DTRawPixelsClassifier::DeSerialize(const char *filename)
{
  ...
  if (!Lrya::Util::FileUtils::FileExists(filename)) {
