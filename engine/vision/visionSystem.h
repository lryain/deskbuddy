...
#ifndef LRYA_COZMO_BASESTATION_VISIONSYSTEM_H
#define LRYA_COZMO_BASESTATION_VISIONSYSTEM_H
...
namespace Vector {
  ...
  public:
    ...
    Result AddCalibrationImage(const Vision::Image& calibImg, const Lrya::Rectangle<s32>& targetROI) { return _cameraCalibrator->AddCalibrationImage(calibImg, targetROI); }
  ...
  protected:
    ...
    Result DetectPets(Vision::ImageCache& imageCache,
                      std::vector<Lrya::Rectangle<s32>>& ignoreROIs);
...
#endif // LRYA_COZMO_BASESTATION_VISIONSYSTEM_H
