...
#ifndef __Lrya_Cozmo_Basestation_MotionDetector_Neon_H__
#define __Lrya_Cozmo_Basestation_MotionDetector_Neon_H__
...
#if defined(ANDROID) || defined(MATEOS)
...
#endif // __Lrya_Cozmo_Basestation_MotionDetector_Neon_H__
