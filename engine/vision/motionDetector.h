...
#ifndef __Lrya_Cozmo_Basestation_MotionDetector_H__
#define __Lrya_Cozmo_Basestation_MotionDetector_H__
...
#endif /* __Lrya_Cozmo_Basestation_MotionDetector_H__ */
