...
#ifndef __Lrya_Cozmo_Basestation_Components_PublicStateBroadcaster_H__
#define __Lrya_Cozmo_Basestation_Components_PublicStateBroadcaster_H__
...
public:
  ...
  using SubscribeFunc = std::function<void(const LryaEvent<RobotPublicState>&)>;
...
private:
  ...
  LryaEventMgr<RobotPublicState> _eventMgr;
...
#endif // __Lrya_Cozmo_Basestation_Components_PublicStateBroadcaster_H__
