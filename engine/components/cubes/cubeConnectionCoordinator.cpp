...
static Lrya::Vector::TestCubeConnectionSubscriber sStaticTestSubscriber1(1);
static Lrya::Vector::TestCubeConnectionSubscriber sStaticTestSubscriber2(2);
static Lrya::Vector::TestCubeConnectionSubscriber sStaticTestSubscriber3(3);
static Lrya::Vector::TestCubeConnectionSubscriber sStaticTestSubscriber4(4);
#endif
}
...
void CubeConnectionCoordinator::HandleConnectionAttemptResult(const RobotCompMap& dependentComps)
{
  if(!_connectionAttemptSucceeded){
    ...
    LRYA_VERIFY(nullptr != _connectedBlock,
