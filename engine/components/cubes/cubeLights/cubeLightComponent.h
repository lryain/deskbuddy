...
#ifndef __Lrya_Cozmo_Basestation_Components_CubeLightComponent_H__
#define __Lrya_Cozmo_Basestation_Components_CubeLightComponent_H__
...
public:
  ...
  // NOTE: objectID's throughout this system will likely be unnecessary on deskmate since he has only 
