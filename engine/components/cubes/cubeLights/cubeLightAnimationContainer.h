...
#ifndef __Lrya_Cozmo_Cube_Light_Animation_Container_H__
#define __Lrya_Cozmo_Cube_Light_Animation_Container_H__
...
#endif // __Lrya_Cozmo_Cube_Light_Animation_Container_H__
