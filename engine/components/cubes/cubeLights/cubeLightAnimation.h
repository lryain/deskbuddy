...
#ifndef __Lrya_Cozmo_Basestation_Components_CubeLightAnimation_fwd_H__
#define __Lrya_Cozmo_Basestation_Components_CubeLightAnimation_fwd_H__
...
#endif // __Lrya_Cozmo_Basestation_Components_CubeLightAnimation_fwd_H__
