...
#ifndef __Lrya_Cozmo_Basestation_Components_CubeLightAnimationHelpers_H__
#define __Lrya_Cozmo_Basestation_Components_CubeLightAnimationHelpers_H__
...
#endif // __Lrya_Cozmo_Basestation_Components_CubeLightAnimationHelpers_H__
