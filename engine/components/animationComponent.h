...
#include "lrya/cozmo/shared/animationTag.h"
...
public:
  ...
  void HandleAnimAdded(const LryaEvent<RobotInterface::RobotToEngine>& message);
  void HandleAnimStarted(const LryaEvent<RobotInterface::RobotToEngine>& message);
  void HandleAnimEnded(const LryaEvent<RobotInterface::RobotToEngine>& message);
  void HandleAnimationEvent(const LryaEvent<RobotInterface::RobotToEngine>& message);
  void HandleAnimState(const LryaEvent<RobotInterface::RobotToEngine>& message);  
