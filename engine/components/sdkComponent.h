...
public:
  ...
  void HandleProtoMessage(const LryaEvent<external_interface::GatewayWrapper>& event);
...
private:
  ...
  void OnSendAudioModeRequest(const LryaEvent<external_interface::GatewayWrapper>& event);
  void IsImageStreamingEnabledRequest(const LryaEvent<external_interface::GatewayWrapper>& event);
  ...
  void SayText(const LryaEvent<external_interface::GatewayWrapper>& event);
  void SetEyeColor(const LryaEvent<external_interface::GatewayWrapper>& event);
  void ListAnimationTriggers(const LryaEvent<external_interface::GatewayWrapper>& event);
  void HandleAudioStreamPrepareRequest(const LryaEvent<external_interface::GatewayWrapper>& event);
  void HandleAudioStreamChunkRequest(const LryaEvent<external_interface::GatewayWrapper>& event);
  void HandleAudioStreamCompleteRequest(const LryaEvent<external_interface::GatewayWrapper>& event);
  void HandleAudioStreamCancelRequest(const LryaEvent<external_interface::GatewayWrapper>& event);
  void HandleStreamStatusEvent(SDKAudioStreamingState streamStatusId, int audioFramesReceived, int audioFramesPlayed);
  void SetMasterVolume(const LryaEvent<external_interface::GatewayWrapper>& event);
  void SetCameraSettings(const LryaEvent<external_interface::GatewayWrapper>& event);
};
