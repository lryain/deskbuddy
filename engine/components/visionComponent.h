...
#ifndef LRYA_VECTOR_BASESTATION_VISION_PROC_THREAD_H
#define LRYA_VECTOR_BASESTATION_VISION_PROC_THREAD_H
...
struct DockingErrorSignal;
  ...
  public:
    ...
    // Templated message handler used internally by LryaEventUtil
    template<typename T>
...
#endif // LRYA_VECTOR_BASESTATION_VISION_PROC_THREAD_H
