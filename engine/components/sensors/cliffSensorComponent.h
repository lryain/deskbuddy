...
#ifndef __Lrya_Cozmo_Basestation_Components_CliffSensorComponent_H__
#define __Lrya_Cozmo_Basestation_Components_CliffSensorComponent_H__
...
#endif // __Lrya_Cozmo_Basestation_Components_CliffSensorComponent_H__
