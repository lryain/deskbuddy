                                        ...
                                        const bool backUpWhileLiftingCube)
{
  ...
  Result sendResult = _robot->SendRobotMessage<::Lrya::Vector::DockWithObject>(0.0f,
                                                                               speed_mmps,
                                                                               accel_mmps2,
                                                                               decel_mmps2,
                                                                               dockAction,
...
{
  return _robot->SendMessage(RobotInterface::EngineToRobot(Lrya::Vector::AbortDocking()));
}
