...
#ifndef LRYA_COZMO_BASESTATION_ROBOT_DATA_LOADER_H
#define LRYA_COZMO_BASESTATION_ROBOT_DATA_LOADER_H
...
public:
  ...
  const Json::Value& GetVictorFreeplayBehaviorConfig() const { return _deskmateFreeplayBehaviorConfig; }
...
private:
  ...
  Json::Value _deskmateFreeplayBehaviorConfig;
