...
LogLevel ILoggerLevelToCladLevel(Lrya::Util::ILoggerProvider::LogLevel logLevel)
{
...
void CLADLoggerProvider::Log(Lrya::Util::ILoggerProvider::LogLevel logLevel, const std::string& message)
{
