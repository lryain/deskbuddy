...
namespace {
  static Lrya::Vector::DevLoggingSystem* sInstance = nullptr;
  static Lrya::Util::ILoggerProvider* sInstancePrintProvider = nullptr;
}
...
void DevLoggingSystem::CreateInstance(const std::string& loggingBaseDirectory, const std::string& appRunId)
{
  ...
  const auto & devlogPath = Lrya::Util::FileUtils::FullFilePath({devlogBase, kPrintName});
  sInstancePrintProvider = new Lrya::Vector::DevLoggerProvider(devlogQueue, devlogPath);
}
...
Lrya::Util::ILoggerProvider* DevLoggingSystem::GetInstancePrintProvider()
{
...
void DevLoggingSystem::CreateAppRunFile(const std::string& appRunTimeString, const std::string& appRunId)
{
  ...
  appRunData[kTimeSinceEpochKey] = static_cast<int64_t>(appStartTimeSinceEpoch_ms);
...
void DevLoggingSystem::LogMessage(const ExternalInterface::MessageEngineToGame& message)
{
  ...
  LRYA_CPU_PROFILE("LogMessage_EToG");
...
void DevLoggingSystem::LogMessage(const ExternalInterface::MessageGameToEngine& message)
{
  ...
  LRYA_CPU_PROFILE("LogMessage_GToE");
...
{
  LRYA_CPU_PROFILE("LogMessage_EToR");
...
void DevLoggingSystem::LogMessage(const RobotInterface::RobotToEngine& message)
{
  ...
  LRYA_CPU_PROFILE("LogMessage_RToE");
...
void DevLoggingSystem::LogMessage(const VizInterface::MessageViz& message)
{
  ...
  LRYA_CPU_PROFILE("LogMessage_Viz");
