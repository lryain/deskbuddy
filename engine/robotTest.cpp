...
{
  LRYA_CPU_PROFILE("RobotTest::Update");
...
{
  LRYA_CPU_PROFILE("RobotTest::SampleCPU");

  std::vector<std::string> cpuTimeStatsStrings;
  {
    LRYA_CPU_PROFILE("RobotTest::SampleCPUCallOS");
...
#endif  // (else) LRYA_ROBOT_TEST_ENABLED
