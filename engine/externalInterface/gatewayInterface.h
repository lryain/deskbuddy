...
#ifndef __Lrya_Cozmo_ExternalInterface_GatewayInterface_H__
#define __Lrya_Cozmo_ExternalInterface_GatewayInterface_H__
...
public:
  ...
  virtual Signal::SmartHandle Subscribe(const external_interface::GatewayWrapperTag& tagType, std::function<void(const LryaEvent<external_interface::GatewayWrapper>&)> messageHandler) = 0;
...
#endif //__Lrya_Cozmo_ExternalInterface_GatewayInterface_H__
