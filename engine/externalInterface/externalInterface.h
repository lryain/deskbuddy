...
#ifndef __Lrya_Cozmo_Basestation_ExternalInterface_ExternalInterface_H__
#define __Lrya_Cozmo_Basestation_ExternalInterface_ExternalInterface_H__
...
public:
  ...
  virtual Signal::SmartHandle Subscribe(const ExternalInterface::MessageEngineToGameTag& tagType, std::function<void(const LryaEvent<ExternalInterface::MessageEngineToGame>&)> messageHandler) = 0;
  
  virtual Signal::SmartHandle Subscribe(const ExternalInterface::MessageGameToEngineTag& tagType, std::function<void(const LryaEvent<ExternalInterface::MessageGameToEngine>&)> messageHandler) = 0;
...
#endif //__Lrya_Cozmo_Basestation_ExternalInterface_ExternalInterface_H__
