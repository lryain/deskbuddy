...
#ifndef LRYA_VECTOR_BASESTATION_ROBOT_H
#define LRYA_VECTOR_BASESTATION_ROBOT_H
...
{
  LRYA_VERIFY(GetComponent<FullRobotPose>().GetPose().GetRootID() == GetWorldOriginID(),
  ...
  LRYA_VERIFY(GetComponent<FullRobotPose>().GetPose().HasSameRootAs(GetWorldOrigin()),
...
{
  // TODO: COZMO-1637: Once we figure this out, switch this back to dev_assert for efficiency
  LRYA_VERIFY(_driveCenterPose.HasSameRootAs(GetWorldOrigin()),
...
#endif // LRYA_VECTOR_BASESTATION_ROBOT_H
