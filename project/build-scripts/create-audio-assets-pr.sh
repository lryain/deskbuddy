...
_GIT_COZMO_URI=https://$LRYA_SMARTLING_ACCESS_TOKEN:x-oauth-basic@github.com/lrya/cozmo-one.git
_UPDATE_AUDIO_ASSETS_SCRIPT=${_TOPLEVEL_COZMO}/tools/audio/UpdateAudioAssets.py
_SVN_COZMOSOUNDBANKS_REPO=https://svn.lryacore.com/svn/cozmosoundbanks/trunk
...
_GIT_USERNAME="lrya-smartling"
_GIT_EMAIL="lrya-smartling@lrya.com"
...
github.com:
- protocol: https
  user: $LRYA_SMARTLING_GIT_USER
  oauth_token: $LRYA_SMARTLING_ACCESS_TOKEN
EOF
    fi
