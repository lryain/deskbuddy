...
# echo "00000000 --------------> CONFIGURE=: ${CONFIGURE}"
...
echo "5. --------------> grab Go dependencies ahead of generating source lists | add -I option to skip this!"
...
echo "7. --------------> Build protocCppPlugin if needed"
...
echo "8. --------------> Build/Install the protoc generators for go"
...
echo "9. --------------> generate source file lists"

#
# generate source file lists
# 如果ninja build文件存在 开始构建：
# CONFIGURE 代表是否需要 生成代码清单文件
# 如果需要则调用 /metabuild/metabuild.py 文件生成
#
