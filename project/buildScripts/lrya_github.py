...
#                                           #
# Lrya_Github                               #
# Library for Lrya Specific Github funcions #
#                                           #
#############################################
...
DEFAULT_REPO = "lrya/cozmo-one"

def get_branch_name(auth_token, pull_request_number, repo_name="lrya/cozmo-one"):
    """
...
def post_ci_bot_comment(auth_token, pull_request_number, mrkdwn_comment, repo_name="lrya/deskmate"):
    """
...
def get_pr_head_commit(auth_token, pull_request_number, repo_name="lrya/deskmate"):
    """
    Returns a :class:`github.CommitComment.CommitComment`
...
def post_pending_commit_status(auth_token, pull_request_number, build_url, 
    build_ctx, description_msg, repo_name="lrya/deskmate"):
    """
    Returns a :class:`github.CommitComment.CommitComment`
