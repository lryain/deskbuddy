...
def parse_args(argv=[]):
    ...
    parser.add_argument('-r', '--repository_name', action='store', default='lrya/cozmo-one',
                        help='Enter the repository to verify PRs from. Default=lrya/cozmo-one')
...
def main(argv):
    ...
    if args.auth_token is not None:
        ...
        pull_request_status = lrya_github.pull_request_merge_info(args.auth_token, branch_number, 6,
